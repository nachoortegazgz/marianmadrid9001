 ...
 * @slug created
 */
declare function onAttachmentCreated(handler: (event: AttachmentCreatedEnvelope) => void | Promise<void>): void;
 ...
 * @slug deleted
 */
declare function onAttachmentDeleted(handler: (event: AttachmentDeletedEnvelope) => void | Promise<void>): void;
/**
 ...
 */
declare function generateAttachmentUploadUrl(contactId: string, fileName: string, options: NonNullablePaths<GenerateAttachmentUploadUrlOptions, `mimeType`, 0>): Promise<NonNullablePaths<GenerateAttachmentUploadUrlResponse, `uploadUrl`, 0>>;
 ...
 */
declare function listAttachments(contactId: string, options?: ListAttachmentsOptions): Promise<NonNullablePaths<ListAttachmentsResponse, `attachments` | `attachments.${number}._id` | `attachments.${number}.fileName` | `attachments.${number}.mimeType` | `attachments.${number}.attachmentType`, 2>>;
 ...
 */
declare function deleteAttachment(identifiers: NonNullablePaths<DeleteAttachmentIdentifiers, `attachmentId` | `contactId`, 0>): Promise<void>;
 ...
 */
declare function getAttachment(identifiers: NonNullablePaths<GetAttachmentIdentifiers, `attachmentId` | `contactId`, 0>): Promise<NonNullablePaths<ContactAttachment, `_id` | `fileName` | `mimeType` | `attachmentType`, 0>>;
