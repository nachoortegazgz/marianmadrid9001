...
import { StartOptions, StartResponse, VerifyDuringAuthenticationOptions, StateMachineResponse, VerifyDuringAuthenticationApplicationErrors } from './index.typings.js';
...
interface StartSignature {
     ...
     */
    (options?: StartOptions): Promise<NonNullablePaths<StartResponse, `verificationId`, 0>>;
}
