...
interface StartRequest {
    /**
     * ID of the identity whose email address should be verified. The verification code is sent to this identity's
     * email. Currently required — the request fails if it is omitted.
     * @format GUID
     */
    identityId?: string | null;
    /** Delivery channel for the verification code. Currently only `EMAIL` is supported. */
    target?: TargetWithLiterals;
}
/** The delivery channel used to send the verification code. */
declare enum Target {
    /** Send the verification code to the identity's email address. */
    EMAIL = "EMAIL"
}
/** @enumType */
type TargetWithLiterals = Target | 'EMAIL';
...
/** @enumType */
type ReasonWithLiterals = Reason | 'UNKNOWN_REASON' | 'PENDING_ADMIN_APPROVAL_REQUIRED' | 'PENDING_EMAIL_VERIFICATION_REQUIRED' | 'PENDING_REQUIRED_FIELDS_MISSING';
interface Factor {
    /**
     * Factor ID.
     * @format GUID
...
/** @docsIgnore */
type VerifyDuringAuthenticationApplicationErrors = {
 ...
 */
declare function start(options?: StartOptions): Promise<NonNullablePaths<StartResponse, `verificationId`, 0>>;
...
export { type Address, AddressTag, type AddressTagWithLiterals, type AddressWrapper, type AuthenticatorConnection, type Connection, type ConnectionTypeOneOf, type CustomField, type CustomValue, type CustomValueValueOneOf, type Email, EmailTag, type EmailTagWithLiterals, type Factor, FactorStatus, type FactorStatusWithLiterals, FactorType, type FactorTypeWithLiterals, type Identity, type IdentityProfile, type IdpConnection, type ListValue, type MapValue, type Metadata, type MfaChallengeData, MfaReason, type MfaReasonWithLiterals, type Phone, PhoneTag, type PhoneTagWithLiterals, PrivacyStatus, type PrivacyStatusWithLiterals, type PushChallengeData, Reason, type ReasonWithLiterals, type RequireMfaData, type SecondaryEmail, type StartOptions, type StartRequest, type StartResponse, type StateMachineResponse, type StateMachineResponseStateDataOneOf, StateType, type StateTypeWithLiterals, Status, StatusName, type StatusNameWithLiterals, type StatusV2, type StatusWithLiterals, Target, type TargetWithLiterals, type V1CustomValue, type V1CustomValueValueOneOf, type V1Factor, type V1ListValue, type V1MapValue, type VerificationChallenge, type VerificationChallengeFactorChallengeDataOneOf, type VerifyDuringAuthenticationApplicationErrors, type VerifyDuringAuthenticationOptions, type VerifyDuringAuthenticationRequest, type VerifyRequest, type VerifyResponse, type WebAuthnChallengeData, start, verifyDuringAuthentication };
