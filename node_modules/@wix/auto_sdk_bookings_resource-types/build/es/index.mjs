...
function queryResourceTypes2(options) {
  const { httpClient, sideEffects } = arguments[1];
  return queryBuilder({
    func: async (payload) => {
...
async function typedQueryResourceTypes(query, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = renameKeysFromSDKRequestToRESTRequest({
    query,
    ...options
  });
  const reqOpts = queryResourceTypes(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
function queryResourceTypes3(httpClient) {
  return (options) => queryResourceTypes2(
    options,
    // @ts-ignore
    { httpClient }
  );
}
function typedQueryResourceTypes2(httpClient) {
  return (query, options) => typedQueryResourceTypes(
    query,
    options,
    // @ts-ignore
    { httpClient }
...
var onResourceTypeCreated = /* @__PURE__ */ EventDefinition(
...
var onResourceTypeDeleted = /* @__PURE__ */ EventDefinition(
...
var onResourceTypeUpdated = /* @__PURE__ */ EventDefinition(
...
function customQueryResourceTypes(httpClient) {
  const router = /* @__PURE__ */ createQueryOverloadRouter({
    builderQueryFunction: (options) => queryResourceTypes3(httpClient)(options),
    typedQueryFunction: (query, options) => typedQueryResourceTypes2(httpClient)(query, options),
...
var queryResourceTypes4 = /* @__PURE__ */ createRESTModule(customQueryResourceTypes);
var onResourceTypeCreated2 = /* @__PURE__ */ createEventModule(
  onResourceTypeCreated
);
var onResourceTypeDeleted2 = /* @__PURE__ */ createEventModule(
  onResourceTypeDeleted
);
var onResourceTypeUpdated2 = /* @__PURE__ */ createEventModule(
