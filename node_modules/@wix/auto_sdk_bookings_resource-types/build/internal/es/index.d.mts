...
import { ResourceType, CreateResourceTypeApplicationErrors, UpdateResourceType, UpdateResourceTypeApplicationErrors, CountResourceTypesOptions, CountResourceTypesResponse, ResourceTypeCreatedEnvelope, ResourceTypeDeletedEnvelope, ResourceTypeUpdatedEnvelope, ResourceTypeQuery, QueryResourceTypesOptions, typedQueryResourceTypes, ResourceTypesQueryBuilder } from './index.typings.mjs';
export { AccountInfo, AccountInfoMetadata, ActionEvent, BaseEventMetadata, BusinessLocation, CommonQueryWithEntityContext, CountResourceTypesRequest, CreateResourceTypeErrors, CreateResourceTypeErrorsWithLiterals, CreateResourceTypeRequest, CreateResourceTypeResponse, CursorPaging, CursorPagingMetadata, CursorQuery, CursorQueryPagingMethodOneOf, Cursors, DeleteResourceTypeRequest, DeleteResourceTypeResponse, DistinctLocationIds, DomainEvent, DomainEventBodyOneOf, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, ExtendedFields, GetResourceTypeRequest, GetResourceTypeResponse, IdentificationData, IdentificationDataIdOneOf, LocationOptions, MessageEnvelope, QueryResourceTypesRequest, QueryResourceTypesResponse, RequestedFields, RequestedFieldsWithLiterals, ResourceCounts, ResourceTypeQuerySpec, ResourceTypesQueryResult, RestoreInfo, SortOrder, SortOrderWithLiterals, Sorting, SpecificLocation, UpdateResourceTypeRequest, UpdateResourceTypeResponse, WebhookIdentityType, WebhookIdentityTypeWithLiterals, utils } from './index.typings.mjs';
...
interface CreateResourceTypeSignature {
     ...
     */
    (resourceType: NonNullablePaths<ResourceType, `name`, 0>): Promise<ResourceType & {
...
interface UpdateResourceTypeSignature {
     ...
     */
    (_id: string, resourceType: NonNullablePaths<UpdateResourceType, `revision`, 0>): Promise<ResourceType & {
...
interface CountResourceTypesSignature {
     ...
     */
    (options?: CountResourceTypesOptions): Promise<NonNullablePaths<CountResourceTypesResponse, `count`, 0>>;
}
...
declare function customQueryResourceTypes(httpClient: HttpClient): {
    (query: ResourceTypeQuery, options?: QueryResourceTypesOptions): ReturnType<typeof typedQueryResourceTypes>;
    (options?: QueryResourceTypesOptions): ResourceTypesQueryBuilder;
};
...
declare const queryResourceTypes: MaybeContext<BuildRESTFunction<typeof customQueryResourceTypes> & typeof customQueryResourceTypes>;
/**
 * Triggered when a resource type is created.
 */
declare const onResourceTypeCreated: BuildEventDefinition<typeof onResourceTypeCreated$1> & typeof onResourceTypeCreated$1;
/**
 * Triggered when a resource type is deleted.
 */
declare const onResourceTypeDeleted: BuildEventDefinition<typeof onResourceTypeDeleted$1> & typeof onResourceTypeDeleted$1;
/**
 * Triggered when a resource type is updated.
 */
declare const onResourceTypeUpdated: BuildEventDefinition<typeof onResourceTypeUpdated$1> & typeof onResourceTypeUpdated$1;

export { CountResourceTypesOptions, CountResourceTypesResponse, CreateResourceTypeApplicationErrors, QueryResourceTypesOptions, ResourceType, ResourceTypeCreatedEnvelope, ResourceTypeDeletedEnvelope, ResourceTypeQuery, ResourceTypeUpdatedEnvelope, ResourceTypesQueryBuilder, UpdateResourceType, UpdateResourceTypeApplicationErrors, countResourceTypes, createResourceType, deleteResourceType, getResourceType, onResourceTypeCreated, onResourceTypeDeleted, onResourceTypeUpdated, queryResourceTypes, updateResourceType };
