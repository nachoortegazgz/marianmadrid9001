...
interface ResourceType {
    ...
    name?: string | null;
    /**
     * ID of the app to which the connected resources belong.
     *
     * Default: `13d21c63-b5ec-5912-8397-c3a5ddb27a97` (Bookings App ID)
     * @internal
     * @format GUID
     * @immutable
     */
...
interface ResourceCounts {
    ...
    total?: number | null;
    /**
     * Whether at least 1 resource of the type is available in all business [locations](https://dev.wix.com/docs/rest/business-solutions/bookings/services/services-v2/about-service-locations#location-types).
     * @readonly
     */
...
interface CreateResourceTypeRequest {
    ...
    /**
     * How many resources of this type are automatically created when setting up the resource type.
     * The name of each auto-generated resource consists of the name of the resource type followed by an incrementing sequence number.
     * @internal
     * @max 50
     */
    quantity?: number;
...
interface CreateResourceTypeResponse {
    ...
    resourceType?: ResourceType;
    /**
     * Partial errors. The resource type was created, but some dependent entities couldn't be created.
     * @internal
     */
    partialErrors?: CreateResourceTypeErrorsWithLiterals[];
}
...
/** @enumType */
type CreateResourceTypeErrorsWithLiterals = CreateResourceTypeErrors | 'FAILED_TO_CREATE_RESOURCES';
 ...
 */
declare function createResourceType(resourceType: NonNullablePaths<ResourceType, `name`, 0>): Promise<ResourceType & {
 ...
 */
declare function updateResourceType(_id: string, resourceType: NonNullablePaths<UpdateResourceType, `revision`, 0>): Promise<ResourceType & {
 ...
 */
declare function queryResourceTypes(options?: QueryResourceTypesOptions): ResourceTypesQueryBuilder;
 ...
 * @requiredField query
 */
declare function typedQueryResourceTypes(query: ResourceTypeQuery, options?: QueryResourceTypesOptions): Promise<NonNullablePaths<QueryResourceTypesResponse, `resourceTypes`, 0>>;
interface ResourceTypeQuerySpec extends QuerySpec {
    paging: 'cursor';
    wql: [
        {
            fields: ['name'];
...
type CommonQueryWithEntityContext = Query<ResourceType, ResourceTypeQuerySpec>;
...
declare const utils: {
    query: _wix_sdk_types.QueryHelpers<ResourceType, ResourceTypeQuerySpec, ResourceTypeQuery>;
};
/**
 ...
 */
declare function countResourceTypes(options?: CountResourceTypesOptions): Promise<NonNullablePaths<CountResourceTypesResponse, `count`, 0>>;
