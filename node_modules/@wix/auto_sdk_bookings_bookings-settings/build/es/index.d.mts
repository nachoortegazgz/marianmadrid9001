...
interface GetBookingsSettingsSignature {
     ...
     */
    (): Promise<NonNullablePaths<BookingsSettings, `displayTimeZone.basedOn`, 1> & {
        __applicationErrorsType?: GetBookingsSettingsApplicationErrors;
    }>;
}
declare function updateBookingsSettings$1(httpClient: HttpClient): UpdateBookingsSettingsSignature;
interface UpdateBookingsSettingsSignature {
     ...
     */
    (bookingsSettings: NonNullablePaths<BookingsSettings, `revision`, 0>): Promise<NonNullablePaths<BookingsSettings, `displayTimeZone.basedOn`, 1>>;
}
declare const onBookingsSettingsCreated$1: EventDefinition<BookingsSettingsCreatedEnvelope, "wix.bookings.v2.bookings_settings_created">;
declare const onBookingsSettingsDeleted$1: EventDefinition<BookingsSettingsDeletedEnvelope, "wix.bookings.v2.bookings_settings_deleted">;
declare const onBookingsSettingsUpdated$1: EventDefinition<BookingsSettingsUpdatedEnvelope, "wix.bookings.v2.bookings_settings_updated">;

declare const getBookingsSettings: MaybeContext<BuildRESTFunction<typeof getBookingsSettings$1> & typeof getBookingsSettings$1>;
declare const updateBookingsSettings: MaybeContext<BuildRESTFunction<typeof updateBookingsSettings$1> & typeof updateBookingsSettings$1>;
/**
 * (explanation)
 *
 ...
 */
declare const onBookingsSettingsCreated: BuildEventDefinition<typeof onBookingsSettingsCreated$1> & typeof onBookingsSettingsCreated$1;
/** */
declare const onBookingsSettingsDeleted: BuildEventDefinition<typeof onBookingsSettingsDeleted$1> & typeof onBookingsSettingsDeleted$1;
/** */
declare const onBookingsSettingsUpdated: BuildEventDefinition<typeof onBookingsSettingsUpdated$1> & typeof onBookingsSettingsUpdated$1;

export { BookingsSettings, BookingsSettingsCreatedEnvelope, BookingsSettingsDeletedEnvelope, BookingsSettingsUpdatedEnvelope, GetBookingsSettingsApplicationErrors, getBookingsSettings, onBookingsSettingsCreated, onBookingsSettingsDeleted, onBookingsSettingsUpdated, updateBookingsSettings };
