import { GetBookingsSettingsRequest as GetBookingsSettingsRequest$1, GetBookingsSettingsResponse as GetBookingsSettingsResponse$1, UpdateBookingsSettingsRequest as UpdateBookingsSettingsRequest$1, UpdateBookingsSettingsResponse as UpdateBookingsSettingsResponse$1 } from './index.typings.mjs';
...
interface BookingsSettings {
    ...
    /**
     * Site properties. Will return null if there is a failure fetching site properties
     * @internal
     * @readonly
     */
    siteProperties?: SiteProperties;
    /**
     * Bookings features. Will return null if there is a failure fetching bookings features
     * @internal
     * @readonly
     */
    features?: Features;
    ...
    /**
     * Backoffice flow settings.
     * @internal
     */
    ownerFlow?: OwnerFlow;
    /**
     * Double booking handling settings.
     * @internal
     */
    doubleBookingHandling?: DoubleBookingHandling;
}
interface CartCheckout {
    /** Whether customers can add multiple services to a cart and check out together. */
    enabled?: boolean | null;
}
interface MultiServiceAppointments {
...
/** @enumType */
type BasedOnWithLiterals = BasedOn | 'BUSINESS_TIME_ZONE' | 'CUSTOMER_TIME_ZONE';
...
interface StaffSelection {
    ...
    /**
     * Whether customers can narrow the staff pool to a gender instead of picking a specific staff member.
     * Only meaningful when `strategy` is `CUSTOMER_MAY_CHOOSE`.
     *
     * Requires staff members' gender to be publicly accessible, controlled by `gender_publicly_accessible`
     * in the staff member settings. While that setting is `false`, a customer's request to narrow the staff
     * pool by gender fails with an error.
     *
     * Default: `false`
     */
    allowGenderSelection?: boolean | null;
}
declare enum StaffSelectionTiming {
...
/** @enumType */
type StaffSelectionTimingWithLiterals = StaffSelectionTiming | 'BEFORE_SLOT_SELECTION' | 'AFTER_SLOT_SELECTION';
...
/** @enumType */
type StrategyWithLiterals = Strategy | 'CUSTOMER_MUST_CHOOSE' | 'CUSTOMER_MAY_CHOOSE' | 'CUSTOMER_CANNOT_CHOOSE';
...
/** @enumType */
type TimingWithLiterals = Timing | 'BEFORE_SLOT_SELECTION' | 'AFTER_SLOT_SELECTION';
...
interface BookingCreationSettings {
    requiredFields?: RequiredFieldWithLiterals[];
}
declare enum RequiredField {
    PHONE = "PHONE",
    EMAIL = "EMAIL"
}
/** @enumType */
type RequiredFieldWithLiterals = RequiredField | 'PHONE' | 'EMAIL';
interface DoubleBookingHandling {
    /**
     * Whether paid double-bookings are automatically declined and refunded.
     * Default: `false`.
     */
    autoDeclineAndRefundEnabled?: boolean | null;
}
interface GetBookingsSettingsRequest {
    /**
...
/** @enumType */
type RequestedFieldsWithLiterals = RequestedFields | 'SITE_PROPERTIES' | 'FEATURES' | 'OWNER_FLOW';
interface GetBookingsSettingsResponse {
    /** Retrieved bookings settings. */
    bookingsSettings?: BookingsSettings;
}
interface UpdateBookingsSettingsRequest {
...
interface UpdateBookingsSettingsResponse {
...
/** @enumType */
type ReasonWithLiterals = Reason | 'UNKNOWN' | 'CUSTOM_PROPERTIES_UPDATED' | 'ONBOARDING_STATUS_UPDATED';
...
/** @docsIgnore */
type GetBookingsSettingsApplicationErrors = {
...
declare function getBookingsSettings(): __PublicMethodMetaInfo<'GET', {}, GetBookingsSettingsRequest$1, GetBookingsSettingsRequest, GetBookingsSettingsResponse$1, GetBookingsSettingsResponse>;
declare function updateBookingsSettings(): __PublicMethodMetaInfo<'PATCH', {}, UpdateBookingsSettingsRequest$1, UpdateBookingsSettingsRequest, UpdateBookingsSettingsResponse$1, UpdateBookingsSettingsResponse>;

export { type AccountInfo as AccountInfoOriginal, type ActionEvent as ActionEventOriginal, type AddressHint as AddressHintOriginal, type Address as AddressOriginal, type Asset as AssetOriginal, BasedOn as BasedOnOriginal, type BasedOnWithLiterals as BasedOnWithLiteralsOriginal, type BookingCreationSettings as BookingCreationSettingsOriginal, type BookingsSettings as BookingsSettingsOriginal, type BusinessNotification as BusinessNotificationOriginal, type CartCheckout as CartCheckoutOriginal, type DeleteContext as DeleteContextOriginal, DeleteStatus as DeleteStatusOriginal, type DeleteStatusWithLiterals as DeleteStatusWithLiteralsOriginal, type DisplayTimeZone as DisplayTimeZoneOriginal, type DomainEventBodyOneOf as DomainEventBodyOneOfOriginal, type DomainEvent as DomainEventOriginal, type DoubleBookingHandling as DoubleBookingHandlingOriginal, type EditorlessAssigned as EditorlessAssignedOriginal, type EditorlessUnassigned as EditorlessUnassignedOriginal, type Empty as EmptyOriginal, type EntityCreatedEvent as EntityCreatedEventOriginal, type EntityDeletedEvent as EntityDeletedEventOriginal, type EntityUpdatedEvent as EntityUpdatedEventOriginal, type ExtendedFields as ExtendedFieldsOriginal, type Feature as FeatureOriginal, type Features as FeaturesOriginal, type GeoCoordinates as GeoCoordinatesOriginal, type GetBookingsSettingsApplicationErrors as GetBookingsSettingsApplicationErrorsOriginal, type GetBookingsSettingsRequest as GetBookingsSettingsRequestOriginal, type GetBookingsSettingsResponse as GetBookingsSettingsResponseOriginal, type IdentificationDataIdOneOf as IdentificationDataIdOneOfOriginal, type IdentificationData as IdentificationDataOriginal, type Locale as LocaleOriginal, type LocationSelection as LocationSelectionOriginal, type MessageEnvelope as MessageEnvelopeOriginal, type MetaSiteSpecialEvent as MetaSiteSpecialEventOriginal, type MetaSiteSpecialEventPayloadOneOf as MetaSiteSpecialEventPayloadOneOfOriginal, type MultiServiceAppointments as MultiServiceAppointmentsOriginal, type NamespaceChanged as NamespaceChangedOriginal, Namespace as NamespaceOriginal, type NamespaceWithLiterals as NamespaceWithLiteralsOriginal, type Notifications as NotificationsOriginal, type OdeditorAssigned as OdeditorAssignedOriginal, type OdeditorUnassigned as OdeditorUnassignedOriginal, type OwnerFlow as OwnerFlowOriginal, type PicassoAssigned as PicassoAssignedOriginal, type PicassoUnassigned as PicassoUnassignedOriginal, PlacementType as PlacementTypeOriginal, type PlacementTypeWithLiterals as PlacementTypeWithLiteralsOriginal, Reason as ReasonOriginal, type ReasonWithLiterals as ReasonWithLiteralsOriginal, RequestedFields as RequestedFieldsOriginal, type RequestedFieldsWithLiterals as RequestedFieldsWithLiteralsOriginal, RequiredField as RequiredFieldOriginal, type RequiredFieldWithLiterals as RequiredFieldWithLiteralsOriginal, type RestoreInfo as RestoreInfoOriginal, type ServiceProvisioned as ServiceProvisionedOriginal, type ServiceRemoved as ServiceRemovedOriginal, SiteCreatedContext as SiteCreatedContextOriginal, type SiteCreatedContextWithLiterals as SiteCreatedContextWithLiteralsOriginal, type SiteCreated as SiteCreatedOriginal, type SiteDeleted as SiteDeletedOriginal, type SiteHardDeleted as SiteHardDeletedOriginal, type SiteMarkedAsTemplate as SiteMarkedAsTemplateOriginal, type SiteMarkedAsWixSite as SiteMarkedAsWixSiteOriginal, type SiteProperties as SitePropertiesOriginal, type SitePublished as SitePublishedOriginal, type SitePurgedExternally as SitePurgedExternallyOriginal, type SiteRenamed as SiteRenamedOriginal, type SiteTransferred as SiteTransferredOriginal, type SiteUndeleted as SiteUndeletedOriginal, type SiteUnpublished as SiteUnpublishedOriginal, type SiteUrlChanged as SiteUrlChangedOriginal, type StaffSelection as StaffSelectionOriginal, StaffSelectionTiming as StaffSelectionTimingOriginal, type StaffSelectionTimingWithLiterals as StaffSelectionTimingWithLiteralsOriginal, State as StateOriginal, type StateWithLiterals as StateWithLiteralsOriginal, Strategy as StrategyOriginal, type StrategyWithLiterals as StrategyWithLiteralsOriginal, type StudioAssigned as StudioAssignedOriginal, type StudioTwoAssigned as StudioTwoAssignedOriginal, type StudioTwoUnassigned as StudioTwoUnassignedOriginal, type StudioUnassigned as StudioUnassignedOriginal, Timing as TimingOriginal, type TimingWithLiterals as TimingWithLiteralsOriginal, type UpdateBookingsSettingsRequest as UpdateBookingsSettingsRequestOriginal, type UpdateBookingsSettingsResponse as UpdateBookingsSettingsResponseOriginal, type UserDomainMediaDisabled as UserDomainMediaDisabledOriginal, type UserDomainMediaEnabled as UserDomainMediaEnabledOriginal, WebhookIdentityType as WebhookIdentityTypeOriginal, type WebhookIdentityTypeWithLiterals as WebhookIdentityTypeWithLiteralsOriginal, type WixelAssigned as WixelAssignedOriginal, type WixelUnassigned as WixelUnassignedOriginal, type __PublicMethodMetaInfo, getBookingsSettings, updateBookingsSettings };
