...
interface MigrationBadgeUpdated {
    migrationBadge?: MigrationBadge;
}
interface MigrationBadge {
    /**
     * Badge ID.
     * @format GUID
     * @readonly
...
interface MigrationBadgeCreated {
    migrationBadge?: MigrationBadge;
}
...
/** @enumType */
type PositionWithLiterals = Position | 'LAST' | 'FIRST' | 'AFTER';
interface MoveBadgeResponse {
}
...
/** @docsIgnore */
type UpdateBadgeValidationErrors = {
 ...
 * @webhook
 * @eventType wix.badges.v4.badge_created
 * @serviceIdentifier wix.badges.v4.Badges
 * @slug created
 */
declare function onBadgeCreated(handler: (event: BadgeCreatedEnvelope) => void | Promise<void>): void;
 ...
 * @permissionId BADGES.BADGE_READ
 * @webhook
 * @eventType wix.badges.v4.badge_deleted
 * @serviceIdentifier wix.badges.v4.Badges
 * @slug deleted
 */
declare function onBadgeDeleted(handler: (event: BadgeDeletedEnvelope) => void | Promise<void>): void;
 ...
 * @permissionId BADGES.BADGE_READ
 * @webhook
 * @eventType wix.badges.v4.badge_updated
 * @serviceIdentifier wix.badges.v4.Badges
 * @slug updated
 */
declare function onBadgeUpdated(handler: (event: BadgeUpdatedEnvelope) => void | Promise<void>): void;
/**
 * Creates a badge.
 ...
 * @fqn wix.badges.v4.Badges.CreateBadge
 */
declare function createBadge(badge: NonNullablePaths<Badge, `backgroundColor` | `textColor` | `title`, 0>): Promise<Badge>;
/**
 ...
 * @permissionId BADGES.BADGE_READ
 * @applicableIdentity APP
 * @returns Retrieved badge.
 * @fqn wix.badges.v4.Badges.GetBadge
 */
declare function getBadge(badgeId: string): Promise<Badge>;
/**
 ...
 * @permissionId BADGES.BADGE_READ
 * @applicableIdentity APP
 * @fqn wix.badges.v4.Badges.QueryBadges
 */
declare function queryBadges(): BadgesQueryBuilder;
...
interface BadgesQueryBuilder {
     ...
     * @param value - Value to compare against.
     */
    ge: (propertyName: '_id' | 'title' | 'description' | 'slug', value: any) => BadgesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    gt: (propertyName: '_id' | 'title' | 'description' | 'slug', value: any) => BadgesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    le: (propertyName: '_id' | 'title' | 'description' | 'slug', value: any) => BadgesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    lt: (propertyName: '_id' | 'title' | 'description' | 'slug', value: any) => BadgesQueryBuilder;
 ...
 * @requiredField query
 */
declare function typedQueryBadges(query: BadgeQuery): Promise<NonNullablePaths<QueryBadgesResponse, `badges`, 0>>;
interface BadgeQuerySpec extends QuerySpec {
    paging: 'offset';
    wql: [
        {
            fields: ['_id', 'description', 'permissionsEnabled', 'slug', 'title'];
            operators: '*';
            sort: 'ASC';
        }
    ];
}
type CommonQueryWithEntityContext = Query<Badge, BadgeQuerySpec>;
type BadgeQuery = {
    /**
    Filter object in the following format:
    `"filter" : {
...
declare const utils: {
    query: _wix_sdk_types.QueryHelpers<Badge, BadgeQuerySpec, BadgeQuery>;
};
/**
 * Updates a badge.
 * @param _id - Badge ID.
 ...
 * @applicableIdentity APP
 * @returns Updated badge with incremented revision and updated timestamp.
 * @fqn wix.badges.v4.Badges.UpdateBadge
 */
declare function updateBadge(_id: string, badge: UpdateBadge): Promise<Badge & {
    __validationErrorsType?: UpdateBadgeValidationErrors;
}>;
 ...
 * @applicableIdentity APP
 * @fqn wix.badges.v4.Badges.DeleteBadge
 */
declare function deleteBadge(badgeId: string): Promise<void>;
/**
 ...
 * @param ids - Ordered list of badge IDs.
 * @public
 * @requiredField ids
 * @permissionId BADGES.BADGE_UPDATE_DISPLAY_ORDER
 * @applicableIdentity APP
 * @fqn wix.badges.v4.Badges.UpdateBadgesDisplayOrder
 * @deprecated
 * @replacedBy wix.badges.v4.Badges.MoveBadge
 * @targetRemovalDate 2026-07-01
 */
declare function updateBadgesDisplayOrder(ids: string[]): Promise<NonNullablePaths<UpdateBadgesDisplayOrderResponse, `badges`, 0>>;
/**
 ...
 *
 * This affects how badges appear to site members and in the site dashboard.
 * @param badgeId - ID of the badge to move.
 * @public
 * @requiredField badgeId
 * @permissionId BADGES.BADGE_UPDATE_DISPLAY_ORDER
 * @applicableIdentity APP
 * @fqn wix.badges.v4.Badges.MoveBadge
 */
declare function moveBadge(badgeId: string, options?: MoveBadgeOptions): Promise<void>;
interface MoveBadgeOptions {
    /** Target position for the badge. */
    position?: PositionWithLiterals;
    /**
     * ID of the badge after which to position your badge.
