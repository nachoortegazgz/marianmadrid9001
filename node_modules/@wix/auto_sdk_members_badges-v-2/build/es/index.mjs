...
async function createBadge2(badge) {
  ...
  const payload = transformPaths2(
    renameKeysFromSDKRequestToRESTRequest({ badge }),
    [
      {
        transformFn: transformSDKImageToRESTImage,
        paths: [{ path: "badge.icon" }]
      }
    ]
  );
...
async function getBadge2(badgeId) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = renameKeysFromSDKRequestToRESTRequest({ badgeId });
  ...
  try {
    ...
    const transformedError = sdkTransformError(
      ...
      {
        spreadPathsToArguments: {},
        explicitPathsToArguments: { badgeId: "$[0]" },
        singleArgumentUnchanged: false
      },
      ["badgeId"]
    );
...
async function updateBadge2(_id, badge) {
  ...
  const payload = transformPaths2(
    renameKeysFromSDKRequestToRESTRequest({ badge: { ...badge, id: _id } }),
    [
      {
        transformFn: transformSDKImageToRESTImage,
        paths: [{ path: "badge.icon" }]
...
function updateBadgesDisplayOrder3(httpClient) {
  return (ids) => updateBadgesDisplayOrder2(
    ids,
    // @ts-ignore
    { httpClient }
  );
...
function moveBadge3(httpClient) {
  return (badgeId, options) => moveBadge2(
    badgeId,
    options,
    // @ts-ignore
    { httpClient }
...
var onBadgeCreated = /* @__PURE__ */ EventDefinition(
...
var onBadgeDeleted = /* @__PURE__ */ EventDefinition(
...
var onBadgeUpdated = /* @__PURE__ */ EventDefinition(
...
// src/badges-v4-badge-badges-v-2.context.ts
...
var moveBadge4 = /* @__PURE__ */ createRESTModule(moveBadge3);
var queryBadges4 = /* @__PURE__ */ createRESTModule(customQueryBadges);
var onBadgeCreated2 = /* @__PURE__ */ createEventModule(onBadgeCreated);
var onBadgeDeleted2 = /* @__PURE__ */ createEventModule(onBadgeDeleted);
var onBadgeUpdated2 = /* @__PURE__ */ createEventModule(onBadgeUpdated);
export {
  Position,
  SortOrder,
  WebhookIdentityType,
