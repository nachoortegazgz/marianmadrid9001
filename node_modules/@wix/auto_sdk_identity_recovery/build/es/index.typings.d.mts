...
interface SendActivationEmailRequest {
    /**
     * Identity ID of the member to activate.
     * @format GUID
     */
    identityId: string;
    /**
     * Options for the activation email, such as the email language and where to
     * redirect the member after a successful activation.
     */
...
interface RecoverRequest {
    /** Recovery token from the link in the recovery email. */
    recoveryToken: string;
    /** New password to set for the member. */
...
/**
 * Sends an activation email to the specified member.
 *
 * The email contains an activation link that the member clicks to activate
 * their account, completing the transition from an initial contact to an
 * active site member.
 * @param identityId - Identity ID of the member to activate.
 * @public
...
/**
 * Sets a new password for the member associated with the specified recovery token.
 *
 * The recovery token comes from the link in a recovery email, sent using
 * Send Recovery Email. After a successful recovery, the member can sign in
 * with the new password.
 * @param recoveryToken - Recovery token from the link in the recovery email.
 * @public
