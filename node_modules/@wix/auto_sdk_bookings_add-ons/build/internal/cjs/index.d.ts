...
import { AddOn, UpdateAddOn, BulkCreateAddOnsOptions, BulkCreateAddOnsResponse, MaskedAddOn, BulkUpdateAddOnsOptions, BulkUpdateAddOnsResponse, BulkDeleteAddOnsResponse, AddOnCreatedEnvelope, AddOnDeletedEnvelope, AddOnUpdatedEnvelope, AddOnsQueryBuilder, AddOnQuery, typedQueryAddOns } from './index.typings.js';
export { AccountInfo, AccountInfoMetadata, ActionEvent, AddOnAddOnInfoOneOf, AddOnQuerySpec, AddOnsQueryResult, Address, AddressHint, ApplicationError, BaseEventMetadata, BulkActionMetadata, BulkAddOnResult, BulkCreateAddOnsRequest, BulkDeleteAddOnsRequest, BulkDeleteAddOnsResponseBulkAddOnResult, BulkUpdateAddOnTagsByFilterRequest, BulkUpdateAddOnTagsByFilterResponse, BulkUpdateAddOnTagsRequest, BulkUpdateAddOnTagsResponse, BulkUpdateAddOnTagsResult, BulkUpdateAddOnsRequest, BulkUpdateAddOnsResponseBulkAddOnResult, BusinessSchedule, Categories, ChangeContext, ChangeContextPayloadOneOf, CommonQueryWithEntityContext, ConsentPolicy, CreateAddOnRequest, CreateAddOnResponse, CursorPaging, CursorPagingMetadata, CursorQuery, CursorQueryPagingMethodOneOf, Cursors, DayOfWeek, DayOfWeekWithLiterals, DeleteAddOnRequest, DeleteAddOnResponse, DomainEvent, DomainEventBodyOneOf, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, ExtendedFields, GeoCoordinates, GetAddOnRequest, GetAddOnResponse, IdentificationData, IdentificationDataIdOneOf, ItemMetadata, Locale, MediaItem, MediaItemMediaOneOf, MessageEnvelope, Money, Multilingual, PlacementType, PlacementTypeWithLiterals, Properties, PropertiesChange, QueryAddOnsRequest, QueryAddOnsResponse, QueryLocalizedAddOnsRequest, QueryLocalizedAddOnsResponse, ResolutionMethod, ResolutionMethodWithLiterals, RestoreInfo, SiteCloned, SiteCreated, SitePropertiesEvent, SitePropertiesNotification, SortOrder, SortOrderWithLiterals, Sorting, SpecialHourPeriod, SupportedLanguage, TagList, Tags, TimePeriod, Translation, UpdateAddOnRequest, UpdateAddOnResponse, WebhookIdentityType, WebhookIdentityTypeWithLiterals, utils } from './index.typings.js';
...
interface CreateAddOnSignature {
     ...
     */
    (addOn: AddOn): Promise<NonNullablePaths<AddOn, `durationInMinutes` | `maxQuantity` | `price.value` | `price.currency` | `tags.privateTags.tagIds`, 2>>;
}
...
interface GetAddOnSignature {
     ...
     */
    (addOnId: string): Promise<NonNullablePaths<AddOn, `durationInMinutes` | `maxQuantity` | `price.value` | `price.currency` | `tags.privateTags.tagIds`, 2>>;
}
...
interface UpdateAddOnSignature {
     ...
     */
    (_id: string, addOn: NonNullablePaths<UpdateAddOn, `revision`, 0>): Promise<NonNullablePaths<AddOn, `durationInMinutes` | `maxQuantity` | `price.value` | `price.currency` | `tags.privateTags.tagIds`, 2>>;
}
...
declare function customQueryAddOns(httpClient: HttpClient): {
    (): AddOnsQueryBuilder;
    (query: AddOnQuery): ReturnType<typeof typedQueryAddOns>;
};
