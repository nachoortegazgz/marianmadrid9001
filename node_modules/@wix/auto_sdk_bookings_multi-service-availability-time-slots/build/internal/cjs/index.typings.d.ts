 ...
 */
declare function listMultiServiceAvailabilityTimeSlots(options?: ListMultiServiceAvailabilityTimeSlotsOptions): Promise<NonNullablePaths<ListMultiServiceAvailabilityTimeSlotsResponse, `timeSlots` | `timeSlots.${number}.location.locationType`, 3> & {
