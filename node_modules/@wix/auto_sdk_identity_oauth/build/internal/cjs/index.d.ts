...
interface TokenSignature {
     ...
     */
    (options?: TokenOptions): Promise<NonNullablePaths<RawHttpResponse, `body` | `headers` | `headers.${number}.key` | `headers.${number}.value`, 2>>;
}
...
interface JwksSignature {
     ...
     */
    (): Promise<NonNullablePaths<RawHttpResponse, `body` | `headers` | `headers.${number}.key` | `headers.${number}.value`, 2>>;
}
...
interface TokenInfoSignature {
     ...
     */
    (options?: TokenInfoOptions): Promise<NonNullablePaths<TokenInfoResponse, `active` | `subjectType` | `subjectId` | `clientId`, 0>>;
}
...
interface UserInfoSignature {
     ...
     */
    (): Promise<NonNullablePaths<UserInfoResponse, `sub`, 0>>;
}
