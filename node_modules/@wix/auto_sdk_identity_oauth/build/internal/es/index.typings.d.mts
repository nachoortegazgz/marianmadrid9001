 ...
 */
declare function token(options?: TokenOptions): Promise<NonNullablePaths<RawHttpResponse, `body` | `headers` | `headers.${number}.key` | `headers.${number}.value`, 2>>;
 ...
 * @fqn wix.identity.oauth2.v1.Oauth2Ng.Jwks
 */
declare function jwks(): Promise<NonNullablePaths<RawHttpResponse, `body` | `headers` | `headers.${number}.key` | `headers.${number}.value`, 2>>;
/**
 * Token Introspection Endpoint.
 * @public
 * @fqn wix.identity.oauth2.v1.Oauth2Ng.TokenInfo
 */
declare function tokenInfo(options?: TokenInfoOptions): Promise<NonNullablePaths<TokenInfoResponse, `active` | `subjectType` | `subjectId` | `clientId`, 0>>;
 ...
 */
declare function userInfo(): Promise<NonNullablePaths<UserInfoResponse, `sub`, 0>>;

export { type ActionEvent, type AuthorizeRequest, type DeviceAuthorizationInfoRequest, type DeviceAuthorizationInfoResponse, type DeviceAuthorizeRequest, type DeviceAuthorizeResponse, type DeviceCodeRequest, type DeviceCodeResponse, type DeviceVerifyRequest, type DeviceVerifyResponse, type DeviceVerifyV2Request, type DeviceVerifyV2Response, type DomainEvent, type DomainEventBodyOneOf, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type HeadersEntry, type InvalidateUserCodeRequest, type InvalidateUserCodeResponse, type JwksRequest, type PathParametersEntry, type QueryParametersEntry, type RawHttpRequest, type RawHttpResponse, type RefreshToken, type RestoreInfo, type RevokeRefreshTokenRequest, type RevokeRefreshTokenResponse, SubjectType, type SubjectTypeWithLiterals, type TokenInfoOptions, type TokenInfoResponse, type TokenOptions, type UserBlockedEvent, type UserDeletedEvent, type UserInfoRequest, type UserInfoResponse, jwks, token, tokenInfo, userInfo };
