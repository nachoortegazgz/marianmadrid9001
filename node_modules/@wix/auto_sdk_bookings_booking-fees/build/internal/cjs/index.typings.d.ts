 ...
 */
declare function listBookingFeesByBookingIds(options?: ListBookingFeesByBookingIdsOptions): Promise<NonNullablePaths<ListBookingFeesByBookingIdsResponse, `bookingFees` | `bookingFees.${number}.cancellationFee.price.value` | `bookingFees.${number}.cancellationFee.price.currency` | `bookingFees.${number}.cancellationFee.status` | `bookingFees.${number}.cancellationFee.trigger`, 4> & {
 ...
 */
declare function collectAppliedBookingFees(orderId: string, options?: NonNullablePaths<CollectAppliedBookingFeesOptions, `additionalFeeId`, 0>): Promise<NonNullablePaths<CollectAppliedBookingFeesResponse, `collectedPrice.amount` | `collectedPrice.formattedAmount`, 1> & {
