...
import { Index, ListIndexesOptions, ListIndexesResponse, ListAvailableIndexesResponse, IndexCreatedEnvelope, IndexDeletedEnvelope, IndexUpdatedEnvelope } from './index.typings.mjs';
export { AccountInfo, AccountInfoMetadata, ActionEvent, BaseEventMetadata, CreateIndexRequest, CreateIndexResponse, DomainEvent, DomainEventBodyOneOf, DropIndexRequest, DropIndexResponse, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, Environment, EnvironmentWithLiterals, EventMetadata, Failure, Field, IdentificationData, IdentificationDataIdOneOf, IndexSource, IndexSourceWithLiterals, ListAvailableIndexesRequest, ListIndexesRequest, MessageEnvelope, Order, OrderWithLiterals, Paging, PagingMetadata, RestoreInfo, Status, StatusWithLiterals, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.mjs';
...
interface CreateIndexSignature {
     ...
     */
    (dataCollectionId: string, index: NonNullablePaths<Index, `fields` | `fields.${number}.path` | `name`, 2>): Promise<NonNullablePaths<Index, `_id` | `name` | `fields` | `fields.${number}.path` | `fields.${number}.order` | `status` | `failure.code` | `failure.description` | `unique` | `caseInsensitive` | `source`, 2>>;
}
...
interface ListAvailableIndexesSignature {
     ...
     */
    (dataCollectionId: string): Promise<NonNullablePaths<ListAvailableIndexesResponse, `regular1Field` | `regular3Field` | `unique1Field`, 0>>;
}
declare const onIndexCreated$1: EventDefinition<IndexCreatedEnvelope, "wix.data.v2.index_created">;
declare const onIndexDeleted$1: EventDefinition<IndexDeletedEnvelope, "wix.data.v2.index_deleted">;
declare const onIndexUpdated$1: EventDefinition<IndexUpdatedEnvelope, "wix.data.v2.index_updated">;
 ...
 */
declare const onIndexCreated: BuildEventDefinition<typeof onIndexCreated$1> & typeof onIndexCreated$1;
/**
 * Triggered when an index is dropped.
 */
declare const onIndexDeleted: BuildEventDefinition<typeof onIndexDeleted$1> & typeof onIndexDeleted$1;
/**
 ...
 */
declare const onIndexUpdated: BuildEventDefinition<typeof onIndexUpdated$1> & typeof onIndexUpdated$1;

export { Index, IndexCreatedEnvelope, IndexDeletedEnvelope, IndexUpdatedEnvelope, ListAvailableIndexesResponse, ListIndexesOptions, ListIndexesResponse, createIndex, dropIndex, listAvailableIndexes, listIndexes, onIndexCreated, onIndexDeleted, onIndexUpdated };
