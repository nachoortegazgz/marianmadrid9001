 ...
 */
declare function createIndex(dataCollectionId: string, index: NonNullablePaths<Index, `fields` | `fields.${number}.path` | `name`, 2>): Promise<NonNullablePaths<Index, `_id` | `name` | `fields` | `fields.${number}.path` | `fields.${number}.order` | `status` | `failure.code` | `failure.description` | `unique` | `caseInsensitive` | `source`, 2>>;
/**
 ...
 */
declare function listAvailableIndexes(dataCollectionId: string): Promise<NonNullablePaths<ListAvailableIndexesResponse, `regular1Field` | `regular3Field` | `unique1Field`, 0>>;
