...
__export(meta_exports, {
  ...
  CollectionOperationOriginal: () => CollectionOperation,
  CollectionTypeOriginal: () => CollectionType,
  DataOperationOriginal: () => DataOperation,
  DirectionOriginal: () => Direction,
  DraftItemsPluginConflictActionOriginal: () => DraftItemsPluginConflictAction,
  DraftItemsRemovalActionOriginal: () => DraftItemsRemovalAction,
  FieldPluginTypeOriginal: () => FieldPluginType,
  FormatOriginal: () => Format,
  IndexSourceOriginal: () => IndexSource,
  IndexStatusOriginal: () => IndexStatus,
  LifecycleStatusOriginal: () => LifecycleStatus,
  OrderOriginal: () => Order,
  PageLinkTypeOriginal: () => PageLinkType,
  PagingModeOriginal: () => PagingMode,
  PermissionOriginal: () => Permission,
  PluginTypeOriginal: () => PluginType,
  PublishPluginConflictActionOriginal: () => PublishPluginConflictAction,
  QueryOperatorOriginal: () => QueryOperator,
  RoleOriginal: () => Role,
  SegmentOriginal: () => Segment,
  SortOrderOriginal: () => SortOrder,
  StatusOriginal: () => Status,
  TenantModeOriginal: () => TenantMode,
  TypeOriginal: () => Type,
  WebhookIdentityTypeOriginal: () => WebhookIdentityType,
  addCatalogPlugin: () => addCatalogPlugin2,
  addCmsPlugin: () => addCmsPlugin2,
  addDataCollectionPlugin: () => addDataCollectionPlugin2,
  addDraftItemsPlugin: () => addDraftItemsPlugin2,
  addMultilingualPlugin: () => addMultilingualPlugin2,
  addPublishPlugin: () => addPublishPlugin2,
  addUrlizedPlugin: () => addUrlizedPlugin2,
  createDataCollection: () => createDataCollection2,
  createDataCollectionField: () => createDataCollectionField2,
  deleteCatalogPlugin: () => deleteCatalogPlugin2,
  deleteCmsPlugin: () => deleteCmsPlugin2,
  deleteDataCollection: () => deleteDataCollection2,
  deleteDataCollectionField: () => deleteDataCollectionField2,
  deleteDataCollectionPlugin: () => deleteDataCollectionPlugin2,
  deleteDraftItemsPlugin: () => deleteDraftItemsPlugin2,
  deleteMultilingualPlugin: () => deleteMultilingualPlugin2,
  deletePublishPlugin: () => deletePublishPlugin2,
  deleteUrlizedPlugin: () => deleteUrlizedPlugin2,
  getDataCollection: () => getDataCollection2,
  listDataCollections: () => listDataCollections2,
  patchDataCollection: () => patchDataCollection2,
  patchDataCollectionField: () => patchDataCollectionField2,
...
function addPublishPlugin(payload) {
  function __addPublishPlugin({ host }) {
    const metadata = {
      ...
      url: resolveComWixpressCloudDataApiCollectionserviceDataCollectionServiceUrl(
        { protoPath: "/v2/collections/add-publish-plugin", data: payload, host }
      ),
      data: payload,
      transformResponse: (payload2) => (0, import_transform_paths.transformPaths)(payload2, [
        {
...
function addUrlizedPlugin(payload) {
  function __addUrlizedPlugin({ host }) {
    const metadata = {
      ...
      url: resolveComWixpressCloudDataApiCollectionserviceDataCollectionServiceUrl(
        { protoPath: "/v2/collections/add-urlized-plugin", data: payload, host }
      ),
      data: payload,
      transformResponse: (payload2) => (0, import_transform_paths.transformPaths)(payload2, [
        {
...
function addCmsPlugin(payload) {
  function __addCmsPlugin({ host }) {
    const metadata = {
      ...
      url: resolveComWixpressCloudDataApiCollectionserviceDataCollectionServiceUrl(
        { protoPath: "/v2/collections/add-cms-plugin", data: payload, host }
      ),
      data: payload,
      transformResponse: (payload2) => (0, import_transform_paths.transformPaths)(payload2, [
        {
...
function deleteCmsPlugin(payload) {
  function __deleteCmsPlugin({ host }) {
    const metadata = {
      ...
      url: resolveComWixpressCloudDataApiCollectionserviceDataCollectionServiceUrl(
        { protoPath: "/v2/collections/delete-cms-plugin", data: payload, host }
      ),
      data: payload,
      transformResponse: (payload2) => (0, import_transform_paths.transformPaths)(payload2, [
        {
...
function addCatalogPlugin(payload) {
  function __addCatalogPlugin({ host }) {
    const metadata = {
      ...
      url: resolveComWixpressCloudDataApiCollectionserviceDataCollectionServiceUrl(
        { protoPath: "/v2/collections/add-catalog-plugin", data: payload, host }
      ),
      data: payload,
      transformResponse: (payload2) => (0, import_transform_paths.transformPaths)(payload2, [
        {
...
// src/data-v2-data-collection-collections.types.ts
...
var FieldPluginType = /* @__PURE__ */ ((FieldPluginType2) => {
  ...
  FieldPluginType2["CATEGORY_FIELD"] = "CATEGORY_FIELD";
  FieldPluginType2["CATEGORY_CONSUMER"] = "CATEGORY_CONSUMER";
  FieldPluginType2["PRIMARY_CATEGORY_FIELD"] = "PRIMARY_CATEGORY_FIELD";
...
var PluginType = /* @__PURE__ */ ((PluginType2) => {
  ...
  PluginType2["CMS"] = "CMS";
  PluginType2["CATALOG"] = "CATALOG";
  PluginType2["CATEGORIES"] = "CATEGORIES";
  PluginType2["DRAFT_ITEMS"] = "DRAFT_ITEMS";
  return PluginType2;
})(PluginType || {});
...
function patchDataCollection2() {
  const payload = { dataCollection: { id: ":dataCollectionId" } };
  const getRequestOptions = patchDataCollection(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function addDataCollectionPlugin2() {
  const payload = {};
  const getRequestOptions = addDataCollectionPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteDataCollectionPlugin2() {
  const payload = {};
  const getRequestOptions = deleteDataCollectionPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function addPublishPlugin2() {
  const payload = {};
  const getRequestOptions = addPublishPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/add-publish-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function deletePublishPlugin2() {
  const payload = {};
  const getRequestOptions = deletePublishPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/delete-publish-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function addUrlizedPlugin2() {
  const payload = {};
  const getRequestOptions = addUrlizedPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/add-urlized-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function deleteUrlizedPlugin2() {
  const payload = {};
  const getRequestOptions = deleteUrlizedPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/delete-urlized-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function addMultilingualPlugin2() {
  const payload = {};
  const getRequestOptions = addMultilingualPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/add-multilingual-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function deleteMultilingualPlugin2() {
  const payload = {};
  const getRequestOptions = deleteMultilingualPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/delete-multilingual-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function addCmsPlugin2() {
  const payload = {};
  const getRequestOptions = addCmsPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/add-cms-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function deleteCmsPlugin2() {
  const payload = {};
  const getRequestOptions = deleteCmsPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/delete-cms-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function addCatalogPlugin2() {
  const payload = {};
  const getRequestOptions = addCatalogPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/add-catalog-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function deleteCatalogPlugin2() {
  const payload = {};
  const getRequestOptions = deleteCatalogPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/delete-catalog-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function addDraftItemsPlugin2() {
  const payload = {};
  const getRequestOptions = addDraftItemsPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/add-draft-items-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function deleteDraftItemsPlugin2() {
  const payload = {};
  const getRequestOptions = deleteDraftItemsPlugin(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/collections/delete-draft-items-plugin",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function patchDataCollectionField2() {
  const payload = { dataCollectionId: ":dataCollectionId" };
  const getRequestOptions = patchDataCollectionField(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
0 && (module.exports = {
  AccessLevelOriginal,
  CollectionOperationOriginal,
  CollectionTypeOriginal,
  DataOperationOriginal,
  DirectionOriginal,
  DraftItemsPluginConflictActionOriginal,
  DraftItemsRemovalActionOriginal,
  FieldPluginTypeOriginal,
  FormatOriginal,
  IndexSourceOriginal,
  IndexStatusOriginal,
  LifecycleStatusOriginal,
  OrderOriginal,
  PageLinkTypeOriginal,
  PagingModeOriginal,
  PermissionOriginal,
  PluginTypeOriginal,
  PublishPluginConflictActionOriginal,
  QueryOperatorOriginal,
  RoleOriginal,
  SegmentOriginal,
  SortOrderOriginal,
  StatusOriginal,
