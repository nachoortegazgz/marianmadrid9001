...
| allowWebpAvifTransforms| true, false, undefined | undefined | boolean |
...
**Note on WebP and AVIF spatial transforms:**
- `allowWebpAvifTransforms`: When `true`, transform URLs for WebP and AVIF may include alignment, focal point, and crop. When `false` or omitted, those are stripped for WebP/AVIF (legacy default) so older pipelines do not send spatial parameters for these formats.
