interface AppsClonedFromTemplate {
    /**
    ...
    _id?: string;
    /**
     * the ID of the meta site to which the template is attached to.
     * @format GUID
     */
    metaSiteId?: string;
    /**
     * the ID of the source template meta site that is attached to the meta site.
     * @format GUID
     */
    originTemplateMetaSiteId?: string;
    /**
     * the apps that are cloned from the template.
     * @maxSize 500
     */
    apps?: App[];
}
interface App {
     ...
     * - Application name from meta-site event API - see MsmEventProtos (e.g. HTML_WEB, FLASH)
     * - Embedded service name from meta-site event API (e.g. WixCode, SiteMembers, Contacts)
     * - TPAs - appDefinitionId from app store (UUID)
     * @maxLength 36
     */
    appId?: string;
    /**
     * ID of the instance. Not guaranteed to be a UUID.
     * @maxLength 36
     */
    instanceId?: string;
    /**
     * ID of the instance of the origin.
     * @maxLength 36
     */
...
interface CreateBusinessScheduleRequest {
}
interface CreateBusinessScheduleResponse {
    /** @format GUID */
    scheduleId?: string;
}
interface ProvisionBookingsPlatformRequest {
    /**
     * ID of your app for which to provision the Bookings Platform. Learn more about [app identity in the Bookings Platform](https://dev.wix.com/docs/api-reference/business-solutions/bookings/bookings-platform/app-identity-in-the-bookings-platform).
     * @format GUID
     */
    appId: string;
    /**
     * Details about how available time slots are displayed to customers, including intervals between slots, timezone, and how customers select staff.
     *
     * Default:
     * - `splitInterval.sameAsDuration`: `false`
     * - `splitInterval.valueInMinutes`: `30`
     * - `displayTimeZone.basedOn`: `BUSINESS_TIME_ZONE`
     * - `displayTimeZone.customerCanChange`: `true`
     * - `staffSelection.strategy`: `CUSTOMER_MAY_CHOOSE`
     */
...
interface ProvisionBookingsPlatformResponse {
}
...
/**
 * Sets up the [Wix Bookings platform](https://dev.wix.com/docs/api-reference/business-solutions/bookings/bookings-platform/introduction) for an app.
 *
 * Use this method to initialize your app's booking infrastructure.
 * This creates a time slots configuration that controls how available time slots
 * are displayed to customers.
 *
 * The app must be installed on the site before calling this method.
 *
 * This method is idempotent. Calling it multiple times for the same app
 * has no effect if the configuration already exists.
 * @param appId - ID of your app for which to provision the Bookings Platform. Learn more about [app identity in the Bookings Platform](https://dev.wix.com/docs/api-reference/business-solutions/bookings/bookings-platform/app-identity-in-the-bookings-platform).
 * @public
 * @documentationMaturity preview
 * @requiredField appId
 * @permissionId BOOKINGS.BOOKING_MANAGE
 * @applicableIdentity APP
 * @fqn wix.bookings.provisioner.v1.ProvisionerService.ProvisionBookingsPlatform
 */
declare function provisionBookingsPlatform(appId: string, options?: ProvisionBookingsPlatformOptions): Promise<void>;
interface ProvisionBookingsPlatformOptions {
    /**
     * Details about how available time slots are displayed to customers, including intervals between slots, timezone, and how customers select staff.
     *
     * Default:
...
export { type AccountInfo, type ActionEvent, type App, type AppsClonedFromTemplate, type Asset, BasedOn, type BasedOnWithLiterals, type CreateBusinessScheduleRequest, type CreateBusinessScheduleResponse, type DeleteContext, DeleteStatus, type DeleteStatusWithLiterals, type DisplayTimeZone, type DomainEvent, type DomainEventBodyOneOf, type EditorlessAssigned, type EditorlessUnassigned, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type ExtendedFields, type IdentificationData, type IdentificationDataIdOneOf, type MessageEnvelope, type MetaSiteSpecialEvent, type MetaSiteSpecialEventPayloadOneOf, Namespace, type NamespaceChanged, type NamespaceWithLiterals, type OdeditorAssigned, type OdeditorUnassigned, type PicassoAssigned, type PicassoUnassigned, type ProvisionBookingsPlatformOptions, type ProvisionBookingsPlatformRequest, type ProvisionBookingsPlatformResponse, type RestoreInfo, type ServiceProvisioned, type ServiceRemoved, type SiteCreated, SiteCreatedContext, type SiteCreatedContextWithLiterals, type SiteDeleted, type SiteHardDeleted, type SiteMarkedAsTemplate, type SiteMarkedAsWixSite, type SitePublished, type SitePurgedExternally, type SiteRenamed, type SiteTransferred, type SiteUndeleted, type SiteUnpublished, type SiteUrlChanged, type SplitInterval, type StaffSelection, State, type StateWithLiterals, Strategy, type StrategyWithLiterals, type StudioAssigned, type StudioTwoAssigned, type StudioTwoUnassigned, type StudioUnassigned, type TimeSlotsConfiguration, type UserDomainMediaDisabled, type UserDomainMediaEnabled, WebhookIdentityType, type WebhookIdentityTypeWithLiterals, type WixelAssigned, type WixelUnassigned, provisionBookingsPlatform };
