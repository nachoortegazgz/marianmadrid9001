 ...
 * @fqn wix.members.usermembers.v1.UserMembers.QueryUserMembers
 */
declare function queryUserMembers(): UserMembersQueryBuilder;
...
interface UserMembersQueryBuilder {
     ...
     */
    eq: (propertyName: 'memberId' | 'userId' | 'siteMembersInstanceId' | 'metaSiteId' | '_createdDate' | 'status', value: any) => UserMembersQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ne: (propertyName: 'memberId' | 'userId' | 'siteMembersInstanceId' | 'metaSiteId' | '_createdDate' | 'status', value: any) => UserMembersQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ge: (propertyName: 'memberId' | 'userId' | 'siteMembersInstanceId' | 'metaSiteId' | '_createdDate', value: any) => UserMembersQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    gt: (propertyName: 'memberId' | 'userId' | 'siteMembersInstanceId' | 'metaSiteId' | '_createdDate', value: any) => UserMembersQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    le: (propertyName: 'memberId' | 'userId' | 'siteMembersInstanceId' | 'metaSiteId' | '_createdDate', value: any) => UserMembersQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    lt: (propertyName: 'memberId' | 'userId' | 'siteMembersInstanceId' | 'metaSiteId' | '_createdDate', value: any) => UserMembersQueryBuilder;
    ...
    in: (propertyName: 'memberId' | 'userId' | 'siteMembersInstanceId' | 'metaSiteId' | '_createdDate' | 'status', value: any) => UserMembersQueryBuilder;
    exists: (propertyName: 'memberId' | 'userId' | 'siteMembersInstanceId' | 'metaSiteId' | '_createdDate' | 'status', value: boolean) => UserMembersQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments. */
    ascending: (...propertyNames: Array<'memberId' | 'userId' | 'siteMembersInstanceId' | 'metaSiteId' | '_createdDate' | 'status'>) => UserMembersQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments. */
    descending: (...propertyNames: Array<'memberId' | 'userId' | 'siteMembersInstanceId' | 'metaSiteId' | '_createdDate' | 'status'>) => UserMembersQueryBuilder;
 ...
 * @requiredField query
 */
declare function typedQueryUserMembers(query: UserMemberQuery): Promise<NonNullablePaths<QueryUserMembersResponse, `userMembers` | `userMembers.${number}.photo._id` | `userMembers.${number}.photo.url` | `userMembers.${number}.photo.height` | `userMembers.${number}.photo.width` | `userMembers.${number}.privacyStatus` | `userMembers.${number}.status` | `userMembers.${number}.activityStatus`, 3>>;
interface UserMemberQuerySpec extends QuerySpec {
    paging: 'cursor';
    wql: [
        {
            fields: [
...
type CommonQueryWithEntityContext = Query<UserMember, UserMemberQuerySpec>;
type UserMemberQuery = {
    /**
    Cursor token pointing to a page of results. Not used in the first request. Following requests use the cursor token and not `filter` or `sort`.
    */
    cursorPaging?: {
...
declare const utils: {
    query: _wix_sdk_types.QueryHelpers<UserMember, UserMemberQuerySpec, UserMemberQuery>;
};

export { type ActionEvent, ActivityStatusStatus, type ActivityStatusStatusWithLiterals, type Asset, type CommonQueryWithEntityContext, type CursorPaging, type CursorPagingMetadata, type CursorQuery, type CursorQueryPagingMethodOneOf, type Cursors, type DeleteContext, DeleteStatus, type DeleteStatusWithLiterals, type DomainEvent, type DomainEventBodyOneOf, type EditorlessAssigned, type EditorlessUnassigned, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type Image, type MetaSiteSpecialEvent, type MetaSiteSpecialEventPayloadOneOf, Namespace, type NamespaceChanged, type NamespaceWithLiterals, type OdeditorAssigned, type OdeditorUnassigned, type PicassoAssigned, type PicassoUnassigned, PrivacyStatusStatus, type PrivacyStatusStatusWithLiterals, type QueryUserMembersRequest, type QueryUserMembersResponse, type RestoreInfo, type ServiceProvisioned, type ServiceRemoved, type SiteCreated, SiteCreatedContext, type SiteCreatedContextWithLiterals, type SiteDeleted, type SiteHardDeleted, type SiteMarkedAsTemplate, type SiteMarkedAsWixSite, type SitePublished, type SitePurgedExternally, type SiteRenamed, type SiteTransferred, type SiteUndeleted, type SiteUnpublished, type SiteUrlChanged, SortOrder, type SortOrderWithLiterals, type Sorting, State, type StateWithLiterals, Status, type StatusWithLiterals, type StudioAssigned, type StudioTwoAssigned, type StudioTwoUnassigned, type StudioUnassigned, type UserDomainMediaDisabled, type UserDomainMediaEnabled, type UserMember, type UserMemberQuery, type UserMemberQuerySpec, type UserMembersQueryBuilder, type UserMembersQueryResult, type WixelAssigned, type WixelUnassigned, queryUserMembers, typedQueryUserMembers, utils };
