...
// src/identity-roles-v1-user-users.types.ts
...
// src/identity-roles-v1-user-users.meta.ts
function removeMember2() {
  const payload = {};
  const getRequestOptions = removeMember(payload);
...
function searchTeam2() {
  const payload = {};
  const getRequestOptions = searchTeam(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getRolesInfo2() {
  const payload = {};
  const getRequestOptions = getRolesInfo(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function changeRoleV22() {
  const payload = {};
  const getRequestOptions = changeRoleV2(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function updateTeamMemberAssignments2() {
  const payload = {};
  const getRequestOptions = updateTeamMemberAssignments(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
export {
  AccountGroup as AccountGroupOriginal,
  ConditionAttributeType as ConditionAttributeTypeOriginal,
  Direction as DirectionOriginal,
  EditorType as EditorTypeOriginal,
  Effect as EffectOriginal,
  FacetType as FacetTypeOriginal,
  InviteStatus as InviteStatusOriginal,
  JoinedConditionOperator as JoinedConditionOperatorOriginal,
  OrderField as OrderFieldOriginal,
  PeopleType as PeopleTypeOriginal,
  PolicyType as PolicyTypeOriginal,
  ResourceType as ResourceTypeOriginal,
  RoleLevel as RoleLevelOriginal,
  RoleLevelRestriction as RoleLevelRestrictionOriginal,
  RoleVisibility as RoleVisibilityOriginal,
  ScopeLevel as ScopeLevelOriginal,
  SimpleConditionOperator as SimpleConditionOperatorOriginal,
  SubjectContextType as SubjectContextTypeOriginal,
  SubjectType as SubjectTypeOriginal,
  Visibility as VisibilityOriginal,
  changeRoleV22 as changeRoleV2,
  getRolesInfo2 as getRolesInfo,
  removeMember2 as removeMember,
  searchTeam2 as searchTeam,
  updateTeamMemberAssignments2 as updateTeamMemberAssignments
};
