...
__export(meta_exports, {
  AccountGroupOriginal: () => AccountGroup,
  ConditionAttributeTypeOriginal: () => ConditionAttributeType,
  DirectionOriginal: () => Direction,
  EditorTypeOriginal: () => EditorType,
  EffectOriginal: () => Effect,
  FacetTypeOriginal: () => FacetType,
  InviteStatusOriginal: () => InviteStatus,
  JoinedConditionOperatorOriginal: () => JoinedConditionOperator,
  OrderFieldOriginal: () => OrderField,
  PeopleTypeOriginal: () => PeopleType,
  PolicyTypeOriginal: () => PolicyType,
  ResourceTypeOriginal: () => ResourceType,
  RoleLevelOriginal: () => RoleLevel,
  RoleLevelRestrictionOriginal: () => RoleLevelRestriction,
  RoleVisibilityOriginal: () => RoleVisibility,
  ScopeLevelOriginal: () => ScopeLevel,
  ...
  VisibilityOriginal: () => Visibility,
  changeRoleV2: () => changeRoleV22,
  getRolesInfo: () => getRolesInfo2,
  removeMember: () => removeMember2,
  searchTeam: () => searchTeam2,
  updateTeamMemberAssignments: () => updateTeamMemberAssignments2
});
...
0 && (module.exports = {
  AccountGroupOriginal,
  ConditionAttributeTypeOriginal,
  DirectionOriginal,
  EditorTypeOriginal,
  EffectOriginal,
  FacetTypeOriginal,
  InviteStatusOriginal,
  JoinedConditionOperatorOriginal,
  OrderFieldOriginal,
  PeopleTypeOriginal,
  PolicyTypeOriginal,
  ResourceTypeOriginal,
  RoleLevelOriginal,
  RoleLevelRestrictionOriginal,
  RoleVisibilityOriginal,
  ScopeLevelOriginal,
