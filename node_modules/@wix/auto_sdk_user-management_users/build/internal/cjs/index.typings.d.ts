...
interface GetScopesByRoleRequest {
    /**
...
interface GetScopesByRoleResponse {
    /**
...
interface PredefinedRolesAreaV2 {
    /**
     * Area ID
     * @maxLength 50
     */
...
interface GetRolesBackofficeRequest {
    /**
     * The locale of the predefined roles names and descriptions. Defaults to English
     * @format LANGUAGE
     */
...
interface GetRolesBackofficeResponse {
    /**
...
interface GetScopesBackofficeRequest {
    /**
     * The locale of the scope areas names and descriptions. Defaults to English
     * @format LANGUAGE
     */
...
interface GetScopesBackofficeResponse {
    /**
 ...
 */
declare function searchTeam(options?: SearchTeamOptions): Promise<NonNullablePaths<SearchTeamResponse, `facets` | `facets.${number}.facetType` | `teamMembers` | `teamMembers.${number}.user._id` | `teamMembers.${number}.user.name.firstName` | `teamMembers.${number}.user.name.lastName` | `teamMembers.${number}.invite._id` | `teamMembers.${number}.invite.status`, 6>>;
