...
interface BookingLineItem {
     ...
     * not custom or customer locations. Used to resolve the price for `LOCATION` dynamic-pricing variants.
     * @internal
     * @format GUID
     */
     ...
     * @maxSize 40
     */
    serviceChoices?: V1ServiceChoices[];
    /**
     * Local start date and time of the booking. For example, `"2024-01-30T13:30:00"`.
     *
     * Used together with `localEndDate` and `timeZone` for duration-based pricing calculations.
     * @format LOCAL_DATE_TIME
     */
     ...
     *
     * Used together with `localStartDate` and `timeZone` for duration-based pricing calculations.
     * @format LOCAL_DATE_TIME
     */
...
interface BookingsPricingProviderConfig {
    /** URI to which the SPI Implementer is deployed. */
...
interface CalculatePriceEnvelope {
...
declare const provideHandlers: ServicePluginDefinition<{
     ...
     * }
     * ``` */
    calculatePrice(payload: CalculatePriceEnvelope): CalculatePriceResponse | Promise<CalculatePriceResponse>;
}>;

export { type PriceDescriptionInfo as $, type Address as A, type Booking as B, type CalculatePriceRequest as C, DurationUnitType as D, type ExtendedFields as E, type FlowControlSettings as F, type ParticipantChoices as G, type ServiceChoices as H, type IdentificationData as I, type ServiceChoice as J, type ServiceChoiceChoiceOneOf as K, type Location as L, MultiServiceBookingType as M, type Duration as N, type DateTimeRule as O, type PhoneCall as P, type ParticipantsRange as Q, ResourceTransparency as R, SelectionMethod as S, type MultiServiceBookingInfo as T, type BookedAddOn as U, ValueType as V, type CalculatePriceResponse as W, type CalculatePriceResponseTotalPriceOneOf as X, type BookingLineItem as Y, type ZonedDate as Z, type V1ServiceChoices as _, type BookingParticipantsInfoOneOf as a, type BookingsPricingProviderConfig as a0, type Context as a1, IdentificationDataIdentityType as a2, type ContextIdentificationData as a3, type ContextIdentificationDataIdOneOf as a4, type CalculatePriceEnvelope as a5, type BookedEntity as b, type BookedEntityItemOneOf as c, type BookedSlot as d, type BookedResource as e, LocationType as f, type ResourceSelection as g, type RequestedGenderValue as h, RequestedGender as i, type BookedSchedule as j, type ContactDetails as k, type AddressStreetOneOf as l, type StreetAddress as m, type AddressLocation as n, type Subdivision as o, provideHandlers as p, type CustomFormField as q, BookingStatus as r, PaymentStatus as s, SelectedPaymentOption as t, type BookingSource as u, Platform as v, Actor as w, type ParticipantNotification as x, type IdentificationDataIdOneOf as y, IdentityType as z };
