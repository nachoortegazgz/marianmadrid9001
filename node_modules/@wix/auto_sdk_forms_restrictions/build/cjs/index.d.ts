...
import { GetRestrictionsResponse } from './index.typings.js';
export { AscendPlan, AscendPlanWithLiterals, Feature, FeatureWithLiterals, GetRestrictionsRequest, Limit, PremiumRestrictions } from './index.typings.js';

declare function getRestrictions$1(httpClient: HttpClient): GetRestrictionsSignature;
interface GetRestrictionsSignature {
    /**
     ...
     */
    (): Promise<NonNullablePaths<GetRestrictionsResponse, `restrictions.features` | `restrictions.ascendPlan` | `totalFormCount`, 1>>;
}

declare const getRestrictions: MaybeContext<BuildRESTFunction<typeof getRestrictions$1> & typeof getRestrictions$1>;

export { GetRestrictionsResponse, getRestrictions };
