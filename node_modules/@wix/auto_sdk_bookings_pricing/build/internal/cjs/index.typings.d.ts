 ...
 */
declare function previewPrice(bookingLineItems: BookingLineItem[]): Promise<NonNullablePaths<PreviewPriceResponse, `priceInfo.calculatedPrice` | `priceInfo.priceDescription` | `priceInfo.priceDescriptionInfo.original` | `priceInfo.bookingLineItems`, 2> & {
 ...
 */
declare function calculatePrice(options?: CalculatePriceOptions): Promise<NonNullablePaths<CalculatePriceResponse, `priceInfo.calculatedPrice` | `priceInfo.priceDescription` | `priceInfo.priceDescriptionInfo.original` | `priceInfo.bookingLineItems`, 2> & {
...
export { Actor, type ActorWithLiterals, type Address, type AddressLocation, type AddressStreetOneOf, type BookedAddOn, type BookedEntity, type BookedEntityItemOneOf, type BookedResource, type BookedSchedule, type BookedSlot, type Booking, type BookingLineItem, type BookingParticipantsInfoOneOf, type BookingSource, BookingStatus, type BookingStatusWithLiterals, type CalculatePriceApplicationErrors, type CalculatePriceOptions, type CalculatePriceRequest, type CalculatePriceResponse, type ContactDetails, type CustomFormField, type DateTimeRule, type Duration, DurationUnitType, type DurationUnitTypeWithLiterals, type ExtendedFields, type FlowControlSettings, type IdentificationData, type IdentificationDataIdOneOf, IdentityType, type IdentityTypeWithLiterals, type Location, LocationType, type LocationTypeWithLiterals, type Money, type MultiServiceBookingInfo, MultiServiceBookingType, type MultiServiceBookingTypeWithLiterals, type ParticipantChoices, type ParticipantNotification, type ParticipantsRange, PaymentStatus, type PaymentStatusWithLiterals, type PhoneCall, Platform, type PlatformWithLiterals, type PreviewPriceApplicationErrors, type PreviewPriceRequest, type PreviewPriceResponse, type PreviewSubscriptionPaymentCountRequest, type PreviewSubscriptionPaymentCountResponse, type PriceDescriptionInfo, type PriceInfo, type PriceInfoTotalPriceOneOf, type PricingServiceChoices, RequestedGender, type RequestedGenderValue, type RequestedGenderWithLiterals, type ResourceSelection, ResourceTransparency, type ResourceTransparencyWithLiterals, SelectedPaymentOption, type SelectedPaymentOptionWithLiterals, SelectionMethod, type SelectionMethodWithLiterals, type ServiceChoice, type ServiceChoiceChoiceOneOf, type ServiceChoices, type StreetAddress, type Subdivision, SubscriptionFrequency, type SubscriptionFrequencyWithLiterals, ValueType, type ValueTypeWithLiterals, type ZonedDate, calculatePrice, previewPrice };
