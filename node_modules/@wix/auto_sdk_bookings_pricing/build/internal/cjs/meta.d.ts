...
interface BookingLineItem {
    ...
    /**
     * ID of the business location the booking takes place at. Only business locations are supported,
     * not custom or customer locations.
     *
     * Used to resolve the price for `LOCATION` dynamic-pricing variants. On Calculate Price it is derived server-side from the booking's slot; on Preview Price the caller may supply it.
     * @internal
     * @format GUID
     */
    ...
    /**
     * Base price of this line item on its own. `PriceInfo.totalPrice` is the total across all line items.
     * @internal
     * @readonly
     */
    calculatedPrice?: number | null;
    /**
     * This line item's share of `PriceInfo.deposit`, in proportion to its price.
     * @internal
     * @readonly
     */
    deposit?: number | null;
...
interface CalculatePriceRequest {
     ...
     * Must include `bookedEntity` details and participant information.
     * @replacedBy bookings
     * @targetRemovalDate 2027-02-25
     */
    booking?: Booking;
    /**
     * Existing [bookings](https://dev.wix.com/docs/rest/business-solutions/bookings/bookings/bookings-writer-v2/introduction) to calculate the base price for.
     * Each must include `bookedEntity` details and participant information.
     * @internal
     * @maxSize 40
     */
    bookings?: Booking[];
...
interface PreviewSubscriptionPaymentCountRequest {
    /**
     * ID of the [service](https://dev.wix.com/docs/rest/business-solutions/bookings/services/services-v2/introduction) to preview subscription payment count for.
     * @format GUID
     */
    serviceId?: string;
    /** Date from which to calculate remaining subscription payments. If not provided, remaining payments are calculated from the current date. */
    startDate?: Date | null;
}
interface PreviewSubscriptionPaymentCountResponse {
    /** Number of remaining subscription payments, calculated from `startDate` or from the current date if `startDate` is not provided. */
    paymentCount?: number;
    /** Billing frequency. */
...
/** @enumType */
type SubscriptionFrequencyWithLiterals = SubscriptionFrequency | 'MONTHLY';
/**
 * Money.
...
export { Actor as ActorOriginal, type ActorWithLiterals as ActorWithLiteralsOriginal, type AddressLocation as AddressLocationOriginal, type Address as AddressOriginal, type AddressStreetOneOf as AddressStreetOneOfOriginal, type BookedAddOn as BookedAddOnOriginal, type BookedEntityItemOneOf as BookedEntityItemOneOfOriginal, type BookedEntity as BookedEntityOriginal, type BookedResource as BookedResourceOriginal, type BookedSchedule as BookedScheduleOriginal, type BookedSlot as BookedSlotOriginal, type BookingLineItem as BookingLineItemOriginal, type Booking as BookingOriginal, type BookingParticipantsInfoOneOf as BookingParticipantsInfoOneOfOriginal, type BookingSource as BookingSourceOriginal, BookingStatus as BookingStatusOriginal, type BookingStatusWithLiterals as BookingStatusWithLiteralsOriginal, type CalculatePriceApplicationErrors as CalculatePriceApplicationErrorsOriginal, type CalculatePriceRequest as CalculatePriceRequestOriginal, type CalculatePriceResponse as CalculatePriceResponseOriginal, type ContactDetails as ContactDetailsOriginal, type CustomFormField as CustomFormFieldOriginal, type DateTimeRule as DateTimeRuleOriginal, type Duration as DurationOriginal, DurationUnitType as DurationUnitTypeOriginal, type DurationUnitTypeWithLiterals as DurationUnitTypeWithLiteralsOriginal, type ExtendedFields as ExtendedFieldsOriginal, type FlowControlSettings as FlowControlSettingsOriginal, type IdentificationDataIdOneOf as IdentificationDataIdOneOfOriginal, type IdentificationData as IdentificationDataOriginal, IdentityType as IdentityTypeOriginal, type IdentityTypeWithLiterals as IdentityTypeWithLiteralsOriginal, type Location as LocationOriginal, LocationType as LocationTypeOriginal, type LocationTypeWithLiterals as LocationTypeWithLiteralsOriginal, type Money as MoneyOriginal, type MultiServiceBookingInfo as MultiServiceBookingInfoOriginal, MultiServiceBookingType as MultiServiceBookingTypeOriginal, type MultiServiceBookingTypeWithLiterals as MultiServiceBookingTypeWithLiteralsOriginal, type ParticipantChoices as ParticipantChoicesOriginal, type ParticipantNotification as ParticipantNotificationOriginal, type ParticipantsRange as ParticipantsRangeOriginal, PaymentStatus as PaymentStatusOriginal, type PaymentStatusWithLiterals as PaymentStatusWithLiteralsOriginal, type PhoneCall as PhoneCallOriginal, Platform as PlatformOriginal, type PlatformWithLiterals as PlatformWithLiteralsOriginal, type PreviewPriceApplicationErrors as PreviewPriceApplicationErrorsOriginal, type PreviewPriceRequest as PreviewPriceRequestOriginal, type PreviewPriceResponse as PreviewPriceResponseOriginal, type PreviewSubscriptionPaymentCountRequest as PreviewSubscriptionPaymentCountRequestOriginal, type PreviewSubscriptionPaymentCountResponse as PreviewSubscriptionPaymentCountResponseOriginal, type PriceDescriptionInfo as PriceDescriptionInfoOriginal, type PriceInfo as PriceInfoOriginal, type PriceInfoTotalPriceOneOf as PriceInfoTotalPriceOneOfOriginal, type PricingServiceChoices as PricingServiceChoicesOriginal, RequestedGender as RequestedGenderOriginal, type RequestedGenderValue as RequestedGenderValueOriginal, type RequestedGenderWithLiterals as RequestedGenderWithLiteralsOriginal, type ResourceSelection as ResourceSelectionOriginal, ResourceTransparency as ResourceTransparencyOriginal, type ResourceTransparencyWithLiterals as ResourceTransparencyWithLiteralsOriginal, SelectedPaymentOption as SelectedPaymentOptionOriginal, type SelectedPaymentOptionWithLiterals as SelectedPaymentOptionWithLiteralsOriginal, SelectionMethod as SelectionMethodOriginal, type SelectionMethodWithLiterals as SelectionMethodWithLiteralsOriginal, type ServiceChoiceChoiceOneOf as ServiceChoiceChoiceOneOfOriginal, type ServiceChoice as ServiceChoiceOriginal, type ServiceChoices as ServiceChoicesOriginal, type StreetAddress as StreetAddressOriginal, type Subdivision as SubdivisionOriginal, SubscriptionFrequency as SubscriptionFrequencyOriginal, type SubscriptionFrequencyWithLiterals as SubscriptionFrequencyWithLiteralsOriginal, ValueType as ValueTypeOriginal, type ValueTypeWithLiterals as ValueTypeWithLiteralsOriginal, type ZonedDate as ZonedDateOriginal, type __PublicMethodMetaInfo, calculatePrice, previewPrice };
