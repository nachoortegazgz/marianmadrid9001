...
import { BookingLineItem, PreviewPriceResponse, PreviewPriceApplicationErrors, CalculatePriceOptions, CalculatePriceResponse, CalculatePriceApplicationErrors } from './index.typings.js';
export { Actor, ActorWithLiterals, Address, AddressLocation, AddressStreetOneOf, BookedAddOn, BookedEntity, BookedEntityItemOneOf, BookedResource, BookedSchedule, BookedSlot, Booking, BookingParticipantsInfoOneOf, BookingSource, BookingStatus, BookingStatusWithLiterals, CalculatePriceRequest, ContactDetails, CustomFormField, DateTimeRule, Duration, DurationUnitType, DurationUnitTypeWithLiterals, ExtendedFields, FlowControlSettings, IdentificationData, IdentificationDataIdOneOf, IdentityType, IdentityTypeWithLiterals, Location, LocationType, LocationTypeWithLiterals, Money, MultiServiceBookingInfo, MultiServiceBookingType, MultiServiceBookingTypeWithLiterals, ParticipantChoices, ParticipantNotification, ParticipantsRange, PaymentStatus, PaymentStatusWithLiterals, PhoneCall, Platform, PlatformWithLiterals, PreviewPriceRequest, PreviewSubscriptionPaymentCountRequest, PreviewSubscriptionPaymentCountResponse, PriceDescriptionInfo, PriceInfo, PriceInfoTotalPriceOneOf, PricingServiceChoices, RequestedGender, RequestedGenderValue, RequestedGenderWithLiterals, ResourceSelection, ResourceTransparency, ResourceTransparencyWithLiterals, SelectedPaymentOption, SelectedPaymentOptionWithLiterals, SelectionMethod, SelectionMethodWithLiterals, ServiceChoice, ServiceChoiceChoiceOneOf, ServiceChoices, StreetAddress, Subdivision, SubscriptionFrequency, SubscriptionFrequencyWithLiterals, ValueType, ValueTypeWithLiterals, ZonedDate } from './index.typings.js';
...
interface PreviewPriceSignature {
     ...
     * @param - Booking line items to preview pricing for.
     ...
     */
    (bookingLineItems: BookingLineItem[]): Promise<NonNullablePaths<PreviewPriceResponse, `priceInfo.calculatedPrice` | `priceInfo.priceDescription` | `priceInfo.priceDescriptionInfo.original` | `priceInfo.bookingLineItems`, 2> & {
...
interface CalculatePriceSignature {
     ...
     */
    (options?: CalculatePriceOptions): Promise<NonNullablePaths<CalculatePriceResponse, `priceInfo.calculatedPrice` | `priceInfo.priceDescription` | `priceInfo.priceDescriptionInfo.original` | `priceInfo.bookingLineItems`, 2> & {
...
export { BookingLineItem, CalculatePriceApplicationErrors, CalculatePriceOptions, CalculatePriceResponse, PreviewPriceApplicationErrors, PreviewPriceResponse, calculatePrice, previewPrice };
