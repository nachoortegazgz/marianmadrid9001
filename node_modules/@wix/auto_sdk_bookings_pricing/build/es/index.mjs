    ...
    const serializedData = transformPaths(payload, [
      {
        ...
        paths: [
          ...
          { path: "bookingLineItems.calculatedPrice" },
          { path: "bookingLineItems.deposit" },
      ...
      transformResponse: (payload2) => transformPaths(payload2, [
        {
          ...
          paths: [
            ...
            { path: "priceInfo.bookingLineItems.calculatedPrice" },
            { path: "priceInfo.bookingLineItems.deposit" },
            {
...
var SubscriptionFrequency = /* @__PURE__ */ ((SubscriptionFrequency2) => {
  SubscriptionFrequency2["MONTHLY"] = "MONTHLY";
...
async function calculatePrice2(options) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = renameKeysFromSDKRequestToRESTRequest({
...
function calculatePrice3(httpClient) {
  return (options) => calculatePrice2(
    options,
    // @ts-ignore
    { httpClient }
  );
...
var previewPrice4 = /* @__PURE__ */ createRESTModule(previewPrice3);
var calculatePrice4 = /* @__PURE__ */ createRESTModule(calculatePrice3);
export {
  Actor,
  BookingStatus,
  DurationUnitType,
  ...
  SubscriptionFrequency,
  ValueType,
  calculatePrice4 as calculatePrice,
  previewPrice4 as previewPrice
};
