...
export {
  ...
  ItemAvailabilityStatus as ItemAvailabilityStatusOriginal,
  ...
  addToCurrentCart2 as addToCurrentCart,
  ...
  updateCurrentCartLineItemQuantity2 as updateCurrentCartLineItemQuantity
};
