...
interface UpdateCurrentCartSignature {
     ...
     * @deprecated Replaced by Cart V2 Update Current Cart.
     */
...
interface RemoveLineItemsFromCurrentCartSignature {
     ...
     * @deprecated Replaced by Cart V2 Remove Line Items From Current Cart.
     */
...
interface CreateCheckoutFromCurrentCartSignature {
     ...
     * @deprecated Cart V2 has no equivalent method. Cart V2 has no separate checkout step: prepare the cart, then call Place Order directly.
     */
    (options?: CreateCheckoutFromCurrentCartOptions): Promise<NonNullablePaths<CreateCheckoutResponse, `checkoutId`, 0>>;
}
...
interface RemoveCouponFromCurrentCartSignature {
     ...
     * >+ This method requires [visitor or member authentication](https://dev.wix.com/docs/overview/auth-permissions/identities).
     * >+ After a cart is updated, call [Refresh Cart](https://dev.wix.com/docs/sdk/frontend-modules/ecom/refresh-cart) to update the cart's UI elements and trigger the Cart Updated event.
     * @deprecated Replaced by Cart V2 Remove Coupon From Current Cart.
     */
...
interface UpdateCurrentCartLineItemQuantitySignature {
     ...
     * @deprecated Replaced by Cart V2 Update Line Items In Current Cart.
     */
...
interface DeleteCurrentCartSignature {
     ...
     * >**Note:**
     * >This method requires [visitor or member authentication](https://dev.wix.com/docs/overview/auth-permissions/identities).
     * @deprecated Replaced by Cart V2 Delete Current Cart.
     */
    (): Promise<void>;
}
