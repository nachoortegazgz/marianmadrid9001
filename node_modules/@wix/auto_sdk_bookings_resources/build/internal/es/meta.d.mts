...
interface Resource extends ResourceCompositionDetailsOneOf {
     ...
     *
     * You can create a resources without specifying a type. However, this field
     * must be set to ensure that a resource can be allocated at a requested time
     * slot and to prevent double bookings.
     *
     * The value to assign to this field depends on how the type is managed. There are 2 options:
     * - The resource type is managed by the business in the site's dashboard or via the `/v2/resource-types` endpoint.
    ...
    appId?: string | null;
    /**
     * Specifies whether the resource is managed by a [Wix user](https://dev.wix.com/docs/rest/articles/getting-started/about-identities#wix-user)
     * or by an app.
     *
     * Default: `WIX_USER`
     * @internal
     * @immutable
     */
    managementType?: ManagementTypeWithLiterals;
    /** Extensions enabling users to save custom data related to the resource. */
    extendedFields?: ExtendedFields;
    /**
     * Resource ranking for automatic ranked resource selection.
     *
     * Default: `0`
     * @internal
     * @max 5
    ...
    ranking?: number | null;
    /**
     * Whether the resource can be offered to customers in booking flows, for example
     * when retrieving [availability time slots](https://dev.wix.com/docs/rest/business-solutions/bookings/time-slots/time-slots-v2/introduction).
     *
     * When `false`, customers can't book the resource, but the business can still use
     * it for internal operations, such as managing its working hours and calendar events.
     * For example, a [staff member](https://dev.wix.com/docs/rest/business-solutions/bookings/staff-members/introduction)
     * who doesn't provide services.
     *
     * Default: `true`
     * @internal
     */
