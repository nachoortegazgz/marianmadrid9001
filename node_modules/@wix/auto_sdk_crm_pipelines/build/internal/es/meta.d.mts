...
interface Pipeline {
    ...
    doneStage?: DoneStage;
    /**
     * Pipeline classification, used to distinguish between different kinds of pipelines.
     *
     * Default: `GENERIC`
     * @internal
     */
    type?: PipelineTypeWithLiterals;
    /**
    ...
    /**
     * Namespace that scopes the pipeline to the owning app or context.
     * @internal
     * @immutable
     * @minLength 1
     * @maxLength 50
