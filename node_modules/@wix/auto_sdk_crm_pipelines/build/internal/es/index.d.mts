...
interface CreatePipelineSignature {
     ...
     */
    (pipeline: NonNullablePaths<Pipeline, `doneStage` | `doneStage.allowedOutcomes` | `doneStage.name` | `name` | `stages` | `stages.${number}.name`, 2>): Promise<NonNullablePaths<Pipeline, `stages` | `doneStage.allowedOutcomes` | `tags.privateTags.tagIds`, 2> & {
...
interface GetPipelineSignature {
     ...
     */
    (pipelineId: string): Promise<NonNullablePaths<Pipeline, `stages` | `doneStage.allowedOutcomes` | `tags.privateTags.tagIds`, 2>>;
}
...
interface UpdatePipelineSignature {
     ...
     */
    (_id: string, pipeline: NonNullablePaths<UpdatePipeline, `revision`, 0>): Promise<NonNullablePaths<Pipeline, `stages` | `doneStage.allowedOutcomes` | `tags.privateTags.tagIds`, 2> & {
...
interface BulkUpdatePipelineTagsByFilterSignature {
     ...
     */
    (filter: Record<string, any>, options?: BulkUpdatePipelineTagsByFilterOptions): Promise<NonNullablePaths<BulkUpdatePipelineTagsByFilterResponse, `jobId`, 0> & {
