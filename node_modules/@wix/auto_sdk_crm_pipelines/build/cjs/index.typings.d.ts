 ...
 */
declare function createPipeline(pipeline: NonNullablePaths<Pipeline, `doneStage` | `doneStage.allowedOutcomes` | `doneStage.name` | `name` | `stages` | `stages.${number}.name`, 2>): Promise<NonNullablePaths<Pipeline, `stages` | `doneStage.allowedOutcomes` | `tags.privateTags.tagIds`, 2> & {
 ...
 */
declare function getPipeline(pipelineId: string): Promise<NonNullablePaths<Pipeline, `stages` | `doneStage.allowedOutcomes` | `tags.privateTags.tagIds`, 2>>;
/**
 * Updates a pipeline.
 *
 ...
 */
declare function updatePipeline(_id: string, pipeline: NonNullablePaths<UpdatePipeline, `revision`, 0>): Promise<NonNullablePaths<Pipeline, `stages` | `doneStage.allowedOutcomes` | `tags.privateTags.tagIds`, 2> & {
 ...
 * @requiredField query
 */
declare function typedQueryPipelines(query: PipelineQuery): Promise<NonNullablePaths<QueryPipelinesResponse, `pipelines`, 0>>;
...
declare const utils: {
    query: _wix_sdk_types.QueryHelpers<Pipeline, PipelineQuerySpec, PipelineQuery>;
};
/**
 ...
 */
declare function bulkUpdatePipelineTagsByFilter(filter: Record<string, any>, options?: BulkUpdatePipelineTagsByFilterOptions): Promise<NonNullablePaths<BulkUpdatePipelineTagsByFilterResponse, `jobId`, 0> & {
