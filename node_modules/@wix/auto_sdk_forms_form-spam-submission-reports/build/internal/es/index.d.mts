...
interface CheckForSpamSignature {
     ...
     */
    (submission: NonNullablePaths<FormSubmission, `formId`, 0>): Promise<NonNullablePaths<CheckForSpamResponse, `spam` | `spamReport.reportReason`, 1>>;
}
...
interface CreateFormSpamSubmissionReportSignature {
     ...
     */
    (formSpamSubmissionReport: NonNullablePaths<FormSpamSubmissionReport, `formId` | `reportReason` | `submissions` | `submitter`, 0>): Promise<NonNullablePaths<FormSpamSubmissionReport, `formId` | `namespace` | `reportReason` | `submissionStatusAtReport` | `orderDetails.checkoutId`, 1> & {
...
interface GetFormSpamSubmissionReportSignature {
     ...
     */
    (formSpamSubmissionReportId: string): Promise<NonNullablePaths<FormSpamSubmissionReport, `formId` | `namespace` | `reportReason` | `submissionStatusAtReport` | `orderDetails.checkoutId`, 1>>;
}
...
interface BulkDeleteFormSpamSubmissionReportByFilterSignature {
     ...
     */
    (filter: Record<string, any>): Promise<NonNullablePaths<BulkDeleteFormSpamSubmissionReportByFilterResponse, `jobId`, 0>>;
}
...
interface ReportNotSpamSubmissionSignature {
     ...
     */
    (formSpamSubmissionReportId: string): Promise<NonNullablePaths<ReportNotSpamSubmissionResponse, `submission.formId` | `submission.namespace` | `submission.status` | `submission.seen` | `submission.orderDetails.itemSubtotal` | `submission.orderDetails.checkoutId` | `submission.tags.tags.tagIds`, 3>>;
}
...
interface ReportSpamSubmissionSignature {
     ...
     */
    (submissionId: string, reportReason: ReportReasonWithLiterals, options?: ReportSpamSubmissionOptions): Promise<NonNullablePaths<ReportSpamSubmissionResponse, `formSpamSubmissionReport.formId` | `formSpamSubmissionReport.namespace` | `formSpamSubmissionReport.reportReason` | `formSpamSubmissionReport.submissionStatusAtReport` | `formSpamSubmissionReport.orderDetails.checkoutId`, 2>>;
}
...
interface CountFormSpamSubmissionReportsSignature {
     ...
     */
    (formIds: string[], namespace: string): Promise<NonNullablePaths<CountFormSpamSubmissionReportsResponse, `formsSpamSubmissionReportsCount` | `formsSpamSubmissionReportsCount.${number}.formId` | `formsSpamSubmissionReportsCount.${number}.totalCount`, 2>>;
}

declare function customQueryFormSpamSubmissionReportsByNamespace(httpClient: HttpClient): {
    (): FormSpamSubmissionReportsQueryBuilder;
    (query: FormSpamSubmissionReportQuery): ReturnType<typeof typedQueryFormSpamSubmissionReportsByNamespace>;
};
