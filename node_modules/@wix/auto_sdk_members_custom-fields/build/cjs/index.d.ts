...
interface CreateCustomFieldSignature {
     ...
     */
    (field: NonNullablePaths<CustomField, `name`, 0>): Promise<NonNullablePaths<CustomField, `defaultPrivacy` | `fieldType` | `socialType` | `fieldOrigin` | `appliesTo` | `section`, 0> & {
...
interface GetCustomFieldSignature {
     ...
     */
    (_id: string): Promise<NonNullablePaths<GetCustomFieldResponse, `field.defaultPrivacy` | `field.fieldType` | `field.socialType` | `field.fieldOrigin` | `field.appliesTo` | `field.section`, 1>>;
}
...
interface ListCustomFieldsSignature {
     ...
     */
    (options?: ListCustomFieldsOptions): Promise<NonNullablePaths<ListCustomFieldsResponse, `fields` | `fields.${number}.defaultPrivacy` | `fields.${number}.fieldType` | `fields.${number}.socialType` | `fields.${number}.fieldOrigin` | `fields.${number}.appliesTo` | `fields.${number}.section`, 2>>;
}
...
interface UpdateCustomFieldSignature {
     ...
     */
    (_id: string, field: NonNullablePaths<UpdateCustomField, `revision`, 0>): Promise<NonNullablePaths<CustomField, `defaultPrivacy` | `fieldType` | `socialType` | `fieldOrigin` | `appliesTo` | `section`, 0> & {
...
interface UpdateCustomFieldsOrderSignature {
     ...
     */
    (fieldIds: string[], options?: UpdateCustomFieldsOrderOptions): Promise<NonNullablePaths<UpdateCustomFieldsOrderResponse, `fields` | `fields.${number}.defaultPrivacy` | `fields.${number}.fieldType` | `fields.${number}.socialType` | `fields.${number}.fieldOrigin` | `fields.${number}.appliesTo` | `fields.${number}.section` | `section`, 2>>;
}
