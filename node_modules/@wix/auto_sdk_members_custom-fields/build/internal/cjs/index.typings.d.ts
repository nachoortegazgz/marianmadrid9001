 ...
 */
declare function createCustomField(field: NonNullablePaths<CustomField, `name`, 0>): Promise<NonNullablePaths<CustomField, `defaultPrivacy` | `fieldType` | `socialType` | `fieldOrigin` | `appliesTo` | `section`, 0> & {
    __applicationErrorsType?: CreateCustomFieldApplicationErrors;
}>;
/**
 ...
 */
declare function getCustomField(_id: string): Promise<NonNullablePaths<GetCustomFieldResponse, `field.defaultPrivacy` | `field.fieldType` | `field.socialType` | `field.fieldOrigin` | `field.appliesTo` | `field.section`, 1>>;
/**
 ...
 */
declare function listCustomFields(options?: ListCustomFieldsOptions): Promise<NonNullablePaths<ListCustomFieldsResponse, `fields` | `fields.${number}.defaultPrivacy` | `fields.${number}.fieldType` | `fields.${number}.socialType` | `fields.${number}.fieldOrigin` | `fields.${number}.appliesTo` | `fields.${number}.section`, 2>>;
 ...
 */
declare function updateCustomField(_id: string, field: NonNullablePaths<UpdateCustomField, `revision`, 0>): Promise<NonNullablePaths<CustomField, `defaultPrivacy` | `fieldType` | `socialType` | `fieldOrigin` | `appliesTo` | `section`, 0> & {
    __applicationErrorsType?: UpdateCustomFieldApplicationErrors;
}>;
 ...
 */
declare function deleteCustomField(_id: string, revision: string): Promise<void>;
/**
 ...
 */
declare function hideCustomField(_id: string, revision: string): Promise<void>;
/**
 ...
 */
declare function updateCustomFieldsOrder(fieldIds: string[], options?: UpdateCustomFieldsOrderOptions): Promise<NonNullablePaths<UpdateCustomFieldsOrderResponse, `fields` | `fields.${number}.defaultPrivacy` | `fields.${number}.fieldType` | `fields.${number}.socialType` | `fields.${number}.fieldOrigin` | `fields.${number}.appliesTo` | `fields.${number}.section` | `section`, 2>>;
interface UpdateCustomFieldsOrderOptions {
    /** The section which the fields belong to. */
    section?: SectionWithLiterals;
}

export { type AccountInfo, type ActionEvent, AppliesTo, type AppliesToWithLiterals, type Asset, type CreateCustomFieldApplicationErrors, type CreateCustomFieldRequest, type CreateCustomFieldResponse, type CustomField, type DefaultPrivacyChanged, type DeleteContext, type DeleteCustomFieldRequest, type DeleteCustomFieldResponse, DeleteStatus, type DeleteStatusWithLiterals, type DomainEvent, type DomainEventBodyOneOf, type EditorlessAssigned, type EditorlessUnassigned, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type GetCustomFieldRequest, type GetCustomFieldResponse, type HideCustomFieldRequest, type HideCustomFieldResponse, type IdentificationData, type IdentificationDataIdOneOf, type IncorrectFieldTypeData, type IncorrectPrivacyData, type InvalidSocialTypeData, type ListCustomFieldsOptions, type ListCustomFieldsRequest, type ListCustomFieldsResponse, type MessageEnvelope, type MetaSiteSpecialEvent, type MetaSiteSpecialEventPayloadOneOf, Namespace, type NamespaceChanged, type NamespaceWithLiterals, type OdeditorAssigned, type OdeditorUnassigned, Origin, type OriginWithLiterals, type Paging, type PagingMetadata, type PicassoAssigned, type PicassoUnassigned, Privacy, type PrivacyWithLiterals, type ReservedFieldNameNonEditable, type RestoreInfo, Section, type SectionWithLiterals, type ServiceProvisioned, type ServiceRemoved, type SiteCreated, SiteCreatedContext, type SiteCreatedContextWithLiterals, type SiteDeleted, type SiteHardDeleted, type SiteMarkedAsTemplate, type SiteMarkedAsWixSite, type SitePublished, type SitePurgedExternally, type SiteRenamed, type SiteTransferred, type SiteUndeleted, type SiteUnpublished, type SiteUrlChanged, SocialTypeType, type SocialTypeTypeWithLiterals, State, type StateWithLiterals, type StudioAssigned, type StudioTwoAssigned, type StudioTwoUnassigned, type StudioUnassigned, Type, type TypeWithLiterals, type UpdateCustomField, type UpdateCustomFieldApplicationErrors, type UpdateCustomFieldRequest, type UpdateCustomFieldResponse, type UpdateCustomFieldsOrderOptions, type UpdateCustomFieldsOrderRequest, type UpdateCustomFieldsOrderResponse, type UserDomainMediaDisabled, type UserDomainMediaEnabled, WebhookIdentityType, type WebhookIdentityTypeWithLiterals, type WixelAssigned, type WixelUnassigned, createCustomField, deleteCustomField, getCustomField, hideCustomField, listCustomFields, updateCustomField, updateCustomFieldsOrder };
