...
interface PreviewMergeContactsSignature {
     ...
     * @param - Target contact ID.
     * @param - Preview merge contacts options.
     */
    (targetContactId: string, options?: PreviewMergeContactsOptions): Promise<NonNullablePaths<PreviewMergeContactsResponse, `contact._id` | `contact.revision` | `contact.source.sourceType` | `contact.lastActivity.activityType` | `contact.info.emails.items` | `contact.info.emails.items.${number}.tag` | `contact.info.emails.items.${number}.email` | `contact.info.phones.items` | `contact.info.phones.items.${number}.tag` | `contact.info.phones.items.${number}.phone` | `contact.info.addresses.items` | `contact.info.addresses.items.${number}.tag` | `contact.info.addresses.items.${number}.address.streetAddress.number` | `contact.info.addresses.items.${number}.address.streetAddress.name` | `contact.info.labelKeys.items` | `contact.primaryEmail.subscriptionStatus` | `contact.primaryEmail.deliverabilityStatus` | `contact.primaryPhone.subscriptionStatus`, 7> & {
...
interface ListFacetsSignature {
     ...
     * @param - List facets options.
     */
    (options?: ListFacetsOptions): Promise<NonNullablePaths<ListFacetsResponse, `facets` | `facets.${number}.facetType`, 2>>;
}
...
interface QueryFacetsSignature {
     ...
     * Facets include labels and subscription statuses.
     * @param - Query facets options.
     */
    (options?: QueryFacetsOptions): Promise<NonNullablePaths<QueryFacetsResponse, `facets` | `facets.${number}.facetType`, 2>>;
}
...
interface BulkDeleteContactsSignature {
     ...
     * @param - Bulk delete contacts options.
     */
    (options?: BulkDeleteContactsOptions): Promise<NonNullablePaths<BulkDeleteContactsResponse, `jobId`, 0> & {
...
interface BulkUpdateContactsSignature {
     ...
     * The job's status can be retrieved with Get Bulk Job.
     * @param - Bulk update contacts options.
     */
    (options?: BulkUpdateContactsOptions): Promise<NonNullablePaths<BulkUpdateContactsResponse, `jobId`, 0>>;
}
...
interface BulkLabelAndUnlabelContactsSignature {
     ...
     * The job might not complete right away, depending on its size.
     * The job's status can be retrieved with Get Bulk Job.
     * @param - Bulk label and unlabel contacts options.
     */
    (options?: BulkLabelAndUnlabelContactsOptions): Promise<NonNullablePaths<BulkLabelAndUnlabelContactsResponse, `jobId`, 0> & {
...
declare const previewMergeContacts: MaybeContext<BuildRESTFunction<typeof previewMergeContacts$1> & typeof previewMergeContacts$1>;
