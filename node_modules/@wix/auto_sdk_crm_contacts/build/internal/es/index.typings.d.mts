...
/** @enumType */
type ContactSourceTypeWithLiterals = ContactSourceType | 'OTHER' | 'ADMIN' | 'WIX_APP' | 'IMPORT' | 'THIRD_PARTY' | 'WIX_BOOKINGS' | 'WIX_CHAT' | 'WIX_EMAIL_MARKETING' | 'WIX_EVENTS' | 'WIX_FORMS' | 'WIX_GROUPS' | 'WIX_HOTELS' | 'WIX_MARKET_PLACE' | 'WIX_MUSIC' | 'WIX_RESTAURANTS' | 'WIX_SITE_MEMBERS' | 'WIX_STORES' | 'WIX_CODE' | 'HOPP';
...
interface PrimaryPhone {
    ...
    subscriptionStatus?: SubscriptionStatusWithLiterals;
    /**
     * Indicates last reported status of sent SMS messages.
     *
     * Default:
     * - `NO_PHONE_DELIVERABILITY_STATUS` when the phone is not a valid E164 phone.
     * - `NOT_SET` when the phone is a valid E164 phone.
     * @internal
     * @readonly
     */
...
/** @enumType */
type MemberStatusWithLiterals = MemberStatus | 'PENDING' | 'ACTIVE' | 'DELETED' | 'BLOCKED' | 'OFFLINE';
...
/** @enumType */
type RoleWithLiterals = Role | 'UNSPECIFIED_ROLE' | 'OWNER' | 'CONTRIBUTOR';
...
/** @enumType */
type ContactFieldSetWithLiterals = ContactFieldSet | 'BASIC' | 'COMMUNICATION_DETAILS' | 'EXTENDED' | 'FULL';
/** List of contacts. */
...
/** @enumType */
type ContactsFacetTypeWithLiterals = ContactsFacetType | 'UNKNOWN' | 'ALL_CONTACTS' | 'NOT_LABELED' | 'LABEL' | 'SUBSCRIPTION_STATUS' | 'MEMBERSHIP_STATUS';
...
/** @enumType */
type ActionWithLiterals = Action | 'UNKNOWN' | 'UPDATED' | 'CREATED';
interface Error {
    /** Error code. */
    code?: string;
    /** Error details. */
...
/** @enumType */
type UpsertContactResponseActionWithLiterals = UpsertContactResponseAction | 'UNKNOWN' | 'UPDATED' | 'CREATED';
...
/** @enumType */
type GetContactResponseTypeWithLiterals = GetContactResponseType | 'REGULAR' | 'IMPLICIT' | 'MERGED';
...
/** @enumType */
type SubmitOperationWithLiterals = SubmitOperation | 'UNKNOWN' | 'CREATE' | 'UPDATE';
...
/** @docsIgnore */
type PreviewMergeContactsApplicationErrors = {
    code?: 'CONTACT_NOT_FOUND';
    description?: string;
    data?: Record<string, any>;
} | {
...
/** @docsIgnore */
type ListContactsApplicationErrors = {
...
/** @docsIgnore */
type BulkLabelAndUnlabelContactsApplicationErrors = {
    code?: 'NEITHER_FILTER_NOR_SEARCH';
    description?: string;
    data?: Record<string, any>;
};
 ...
 */
declare function createContact(info: ContactInfo, options?: CreateContactOptions): Promise<NonNullablePaths<CreateContactResponse, `contact._id` | `contact.revision` | `contact.source.sourceType` | `contact.lastActivity.activityType` | `contact.info.emails.items` | `contact.info.emails.items.${number}.tag` | `contact.info.emails.items.${number}.email` | `contact.info.phones.items` | `contact.info.phones.items.${number}.tag` | `contact.info.phones.items.${number}.phone` | `contact.info.addresses.items` | `contact.info.addresses.items.${number}.tag` | `contact.info.addresses.items.${number}.address.streetAddress.number` | `contact.info.addresses.items.${number}.address.streetAddress.name` | `contact.info.labelKeys.items` | `contact.primaryEmail.subscriptionStatus` | `contact.primaryEmail.deliverabilityStatus` | `contact.primaryPhone.subscriptionStatus`, 7> & {
 ...
 */
declare function updateContact(contactId: string, info: ContactInfo, revision: number, options?: UpdateContactOptions): Promise<NonNullablePaths<UpdateContactResponse, `contact._id` | `contact.revision` | `contact.source.sourceType` | `contact.lastActivity.activityType` | `contact.info.emails.items` | `contact.info.emails.items.${number}.tag` | `contact.info.emails.items.${number}.email` | `contact.info.phones.items` | `contact.info.phones.items.${number}.tag` | `contact.info.phones.items.${number}.phone` | `contact.info.addresses.items` | `contact.info.addresses.items.${number}.tag` | `contact.info.addresses.items.${number}.address.streetAddress.number` | `contact.info.addresses.items.${number}.address.streetAddress.name` | `contact.info.labelKeys.items` | `contact.primaryEmail.subscriptionStatus` | `contact.primaryEmail.deliverabilityStatus` | `contact.primaryPhone.subscriptionStatus`, 7> & {
 ...
 */
declare function mergeContacts(targetContactId: string, targetContactRevision: number, options?: MergeContactsOptions): Promise<NonNullablePaths<MergeContactsResponse, `contact._id` | `contact.revision` | `contact.source.sourceType` | `contact.lastActivity.activityType` | `contact.info.emails.items` | `contact.info.emails.items.${number}.tag` | `contact.info.emails.items.${number}.email` | `contact.info.phones.items` | `contact.info.phones.items.${number}.tag` | `contact.info.phones.items.${number}.phone` | `contact.info.addresses.items` | `contact.info.addresses.items.${number}.tag` | `contact.info.addresses.items.${number}.address.streetAddress.number` | `contact.info.addresses.items.${number}.address.streetAddress.name` | `contact.info.labelKeys.items` | `contact.primaryEmail.subscriptionStatus` | `contact.primaryEmail.deliverabilityStatus` | `contact.primaryPhone.subscriptionStatus`, 7> & {
 ...
 * @permissionId CONTACTS.MERGE
 * @applicableIdentity APP
 * @fqn com.wixpress.contacts.core.api.v4.ContactsServiceV4.PreviewMergeContacts
 */
declare function previewMergeContacts(targetContactId: string, options?: PreviewMergeContactsOptions): Promise<NonNullablePaths<PreviewMergeContactsResponse, `contact._id` | `contact.revision` | `contact.source.sourceType` | `contact.lastActivity.activityType` | `contact.info.emails.items` | `contact.info.emails.items.${number}.tag` | `contact.info.emails.items.${number}.email` | `contact.info.phones.items` | `contact.info.phones.items.${number}.tag` | `contact.info.phones.items.${number}.phone` | `contact.info.addresses.items` | `contact.info.addresses.items.${number}.tag` | `contact.info.addresses.items.${number}.address.streetAddress.number` | `contact.info.addresses.items.${number}.address.streetAddress.name` | `contact.info.labelKeys.items` | `contact.primaryEmail.subscriptionStatus` | `contact.primaryEmail.deliverabilityStatus` | `contact.primaryPhone.subscriptionStatus`, 7> & {
 ...
 */
declare function labelContact(contactId: string, labelKeys: string[]): Promise<NonNullablePaths<LabelContactResponse, `contact._id` | `contact.revision` | `contact.source.sourceType` | `contact.lastActivity.activityType` | `contact.info.emails.items` | `contact.info.emails.items.${number}.tag` | `contact.info.emails.items.${number}.email` | `contact.info.phones.items` | `contact.info.phones.items.${number}.tag` | `contact.info.phones.items.${number}.phone` | `contact.info.addresses.items` | `contact.info.addresses.items.${number}.tag` | `contact.info.addresses.items.${number}.address.streetAddress.number` | `contact.info.addresses.items.${number}.address.streetAddress.name` | `contact.info.labelKeys.items` | `contact.primaryEmail.subscriptionStatus` | `contact.primaryEmail.deliverabilityStatus` | `contact.primaryPhone.subscriptionStatus`, 7> & {
 ...
 */
declare function unlabelContact(contactId: string, labelKeys: string[]): Promise<NonNullablePaths<UnlabelContactResponse, `contact._id` | `contact.revision` | `contact.source.sourceType` | `contact.lastActivity.activityType` | `contact.info.emails.items` | `contact.info.emails.items.${number}.tag` | `contact.info.emails.items.${number}.email` | `contact.info.phones.items` | `contact.info.phones.items.${number}.tag` | `contact.info.phones.items.${number}.phone` | `contact.info.addresses.items` | `contact.info.addresses.items.${number}.tag` | `contact.info.addresses.items.${number}.address.streetAddress.number` | `contact.info.addresses.items.${number}.address.streetAddress.name` | `contact.info.labelKeys.items` | `contact.primaryEmail.subscriptionStatus` | `contact.primaryEmail.deliverabilityStatus` | `contact.primaryPhone.subscriptionStatus`, 7> & {
 ...
 * @fqn com.wixpress.contacts.core.api.v4.ContactsServiceV4.ListContacts
 */
declare function listContacts(options?: ListContactsOptions): Promise<NonNullablePaths<ListContactsResponse, `contacts` | `contacts.${number}._id` | `contacts.${number}.revision` | `contacts.${number}.source.sourceType` | `contacts.${number}.lastActivity.activityType` | `contacts.${number}.primaryEmail.subscriptionStatus` | `contacts.${number}.primaryEmail.deliverabilityStatus` | `contacts.${number}.primaryPhone.subscriptionStatus`, 3> & {
...
interface ContactsQueryBuilder {
     ...
     * @param value - Value to compare against.
     */
    ge: (propertyName: '_createdDate' | '_updatedDate' | 'lastActivity.activityDate' | 'info.birthdate', value: any) => ContactsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    gt: (propertyName: '_createdDate' | '_updatedDate' | 'lastActivity.activityDate' | 'info.birthdate', value: any) => ContactsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    le: (propertyName: '_createdDate' | '_updatedDate' | 'lastActivity.activityDate' | 'info.birthdate', value: any) => ContactsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    lt: (propertyName: '_createdDate' | '_updatedDate' | 'lastActivity.activityDate' | 'info.birthdate', value: any) => ContactsQueryBuilder;
     ...
     */
    hasSome: (propertyName: string, value: any[]) => ContactsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `values`.
     * @param values - List of values to compare against.
     */
    hasAll: (propertyName: string, value: any[]) => ContactsQueryBuilder;
...
interface ContactQuerySpec extends QuerySpec {
    ...
    wql: [
        ...
        },
        {
            ...
            operators: ['$eq', '$exists', '$in', '$ne', '$startsWith'];
            sort: 'BOTH';
        },
        {
 ...
 * @permissionId CONTACTS.VIEW
 * @applicableIdentity APP
 * @fqn com.wixpress.contacts.core.api.v4.ContactsServiceV4.ListFacets
 */
declare function listFacets(options?: ListFacetsOptions): Promise<NonNullablePaths<ListFacetsResponse, `facets` | `facets.${number}.facetType`, 2>>;
 ...
 * @permissionId CONTACTS.VIEW
 * @applicableIdentity APP
 * @fqn com.wixpress.contacts.core.api.v4.ContactsServiceV4.QueryFacets
 */
declare function queryFacets(options?: QueryFacetsOptions): Promise<NonNullablePaths<QueryFacetsResponse, `facets` | `facets.${number}.facetType`, 2>>;
 ...
 * @permissionId MEMBERS.MEMBER_DELETE
 * @applicableIdentity APP
 * @fqn com.wixpress.contacts.core.api.v4.ContactsServiceV4.BulkDeleteContacts
 */
declare function bulkDeleteContacts(options?: BulkDeleteContactsOptions): Promise<NonNullablePaths<BulkDeleteContactsResponse, `jobId`, 0> & {
 ...
 * @permissionId CONTACTS.MODIFY
 * @applicableIdentity APP
 * @fqn com.wixpress.contacts.core.api.v4.ContactsServiceV4.BulkUpdateContacts
 */
declare function bulkUpdateContacts(options?: BulkUpdateContactsOptions): Promise<NonNullablePaths<BulkUpdateContactsResponse, `jobId`, 0>>;
 ...
 * @permissionId CONTACTS.MODIFY
 * @applicableIdentity APP
 * @fqn com.wixpress.contacts.core.api.v4.ContactsServiceV4.BulkLabelAndUnlabelContacts
 */
declare function bulkLabelAndUnlabelContacts(options?: BulkLabelAndUnlabelContactsOptions): Promise<NonNullablePaths<BulkLabelAndUnlabelContactsResponse, `jobId`, 0> & {
