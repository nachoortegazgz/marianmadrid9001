...
__export(meta_exports, {
  ...
  ContactActivityTypeOriginal: () => ContactActivityType,
  ContactFieldSetOriginal: () => ContactFieldSet,
  ContactSourceTypeOriginal: () => ContactSourceType,
  ContactsFacetTypeOriginal: () => ContactsFacetType,
  EmailDeliverabilityStatusOriginal: () => EmailDeliverabilityStatus,
  EmailTagOriginal: () => EmailTag,
  GetContactResponseTypeOriginal: () => GetContactResponseType,
  ImageProviderOriginal: () => ImageProvider,
  MemberStatusOriginal: () => MemberStatus,
  ModeOriginal: () => Mode,
  PhoneDeliverabilityStatusOriginal: () => PhoneDeliverabilityStatus,
  PhoneTagOriginal: () => PhoneTag,
  PrivacyStatusOriginal: () => PrivacyStatus,
  RoleOriginal: () => Role,
  SortOrderOriginal: () => SortOrder,
  SubdivisionTypeOriginal: () => SubdivisionType,
  SubmitOperationOriginal: () => SubmitOperation,
  SubscriptionStatusOriginal: () => SubscriptionStatus,
  UpsertContactResponseActionOriginal: () => UpsertContactResponseAction,
  WebhookIdentityTypeOriginal: () => WebhookIdentityType,
  bulkDeleteContacts: () => bulkDeleteContacts2,
  bulkLabelAndUnlabelContacts: () => bulkLabelAndUnlabelContacts2,
  bulkUpdateContacts: () => bulkUpdateContacts2,
  createContact: () => createContact2,
  deleteContact: () => deleteContact2,
  getContact: () => getContact2,
  labelContact: () => labelContact2,
  listContacts: () => listContacts2,
  listFacets: () => listFacets2,
...
function previewMergeContacts(payload) {
  function __previewMergeContacts({ host }) {
    const metadata = {
      entityFqdn: "wix.contacts.v4.contact",
      method: "POST",
...
function listFacets(payload) {
  function __listFacets({ host }) {
    const metadata = {
      entityFqdn: "wix.contacts.v4.contact",
      method: "GET",
...
function queryFacets(payload) {
  function __queryFacets({ host }) {
    const metadata = {
      entityFqdn: "wix.contacts.v4.contact",
      method: "POST",
...
function bulkLabelAndUnlabelContacts(payload) {
  function __bulkLabelAndUnlabelContacts({ host }) {
    const metadata = {
      entityFqdn: "wix.contacts.v4.contact",
      method: "POST",
...
// src/contacts-v4-contact-contacts.types.ts
...
// src/contacts-v4-contact-contacts.meta.ts
function createContact2() {
  const payload = {};
  const getRequestOptions = createContact(payload);
...
function updateContact2() {
  ...
  const getRequestOptions = updateContact(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function mergeContacts2() {
  const payload = { targetContactId: ":targetContactId" };
  const getRequestOptions = mergeContacts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function previewMergeContacts2() {
  const payload = { targetContactId: ":targetContactId" };
  const getRequestOptions = previewMergeContacts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteContact2() {
  const payload = { contactId: ":contactId" };
  const getRequestOptions = deleteContact(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function labelContact2() {
  const payload = { contactId: ":contactId" };
  const getRequestOptions = labelContact(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function unlabelContact2() {
  const payload = { contactId: ":contactId" };
  const getRequestOptions = unlabelContact(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function listContacts2() {
  const payload = {};
  const getRequestOptions = listContacts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function queryContacts2() {
  const payload = {};
  const getRequestOptions = queryContacts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function listFacets2() {
  const payload = {};
  const getRequestOptions = listFacets(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function queryFacets2() {
  const payload = {};
  const getRequestOptions = queryFacets(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkDeleteContacts2() {
  const payload = {};
  const getRequestOptions = bulkDeleteContacts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkUpdateContacts2() {
  const payload = {};
  const getRequestOptions = bulkUpdateContacts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkLabelAndUnlabelContacts2() {
  const payload = {};
  const getRequestOptions = bulkLabelAndUnlabelContacts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getContact2() {
  const payload = { id: ":id" };
  const getRequestOptions = getContact(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
0 && (module.exports = {
  ActionOriginal,
  AddressTagOriginal,
  ContactActivityTypeOriginal,
  ContactFieldSetOriginal,
  ContactSourceTypeOriginal,
  ContactsFacetTypeOriginal,
  EmailDeliverabilityStatusOriginal,
  EmailTagOriginal,
  GetContactResponseTypeOriginal,
  ImageProviderOriginal,
  MemberStatusOriginal,
  ModeOriginal,
  PhoneDeliverabilityStatusOriginal,
  PhoneTagOriginal,
  PrivacyStatusOriginal,
  RoleOriginal,
  SortOrderOriginal,
  SubdivisionTypeOriginal,
  SubmitOperationOriginal,
  SubscriptionStatusOriginal,
  UpsertContactResponseActionOriginal,
