 ...
 */
declare function bulkInvite(policyIds: string[], options?: NonNullablePaths<BulkInviteOptions, `emails`, 2>): Promise<NonNullablePaths<BulkSiteInviteResponse, `invites` | `invites.${number}._id` | `invites.${number}.siteId` | `invites.${number}.email` | `invites.${number}.inviterId` | `invites.${number}.status` | `invites.${number}.acceptLink` | `invites.${number}.inviterAccountId` | `failedEmails` | `failedInvites` | `failedInvites.${number}.email` | `failedInvites.${number}.reason`, 4>>;
 ...
 */
declare function resendInvite(inviteId: string, options?: ResendInviteOptions): Promise<NonNullablePaths<SiteInviteResponse, `invite._id` | `invite.siteId` | `invite.email` | `invite.policyIds` | `invite.inviterId` | `invite.status` | `invite.acceptLink` | `invite.inviterAccountId` | `invite.locationIds` | `invite.callerCapabilities`, 3>>;
...
export { type AcceptSiteInviteRequest, type AcceptSiteInviteResponse, type AddressLocation, type BulkInviteOptions, type BulkSiteInviteRequest, type BulkSiteInviteResponse, type ContributorLimitation, type CursorPaging, type FailedSiteInvite, type GetContributorLimitRequest, type GetContributorLimitResponse, type GetSiteInviteRequest, type GetSiteInviteResponse, type GetSiteInvitesRequest, type GetSiteInvitesResponse, InviteStatus, type InviteStatusWithLiterals, type LocationRestriction, type Paging, type ParseSiteInviteTokenRequest, type ParseSiteInviteTokenResponse, type QuerySiteInvitesRequest, type QuerySiteInvitesResponse, type QueryV2, type QueryV2PagingMethodOneOf, type ResendInviteOptions, type ResendSiteInviteRequest, type RevokeSiteInviteRequest, type RevokeSiteInviteResponse, type SiteInvite, SiteInviteFailureReason, type SiteInviteFailureReasonWithLiterals, type SiteInviteRequest, type SiteInviteResponse, SortOrder, type SortOrderWithLiterals, type Sorting, type UpdateSiteInviteRequest, type UpdateSiteInviteResponse, bulkInvite, resendInvite, revokeInvite };
