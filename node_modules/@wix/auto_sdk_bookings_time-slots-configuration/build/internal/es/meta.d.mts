...
declare function getTimeSlotsConfiguration(): __PublicMethodMetaInfo<'GET', {
    timeSlotsConfigurationId: string;
}, GetTimeSlotsConfigurationRequest$1, GetTimeSlotsConfigurationRequest, GetTimeSlotsConfigurationResponse$1, GetTimeSlotsConfigurationResponse>;
declare function getTimeSlotsConfigurationByAppId(): __PublicMethodMetaInfo<'GET', {
    appId: string;
}, GetTimeSlotsConfigurationByAppIdRequest$1, GetTimeSlotsConfigurationByAppIdRequest, GetTimeSlotsConfigurationByAppIdResponse$1, GetTimeSlotsConfigurationByAppIdResponse>;
declare function updateTimeSlotsConfiguration(): __PublicMethodMetaInfo<'PATCH', {
    timeSlotsConfigurationId: string;
}, UpdateTimeSlotsConfigurationRequest$1, UpdateTimeSlotsConfigurationRequest, UpdateTimeSlotsConfigurationResponse$1, UpdateTimeSlotsConfigurationResponse>;
declare function queryTimeSlotsConfigurations(): __PublicMethodMetaInfo<'GET', {}, QueryTimeSlotsConfigurationsRequest$1, QueryTimeSlotsConfigurationsRequest, QueryTimeSlotsConfigurationsResponse$1, QueryTimeSlotsConfigurationsResponse>;
