...
declare function bookingsCancelBookingAnonymously(): __PublicMethodMetaInfo<'POST', {
    token: string;
}, V1CancelBookingAnonymouslyRequest$1, V1CancelBookingAnonymouslyRequest, V1CancelBookingAnonymouslyResponse$1, V1CancelBookingAnonymouslyResponse>;
declare function bookingsRescheduleBookingAnonymously(): __PublicMethodMetaInfo<'POST', {
    token: string;
}, V1RescheduleBookingAnonymouslyRequest$1, V1RescheduleBookingAnonymouslyRequest, V1RescheduleBookingAnonymouslyResponse$1, V1RescheduleBookingAnonymouslyResponse>;
declare function bookingsGetBookingAnonymously(): __PublicMethodMetaInfo<'GET', {
    token: string;
}, V1GetBookingAnonymouslyRequest$1, V1GetBookingAnonymouslyRequest, V1GetBookingAnonymouslyResponse$1, V1GetBookingAnonymouslyResponse>;
declare function getServiceAnonymously(): __PublicMethodMetaInfo<'GET', {
    token: string;
}, GetServiceAnonymouslyRequest$1, GetServiceAnonymouslyRequest, GetServiceAnonymouslyResponse$1, GetServiceAnonymouslyResponse>;
declare function getAnonymousActionToken(): __PublicMethodMetaInfo<'GET', {
    bookingId: string;
}, GetAnonymousActionTokenRequest$1, GetAnonymousActionTokenRequest, GetAnonymousActionTokenResponse$1, GetAnonymousActionTokenResponse>;
declare function getAnonymousActionTokenForMultiServiceBooking(): __PublicMethodMetaInfo<'GET', {
    multiServiceBookingId: string;
}, GetAnonymousActionTokenForMultiServiceBookingRequest$1, GetAnonymousActionTokenForMultiServiceBookingRequest, GetAnonymousActionTokenForMultiServiceBookingResponse$1, GetAnonymousActionTokenForMultiServiceBookingResponse>;
declare function getMultiServiceBookingAnonymously(): __PublicMethodMetaInfo<'GET', {
    token: string;
}, GetMultiServiceBookingAnonymouslyRequest$1, GetMultiServiceBookingAnonymouslyRequest, GetMultiServiceBookingAnonymouslyResponse$1, GetMultiServiceBookingAnonymouslyResponse>;
declare function cancelMultiServiceBookingAnonymously(): __PublicMethodMetaInfo<'POST', {
    token: string;
}, CancelMultiServiceBookingAnonymouslyRequest$1, CancelMultiServiceBookingAnonymouslyRequest, CancelMultiServiceBookingAnonymouslyResponse$1, CancelMultiServiceBookingAnonymouslyResponse>;
...
declare function bulkCancelBooking(): __PublicMethodMetaInfo<'POST', {}, BulkCancelBookingRequest$1, BulkCancelBookingRequest, BulkCancelBookingResponse$1, BulkCancelBookingResponse>;
