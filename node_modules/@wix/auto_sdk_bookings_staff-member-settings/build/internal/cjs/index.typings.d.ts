...
interface StaffMemberSettings {
    ...
    /**
     * Privacy settings for controlling staff member properties visibility, such as gender, in API responses and on the live site.
     * @internal
     */
...
/**
 * Privacy settings for staff member properties.
 *
 * These settings control whether staff members' properties, such as gender,
 * are populated in [staff member objects](https://dev.wix.com/docs/api-reference/business-solutions/bookings/staff-members/staff-members/staff-member-object).
 * Each property has its own visibility setting.
 */
interface StaffProperties {
    /**
     * Whether staff members' gender is accessible in API responses and on the live site.
     *
     * - `true`: The `gender` field in [staff member objects](https://dev.wix.com/docs/api-reference/business-solutions/bookings/staff-members/staff-members/staff-member-object) contains the staff member's gender, and this information is displayed on the live site.
     * - `false`: The field returns `UNKNOWN_GENDER` in API responses if the calling [identity](https://dev.wix.com/docs/build-apps/develop-your-app/access/about-identities) doesn't have sufficient permissions, and gender isn't displayed on the live site.
     *
     * Identities with appropriate permissions can still access this information in API responses regardless of this setting.
     *
     * Default: `false`
     */
    genderPubliclyAccessible?: boolean | null;
}
...
interface GetStaffMemberSettingsRequest {
}
interface GetStaffMemberSettingsResponse {
    /** Retrieved staff member settings. */
    staffMemberSettings?: StaffMemberSettings;
}
interface UpdateStaffMemberSettingsRequest {
    /** Staff member settings to update, may be partial. */
    staffMemberSettings: StaffMemberSettings;
    /**
     * Set of fields to update.
     *
     * Fields not included in `fieldMask.paths` are ignored.
     * @internal
     */
    fieldMask?: string[];
}
interface UpdateStaffMemberSettingsResponse {
 ...
 */
declare function onStaffMemberSettingsUpdated(handler: (event: StaffMemberSettingsUpdatedEnvelope) => void | Promise<void>): void;
/**
 ...
 */
declare function getStaffMemberSettings(): Promise<StaffMemberSettings>;
/**
 ...
 */
declare function updateStaffMemberSettings(staffMemberSettings: NonNullablePaths<StaffMemberSettings, `revision`, 0>): Promise<StaffMemberSettings>;

export { type AccountInfo, type AccountInfoMetadata, type ActionEvent, type BaseEventMetadata, type ContactInformation, type DomainEvent, type DomainEventBodyOneOf, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type EventMetadata, type ExtendedFields, type GetStaffMemberSettingsRequest, type GetStaffMemberSettingsResponse, type IdentificationData, type IdentificationDataIdOneOf, type MessageEnvelope, type RestoreInfo, type StaffMemberSettings, type StaffMemberSettingsUpdatedEnvelope, type StaffProperties, type UpdateStaffMemberSettingsRequest, type UpdateStaffMemberSettingsResponse, WebhookIdentityType, type WebhookIdentityTypeWithLiterals, getStaffMemberSettings, onStaffMemberSettingsUpdated, updateStaffMemberSettings };
