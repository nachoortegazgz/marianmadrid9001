import { aL as CreateStaffMemberRequest$1, aM as CreateStaffMemberResponse$1, aN as GetStaffMemberRequest$1, aO as GetStaffMemberResponse$1, aP as GetDeletedStaffMemberRequest$1, b as GetDeletedStaffMemberResponse$1, aQ as ListDeletedStaffMembersRequest$1, c as ListDeletedStaffMembersResponse$1, aU as RemoveStaffMemberFromTrashBinRequest$1, aV as RemoveStaffMemberFromTrashBinResponse$1, aY as UpdateStaffMemberRequest$1, aZ as UpdateStaffMemberResponse$1, a_ as DeleteStaffMemberRequest$1, a$ as DeleteStaffMemberResponse$1, b0 as QueryStaffMembersRequest$1, b4 as QueryStaffMembersResponse$1, b7 as CountStaffMembersRequest$1, f as CountStaffMembersResponse$1, b8 as ConnectStaffMemberToUserRequest$1, h as ConnectStaffMemberToUserResponse$1, b9 as SetServiceProviderRequest$1, k as SetServiceProviderResponse$1, ba as GetOrCreateStaffMemberRequest$1, m as GetOrCreateStaffMemberResponse$1, bb as BulkGetOrCreateStaffMembersRequest$1, n as BulkGetOrCreateStaffMembersResponse$1, bg as SearchStaffMembersRequest$1, q as SearchStaffMembersResponse$1, bE as QueryStaffMembersV2Request$1, r as QueryStaffMembersV2Response$1, bF as SearchStaffMembersV2Request$1, u as SearchStaffMembersV2Response$1, bG as CountStaffMembersV2Request$1, w as CountStaffMembersV2Response$1, bH as DisconnectStaffMemberFromUserRequest$1, x as DisconnectStaffMemberFromUserResponse$1, bI as AssignWorkingHoursScheduleRequest$1, y as AssignWorkingHoursScheduleResponse$1, bJ as AssignCustomScheduleRequest$1, E as AssignCustomScheduleResponse$1, bK as BulkUpdateStaffMemberTagsRequest$1, H as BulkUpdateStaffMemberTagsResponse$1, bM as BulkUpdateStaffMemberTagsByFilterRequest$1, K as BulkUpdateStaffMemberTagsByFilterResponse$1 } from './bookings-staff-v1-staff-member-staff-members.universal-DHMVh8ru.mjs';
...
interface StaffMember {
     ...
     * This field is populated based on the `genderPubliclyAccessible` setting in the [Staff Member Settings API](https://dev.wix.com/docs/api-reference/business-solutions/bookings/staff-members/staff-member-settings/introduction).
     * When the setting is disabled, this field returns `UNKNOWN_GENDER` if the calling [identity](https://dev.wix.com/docs/build-apps/develop-your-app/access/about-identities) doesn't have sufficient permissions.
     * Identities with appropriate permissions can access this field regardless of the setting.
     * @internal
     */
    gender?: GenderWithLiterals;
    /**
...
interface Resource {
    ...
    /**
     * Details about the [locations](https://dev.wix.com/docs/rest/business-management/locations/introduction)
     * where the staff member is available.
     * @internal
     */
    locationOptions?: LocationOptions;
    /**
     * Staff ranking for automatic ranked Staff selection.
     *
     * Default: `0`
     * @internal
     * @max 5
...
interface SpecificLocation {
    /**
     * Whether the resource is available in [customer locations](https://dev.wix.com/docs/rest/business-solutions/bookings/services/services-v2/about-service-locations#location-types).
     *
     * - `true`: The resource is available in customer locations.
     * - `false`: The resource isn't available in customer locations.
     *
     * Default: `false`
     * @internal
     */
    ...
    /**
     * Whether the resource is available in [custom locations](https://dev.wix.com/docs/rest/business-solutions/bookings/services/services-v2/about-service-locations#location-types).
     *
     * - `true`: The resource is available in custom locations.
     * - `false`: The resource isn't available in custom locations.
     *
     * Default: `false`
     * @internal
     */
...
declare enum RequestedFields {
    ...
    /**
     * Includes `associatedConferencingProviders` in the response.
     * @internal
     */
    ...
    /**
     * Includes `associatedConferencingAccounts` in the response.
     * @internal
     */
...
interface ConnectStaffMemberToUserRequest {
    ...
    fields?: RequestedFieldsWithLiterals[];
    /**
     * IDs of roles to assign to the connected Wix user.
     *
     * Existing role assignments aren't changed. If the staff member is a service provider,
     * Wix Bookings also assigns the Staff role automatically.
     *
     * If the user must be invited to the site and the staff member isn't a service provider,
     * you must provide at least one role ID. Duplicate role IDs are ignored.
     * @internal
     * @maxLength 50
     * @maxSize 50
     */
...
declare function getDeletedStaffMember(): __PublicMethodMetaInfo<'GET', {
    staffMemberId: string;
}, GetDeletedStaffMemberRequest$1, GetDeletedStaffMemberRequest, GetDeletedStaffMemberResponse$1, GetDeletedStaffMemberResponse>;
declare function listDeletedStaffMembers(): __PublicMethodMetaInfo<'GET', {}, ListDeletedStaffMembersRequest$1, ListDeletedStaffMembersRequest, ListDeletedStaffMembersResponse$1, ListDeletedStaffMembersResponse>;
declare function removeStaffMemberFromTrashBin(): __PublicMethodMetaInfo<'DELETE', {
    staffMemberId: string;
}, RemoveStaffMemberFromTrashBinRequest$1, RemoveStaffMemberFromTrashBinRequest, RemoveStaffMemberFromTrashBinResponse$1, RemoveStaffMemberFromTrashBinResponse>;
...
declare function setServiceProvider(): __PublicMethodMetaInfo<'POST', {
    staffMemberId: string;
}, SetServiceProviderRequest$1, SetServiceProviderRequest, SetServiceProviderResponse$1, SetServiceProviderResponse>;
declare function getOrCreateStaffMember(): __PublicMethodMetaInfo<'POST', {
    wixUserId: string;
}, GetOrCreateStaffMemberRequest$1, GetOrCreateStaffMemberRequest, GetOrCreateStaffMemberResponse$1, GetOrCreateStaffMemberResponse>;
declare function bulkGetOrCreateStaffMembers(): __PublicMethodMetaInfo<'POST', {}, BulkGetOrCreateStaffMembersRequest$1, BulkGetOrCreateStaffMembersRequest, BulkGetOrCreateStaffMembersResponse$1, BulkGetOrCreateStaffMembersResponse>;
...
declare function queryStaffMembersV2(): __PublicMethodMetaInfo<'POST', {}, QueryStaffMembersV2Request$1, QueryStaffMembersV2Request, QueryStaffMembersV2Response$1, QueryStaffMembersV2Response>;
declare function searchStaffMembersV2(): __PublicMethodMetaInfo<'POST', {}, SearchStaffMembersV2Request$1, SearchStaffMembersV2Request, SearchStaffMembersV2Response$1, SearchStaffMembersV2Response>;
declare function countStaffMembersV2(): __PublicMethodMetaInfo<'POST', {}, CountStaffMembersV2Request$1, CountStaffMembersV2Request, CountStaffMembersV2Response$1, CountStaffMembersV2Response>;
