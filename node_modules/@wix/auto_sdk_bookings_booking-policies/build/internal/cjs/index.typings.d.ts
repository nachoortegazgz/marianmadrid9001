...
/**
 * Rule for sorting and selecting staff members when multiple staff members are available for a service.
 * The sorting order determines which staff member the
 * [Time Slots V2 API](https://dev.wix.com/docs/api-reference/business-solutions/bookings/time-slots/time-slots-v2/introduction)
 * returns first, and Wix Bookings assigns the first available staff member from the sorted list when creating a booking.
 */
...
/** Sort order for ranking-based staff selection. */
...
declare enum SortingMethodType {
    /** Staff members are returned in random order. */
    RANDOM = "RANDOM",
    /** Staff members are returned in order of their priority ranking. */
    RANKING = "RANKING",
    /**
     * Staff members are returned in the order determined by a
...
/**
 * Rule for requiring customers to complete an [intake form](https://dev.wix.com/docs/api-reference/crm/forms/other-services/intake-forms/introduction) as part of the booking process.
 * Controls which form to use, when to present it, and whether completion is mandatory.
 */
...
/** When the intake form is presented to the customer. */
declare enum Timing {
    /** Form is sent to the customer after the booking is created. */
    AFTER_BOOKING = "AFTER_BOOKING",
    /** Form is shown to the customer during the booking flow, before the booking is created. */
...
declare enum CompletionRequirement {
    /** Form completion is optional. Customers can skip the form. */
    OPTIONAL = "OPTIONAL",
    /**
     * Customers must complete the form before the booking is finalized.
...
interface GetBookingPolicyRequest {
    ...
    /**
     * Bypass the extended field permission validations when getting the policy.
     * When set to `true`, the extended fields from all namespaces will be returned.
     * @internal
     */
    bypassExtendedFieldPermissionsValidations?: boolean | null;
}
 ...
 */
declare function updateBookingPolicy(_id: string, bookingPolicy: NonNullablePaths<UpdateBookingPolicy, `revision`, 0>): Promise<NonNullablePaths<BookingPolicy, `customPolicyDescription.enabled` | `customPolicyDescription.description` | `limitEarlyBookingPolicy.enabled` | `limitEarlyBookingPolicy.earliestBookingInMinutes` | `limitLateBookingPolicy.enabled` | `limitLateBookingPolicy.latestBookingInMinutes` | `bookAfterStartPolicy.enabled` | `cancellationPolicy.enabled` | `cancellationPolicy.limitLatestCancellation` | `cancellationPolicy.latestCancellationInMinutes` | `reschedulePolicy.enabled` | `reschedulePolicy.limitLatestReschedule` | `reschedulePolicy.latestRescheduleInMinutes` | `waitlistPolicy.enabled` | `waitlistPolicy.capacity` | `waitlistPolicy.reservationTimeInMinutes` | `participantsPolicy.maxParticipantsPerBooking` | `cancellationFeePolicy.enabled` | `cancellationFeePolicy.cancellationWindows` | `cancellationFeePolicy.cancellationWindows.${number}.amount.value` | `cancellationFeePolicy.cancellationWindows.${number}.amount.currency` | `cancellationFeePolicy.cancellationWindows.${number}.percentage` | `saveCreditCardPolicy.enabled` | `staffSortingPolicy.rankingOptions.order` | `staffSortingPolicy.customOptions.implementationId` | `staffSortingPolicy.customOptions.appId` | `staffSortingPolicy.sortingMethodType` | `intakeFormPolicy.enabled` | `intakeFormPolicy.timing` | `intakeFormPolicy.completionRequirement`, 4> & {
 ...
 * @requiredField query
 */
declare function typedQueryBookingPolicies(query: BookingPolicyQuery): Promise<NonNullablePaths<QueryBookingPoliciesResponse, `bookingPolicies` | `bookingPolicies.${number}.customPolicyDescription.enabled` | `bookingPolicies.${number}.customPolicyDescription.description` | `bookingPolicies.${number}.limitEarlyBookingPolicy.enabled` | `bookingPolicies.${number}.limitEarlyBookingPolicy.earliestBookingInMinutes` | `bookingPolicies.${number}.limitLateBookingPolicy.enabled` | `bookingPolicies.${number}.limitLateBookingPolicy.latestBookingInMinutes` | `bookingPolicies.${number}.bookAfterStartPolicy.enabled` | `bookingPolicies.${number}.cancellationPolicy.enabled` | `bookingPolicies.${number}.cancellationPolicy.limitLatestCancellation` | `bookingPolicies.${number}.cancellationPolicy.latestCancellationInMinutes` | `bookingPolicies.${number}.reschedulePolicy.enabled` | `bookingPolicies.${number}.reschedulePolicy.limitLatestReschedule` | `bookingPolicies.${number}.reschedulePolicy.latestRescheduleInMinutes` | `bookingPolicies.${number}.waitlistPolicy.enabled` | `bookingPolicies.${number}.waitlistPolicy.capacity` | `bookingPolicies.${number}.waitlistPolicy.reservationTimeInMinutes` | `bookingPolicies.${number}.participantsPolicy.maxParticipantsPerBooking` | `bookingPolicies.${number}.cancellationFeePolicy.enabled` | `bookingPolicies.${number}.saveCreditCardPolicy.enabled` | `bookingPolicies.${number}.staffSortingPolicy.rankingOptions.order` | `bookingPolicies.${number}.staffSortingPolicy.customOptions.implementationId` | `bookingPolicies.${number}.staffSortingPolicy.customOptions.appId` | `bookingPolicies.${number}.staffSortingPolicy.sortingMethodType` | `bookingPolicies.${number}.intakeFormPolicy.enabled` | `bookingPolicies.${number}.intakeFormPolicy.timing` | `bookingPolicies.${number}.intakeFormPolicy.completionRequirement`, 4>>;
...
declare const utils: {
    query: _wix_sdk_types.QueryHelpers<BookingPolicy, BookingPolicyQuerySpec, BookingPolicyQuery>;
};
/**
 ...
 */
declare function countBookingPolicies(options?: CountBookingPoliciesOptions): Promise<NonNullablePaths<CountBookingPoliciesResponse, `count`, 0>>;
