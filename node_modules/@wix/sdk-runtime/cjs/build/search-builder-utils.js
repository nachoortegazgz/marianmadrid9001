...
function createSearchParamsBuilder(options) {
    ...
    const builder = {
        ...
        fields(fields) {
            state = {
                ...state,
                fields: fields.map((field) => (0, field_rename_js_1.renameSystemFieldPath)(field, options)),
            };
            return builder;
        },
        fuzzy(enabled = true) {
...
function createAggregationBuilder(name, options) {
    ...
    const builder = {
        ...
        onField(field) {
            state = {
                ...state,
                fieldPath: (0, field_rename_js_1.renameSystemFieldPath)(field, options),
            };
            return builder;
        },
        asValueAggregation() {
...
function createSearchUtils(options) {
    return {
        ...
        Filter: (0, wql_builder_utils_js_1.createFilterFactory)(options),
        Sort: (0, wql_builder_utils_js_1.createSortFactory)(options),
