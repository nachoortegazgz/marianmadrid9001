...
type Resolvable<T> = T | (() => T | undefined);
...
/**
 * Represents the Wix configuration for app's monitoring.
 */
interface AppMonitoringWixConfig {
    /**
     * The type of monitoring provider.
     */
    type: 'WIX';
    /**
     * The options for the Wix monitoring provider.
     */
    wixOptions: {};
}
/**
 ...
 */
type AppMonitoringConfig = AppMonitoringSentryConfig | AppMonitoringPanoramaConfig | AppMonitoringUnknownConfig | AppMonitoringWixConfig;

export type { AppMonitoringConfig, AppMonitoringPanoramaConfig, AppMonitoringSentryConfig, AppMonitoringUnknownConfig, AppMonitoringWixConfig, Breadcrumb, CaptureContext, Context, Contexts, EndSpanOptions, EventContexts, EventData, EventTags, HostMonitoringContext, ManualSpan, MonitoringClient, Primitive, Resolvable, Span, SpanContextData, SpanOptions, Tags };
