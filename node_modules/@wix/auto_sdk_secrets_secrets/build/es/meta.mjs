...
// src/velo-secrets-vault-v1-secret-secrets.types.ts
...
export {
  ...
  createSecret2 as createSecret,
  deleteSecret2 as deleteSecret,
  getSecretValue2 as getSecretValue,
  listSecretInfo2 as listSecretInfo,
  updateSecret
};
