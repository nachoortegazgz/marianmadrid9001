...
import { GetSecretValueResponse, ListSecretInfoResponse, Secret, SecretCreatedEnvelope, SecretDeletedEnvelope, SecretUpdatedEnvelope } from './index.typings.mjs';
export { AccountInfo, AccountInfoMetadata, ActionEvent, BaseEventMetadata, CreateSecretRequest, CreateSecretResponse, DeleteSecretRequest, DeleteSecretResponse, DomainEvent, DomainEventBodyOneOf, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, GetSecretValueRequest, IdentificationData, IdentificationDataIdOneOf, ListSecretInfoRequest, MessageEnvelope, RestoreInfo, UpdateSecretRequest, UpdateSecretResponse, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.mjs';
...
interface GetSecretValueSignature {
     ...
     */
    (name: string): Promise<NonNullablePaths<GetSecretValueResponse, `value`, 0>>;
}
...
interface ListSecretInfoSignature {
     ...
     */
    (): Promise<NonNullablePaths<ListSecretInfoResponse, `secrets`, 0>>;
}
...
interface CreateSecretSignature {
     ...
     */
    (secret: NonNullablePaths<Secret, `name` | `value`, 0>): Promise<string>;
}
 ...
 */
declare const onSecretCreated: BuildEventDefinition<typeof onSecretCreated$1> & typeof onSecretCreated$1;
/**
 * Triggered when a secret is deleted.
 */
declare const onSecretDeleted: BuildEventDefinition<typeof onSecretDeleted$1> & typeof onSecretDeleted$1;
/**
 * Triggered when a secret is updated.
 */
declare const onSecretUpdated: BuildEventDefinition<typeof onSecretUpdated$1> & typeof onSecretUpdated$1;
