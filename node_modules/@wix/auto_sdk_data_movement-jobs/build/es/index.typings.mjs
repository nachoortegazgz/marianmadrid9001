...
async function getJob2(jobId) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = renameKeysFromSDKRequestToRESTRequest({ jobId });
...
export {
  ...
  WixMediaDestinationWritePolicy,
  WritePolicy,
  createFileUploadUrl2 as createFileUploadUrl,
  getJob2 as getJob,
  listJobs2 as listJobs,
  listMovementLogs2 as listMovementLogs,
  queryJobs2 as queryJobs,
  submitJob2 as submitJob,
  terminateJob2 as terminateJob,
  typedQueryJobs,
  utils
};
