...
interface Source extends SourceSourceOneOf {
    ...
    /**
     * Arbitrary Wix API source, selected by the service FQDN.
     * @internal
     */
    wixApi?: WixApiSource;
}
...
interface WixDataSource extends WixDataSourceQueryOneOf {
     ...
     * @internal
     */
    environment?: WixDataEnvironmentWithLiterals;
    /**
     * Filter to apply to the items. Only items that pass the filter are moved.
     *
     * Learn more about building a query filter using [API Query Language](https://dev.wix.com/docs/rest/articles/getting-started/api-query-language#filters).
...
/** Reads items from a Wix service's query or list API. */
interface WixApiSource {
    /**
     * Fully-qualified name of the Wix service entity to read.
     * @minLength 1
     * @maxLength 512
     */
    fqdn?: string;
     ...
     * Filter to apply to the items. Only items that pass the filter are moved.
     *
     * Supported only when the entity exposes a query method that accepts a filter. Setting a filter
     * for an entity that is read through a list method causes the movement job to fail.
     *
     * Learn more about building a query filter using [API Query Language](https://dev.wix.com/docs/rest/articles/getting-started/api-query-language#filters).
     */
    filter?: Record<string, any> | null;
...
interface Destination extends DestinationDestinationOneOf {
    ...
    /**
     * Arbitrary Wix API destination, selected by the service FQDN.
     * @internal
     */
    wixApi?: WixApiDestination;
    /**
...
interface WixMediaDestination {
     ...
     * @internal
     */
    writePolicy?: WixMediaDestinationWritePolicyWithLiterals;
}
...
/** Writes items to a Wix service's API. */
interface WixApiDestination {
    /**
     * Fully-qualified name of the Wix service entity to write.
     * @minLength 1
     * @maxLength 512
     */
    fqdn?: string;
...
interface Transformation extends TransformationTransformationOneOf {
    ...
    /**
     * Renames and filters source fields onto destination fields. Source fields
     * not listed in `mappings` are excluded from the import.
     * @internal
     */
...
/** @enumType */
type UnitsWithLiterals = Units | 'BYTES' | 'ITEMS';
 ...
 */
declare function submitJob(source: NonNullablePaths<Source, `file.fileId` | `localization.languages` | `wixDataCollection.collectionId`, 1>, destination: NonNullablePaths<Destination, `file.format` | `localization.languages` | `wixDataCollection.collectionId`, 1>, options?: SubmitJobOptions): Promise<NonNullablePaths<SubmitJobResponse, `job.partiallySuccessfulOptions.cause` | `job._id` | `job.status` | `job.source.wixDataCollection.filterQuery.fields` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.objectToArray.objectFieldName` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.objectToArray.destinationFieldName` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.unwindArray.arrayFieldName` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.skip` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.limit` | `job.source.wixDataCollection.aggregationQuery.fields` | `job.source.wixDataCollection.aggregationQuery.fields.${number}.key` | `job.source.wixDataCollection.aggregationQuery.fields.${number}.displayName` | `job.source.wixDataCollection.aggregationQuery.fields.${number}.fieldType` | `job.source.wixDataCollection.collectionId` | `job.source.wixDataCollection.fields` | `job.source.localization.languages` | `job.source.file.format` | `job.source.file.fileId` | `job.source.file.url` | `job.destination.wixDataCollection.collectionId` | `job.destination.wixDataCollection.writePolicy` | `job.destination.localization.languages` | `job.destination.file.format` | `job.destination.file.url` | `job.name` | `job.progress.current` | `job.progress.itemsRejected` | `job.progress.itemsSuccessful` | `job.error.code` | `job.error.description` | `job.sourceSiteId` | `job.destinationSiteId` | `job.logsRecorded`, 8>>;
 ...
 */
declare function createFileUploadUrl(options?: CreateFileUploadUrlOptions): Promise<NonNullablePaths<CreateFileUploadUrlResponse, `fileId` | `uploadUrl`, 0>>;
 ...
 */
declare function getJob(jobId: string): Promise<NonNullablePaths<DataMovementJob, `partiallySuccessfulOptions.cause` | `_id` | `status` | `source.wixDataCollection.filterQuery.fields` | `source.wixDataCollection.aggregationQuery.aggregationPipeline.stages` | `source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.objectToArray.objectFieldName` | `source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.objectToArray.destinationFieldName` | `source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.unwindArray.arrayFieldName` | `source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.skip` | `source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.limit` | `source.wixDataCollection.aggregationQuery.fields` | `source.wixDataCollection.aggregationQuery.fields.${number}.key` | `source.wixDataCollection.aggregationQuery.fields.${number}.displayName` | `source.wixDataCollection.aggregationQuery.fields.${number}.fieldType` | `source.wixDataCollection.collectionId` | `source.wixDataCollection.fields` | `source.localization.languages` | `source.file.format` | `source.file.fileId` | `source.file.url` | `destination.wixDataCollection.collectionId` | `destination.wixDataCollection.writePolicy` | `destination.localization.languages` | `destination.file.format` | `destination.file.url` | `name` | `progress.current` | `progress.itemsRejected` | `progress.itemsSuccessful` | `error.code` | `error.description` | `sourceSiteId` | `destinationSiteId` | `logsRecorded`, 7>>;
/**
...
interface JobsQueryBuilder {
     ...
     */
    eq: (propertyName: '_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId' | 'workflowId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ne: (propertyName: '_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId' | 'workflowId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ge: (propertyName: '_id' | 'startedAt' | 'name' | 'finishedAt' | 'scheduleId' | 'workflowId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    gt: (propertyName: '_id' | 'startedAt' | 'name' | 'finishedAt' | 'scheduleId' | 'workflowId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    le: (propertyName: '_id' | 'startedAt' | 'name' | 'finishedAt' | 'scheduleId' | 'workflowId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    lt: (propertyName: '_id' | 'startedAt' | 'name' | 'finishedAt' | 'scheduleId' | 'workflowId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `string`.
     * @param string - String to compare against. Case-insensitive.
     */
    startsWith: (propertyName: '_id' | 'name' | 'scheduleId' | 'workflowId', value: string) => JobsQueryBuilder;
    in: (propertyName: '_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId' | 'workflowId', value: any) => JobsQueryBuilder;
    exists: (propertyName: '_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId' | 'workflowId', value: boolean) => JobsQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments. */
    ascending: (...propertyNames: Array<'_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId' | 'workflowId'>) => JobsQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments. */
    descending: (...propertyNames: Array<'_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId' | 'workflowId'>) => JobsQueryBuilder;
 ...
 * @requiredField query
 */
declare function typedQueryJobs(query: DataMovementJobQuery): Promise<NonNullablePaths<QueryJobsResponse, `jobs` | `jobs.${number}.partiallySuccessfulOptions.cause` | `jobs.${number}._id` | `jobs.${number}.status` | `jobs.${number}.source.wixDataCollection.collectionId` | `jobs.${number}.source.file.format` | `jobs.${number}.source.file.fileId` | `jobs.${number}.source.file.url` | `jobs.${number}.destination.wixDataCollection.collectionId` | `jobs.${number}.destination.wixDataCollection.writePolicy` | `jobs.${number}.destination.file.format` | `jobs.${number}.destination.file.url` | `jobs.${number}.name` | `jobs.${number}.progress.current` | `jobs.${number}.progress.itemsRejected` | `jobs.${number}.progress.itemsSuccessful` | `jobs.${number}.error.code` | `jobs.${number}.error.description` | `jobs.${number}.sourceSiteId` | `jobs.${number}.destinationSiteId` | `jobs.${number}.logsRecorded`, 4>>;
interface DataMovementJobQuerySpec extends QuerySpec {
    paging: 'cursor';
    wql: [
        {
            fields: [
...
type CommonQueryWithEntityContext = Query<DataMovementJob, DataMovementJobQuerySpec>;
type DataMovementJobQuery = {
    /**
    Cursor paging options.
...
declare const utils: {
    query: _wix_sdk_types.QueryHelpers<DataMovementJob, DataMovementJobQuerySpec, DataMovementJobQuery>;
};
/**
 ...
 */
declare function terminateJob(jobId: string): Promise<NonNullablePaths<TerminateJobResponse, `job.partiallySuccessfulOptions.cause` | `job._id` | `job.status` | `job.source.wixDataCollection.filterQuery.fields` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.objectToArray.objectFieldName` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.objectToArray.destinationFieldName` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.unwindArray.arrayFieldName` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.skip` | `job.source.wixDataCollection.aggregationQuery.aggregationPipeline.stages.${number}.limit` | `job.source.wixDataCollection.aggregationQuery.fields` | `job.source.wixDataCollection.aggregationQuery.fields.${number}.key` | `job.source.wixDataCollection.aggregationQuery.fields.${number}.displayName` | `job.source.wixDataCollection.aggregationQuery.fields.${number}.fieldType` | `job.source.wixDataCollection.collectionId` | `job.source.wixDataCollection.fields` | `job.source.localization.languages` | `job.source.file.format` | `job.source.file.fileId` | `job.source.file.url` | `job.destination.wixDataCollection.collectionId` | `job.destination.wixDataCollection.writePolicy` | `job.destination.localization.languages` | `job.destination.file.format` | `job.destination.file.url` | `job.name` | `job.progress.current` | `job.progress.itemsRejected` | `job.progress.itemsSuccessful` | `job.error.code` | `job.error.description` | `job.sourceSiteId` | `job.destinationSiteId` | `job.logsRecorded`, 8>>;
/**
 ...
 */
declare function listMovementLogs(jobId: string, options?: ListMovementLogsOptions): Promise<NonNullablePaths<ListMovementLogsResponse, `logs` | `logs.${number}.sourceItemId` | `logs.${number}.failure.code` | `logs.${number}.failure.description`, 3>>;
interface ListMovementLogsOptions {
    /** Paging metadata. */
    paging?: CommonCursorPaging;
}

export { type AbsOperation, type AccountInfo, type AccountInfoMetadata, type Accumulator, type AccumulatorExpressionOneOf, type ActionEvent, type AddField, type AddFields, type AddOperation, type AddressLocation, type AggregationPipeline, type AggregationPipelinePagingMethodOneOf, type AggregationQuery, type ApplicationError, type Avg, type BaseEventMetadata, type BooleanOptions, type CeilOperation, type CommonCursorPaging, type CommonPaging, type CommonQueryWithEntityContext, CommonSortOrder, type CommonSortOrderWithLiterals, type CommonSorting, type ConcatOperation, type ConditionOperation, type CreateFileUploadUrlOptions, type CreateFileUploadUrlRequest, type CreateFileUploadUrlResponse, type CursorPaging, type CursorPagingMetadata, type CursorQuery, type CursorQueryPagingMethodOneOf, type Cursors, type DataMovementJob, type DataMovementJobLogs, type DataMovementJobQuery, type DataMovementJobQuerySpec, type DataMovementJobStatusOptionsOneOf, DateFormat, type DateFormatWithLiterals, type DateTimeOptions, type Destination, type DestinationDestinationOneOf, type DivideOperation, type DomainEvent, type DomainEventBodyOneOf, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type EventMetadata, type Exclude, type Expression, type ExpressionValueOneOf, type ExtendedFields, type ExternalFileSource, type FailedOptions, type Field, type FieldMapping, type FieldMappingEntry, type FieldMappingEntryConversionOneOf, type FieldProjectionOneOf, FieldType, type FieldTypeWithLiterals, type FileDestination, FileFormat, type FileFormatWithLiterals, type FileSource, type FilterQuery, type First, type FloorOperation, type GetJobRequest, type GetJobResponse, type GoogleSheetsSource, type GreaterThanOperation, type Group, type GroupId, type IdentificationData, type IdentificationDataIdOneOf, type InProgressOptions, type Include, type ItemsSuccessfulInfo, type JobCallback, type JobCallbackOptionsOneOf, type JobCreatedEnvelope, type JobDeletedEnvelope, JobStatus, type JobStatusWithLiterals, type JobUpdatedEnvelope, type JobsQueryBuilder, type JobsQueryResult, type Last, type LengthOperation, type ListJobsOptions, type ListJobsRequest, type ListJobsResponse, type ListMovementLogsOptions, type ListMovementLogsRequest, type ListMovementLogsResponse, type LocalizationDestination, type LocalizationSource, type Lookup, type Max, MediaType, type MediaTypeWithLiterals, type MessageEnvelope, type Min, type ModOperation, type MovementLog, type MultiplyOperation, type ObjectToArray, type Paging, type PartiallySuccessfulOptions, type PartiallySuccessfulStatusOptions, type Progress, type ProjectNested, type Projection, type Push, type QueryJobsRequest, type QueryJobsResponse, type QueryV2, type QueryV2PagingMethodOneOf, type Reshape, type RestoreInfo, type Schema, type SizeOperation, SortOrder, type SortOrderWithLiterals, type Sorting, type Source, type SourceSourceOneOf, type Stage, type StageStageOneOf, type StoresCatalogInventoryDestination, type StoresCatalogProductsDestination, type StringifyOperation, type SubmitJobOptions, type SubmitJobOptionsSiteOverrideOneOf, type SubmitJobRequest, type SubmitJobRequestSiteOverrideOneOf, type SubmitJobResponse, type SubstringOperation, type SubtractOperation, type Sum, type SumOperation, type TerminateJobByIdRequest, type TerminateJobByIdResponse, type TerminateJobRequest, type TerminateJobResponse, type TestDestination, type TestSource, type TestTransformation, type ToLowerOperation, type ToUpperOperation, type Transformation, type TransformationTransformationOneOf, type UnionWith, Units, type UnitsWithLiterals, type UnwindArray, type V1Field, WebhookIdentityType, type WebhookIdentityTypeWithLiterals, type WixApiDestination, type WixApiSource, type WixCommonSorting, type WixDataCollectionDefinitionDestination, type WixDataCollectionDefinitionSource, type WixDataDestination, WixDataDestinationWritePolicy, type WixDataDestinationWritePolicyWithLiterals, WixDataEnvironment, type WixDataEnvironmentWithLiterals, type WixDataSource, type WixDataSourceQueryOneOf, type WixMediaDestination, WixMediaDestinationWritePolicy, type WixMediaDestinationWritePolicyWithLiterals, type WixMediaSource, WritePolicy, type WritePolicyWithLiterals, createFileUploadUrl, getJob, listJobs, listMovementLogs, onJobCreated, onJobDeleted, onJobUpdated, queryJobs, submitJob, terminateJob, typedQueryJobs, utils };
