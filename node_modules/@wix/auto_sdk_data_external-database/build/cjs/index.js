...
__export(index_exports, {
  BadRequestWixError: () => BadRequestWixError,
  CollectionAlreadyExistsWixError: () => CollectionAlreadyExistsWixError,
  CollectionChangeNotSupportedWixError: () => CollectionChangeNotSupportedWixError,
  CollectionNotFoundWixError: () => CollectionNotFoundWixError,
  DataOperation: () => DataOperation,
  FieldType: () => FieldType,
  IdentityType: () => IdentityType,
  ItemAlreadyExistsWixError: () => ItemAlreadyExistsWixError,
  ItemNotFoundWixError: () => ItemNotFoundWixError,
  Order: () => Order,
  PagingMode: () => PagingMode,
  QueryOperator: () => QueryOperator,
  ReferenceAlreadyExistsWixError: () => ReferenceAlreadyExistsWixError,
  ReferenceNotFoundWixError: () => ReferenceNotFoundWixError,
  Role: () => Role,
  SortOrder: () => SortOrder,
  Status: () => Status,
  ValidationWixError: () => ValidationWixError,
...
var provideHandlers = (0, import_sdk_types.ServicePluginDefinition)("EXTERNAL_DATABASE_PROVIDER", [
  {
    name: "queryDataItems",
