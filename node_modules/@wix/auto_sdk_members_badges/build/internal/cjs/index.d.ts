...
interface CreateBadgeSignature {
     ...
     * @deprecated
     */
    (badge: NonNullablePaths<Badge, `backgroundColor` | `textColor` | `title`, 0>): Promise<NonNullablePaths<Badge, `_id`, 0>>;
}
...
interface UpdateBadgeSignature {
     ...
     * @deprecated
     */
    (_id: string, badge: UpdateBadge): Promise<NonNullablePaths<Badge, `_id`, 0>>;
}
...
interface ListBadgesSignature {
     ...
     * @deprecated
     */
    (options?: ListBadgesOptions): Promise<NonNullablePaths<ListBadgesResponse, `badges` | `badges.${number}._id`, 2>>;
}
...
interface GetBadgeSignature {
     ...
     * @deprecated
     */
    (_id: string): Promise<NonNullablePaths<Badge, `_id`, 0>>;
}
...
interface AssignBadgeSignature {
     ...
     * @deprecated
     */
    (_id: string, memberIds: string[]): Promise<NonNullablePaths<AssignBadgeResponse, `memberIds`, 0>>;
}
...
interface ListMembersByBadgeSignature {
     ...
     * @deprecated
     */
    (_id: string, options?: ListMembersByBadgeOptions): Promise<NonNullablePaths<ListMembersResponse, `memberIds`, 0>>;
}
...
interface ListBadgesPerMemberSignature {
     ...
     * @deprecated
     */
    (memberIds: string[]): Promise<NonNullablePaths<ListMembersBadgeIdsResponse, `memberBadgeIds` | `memberBadgeIds.${number}.memberId`, 2>>;
}
...
interface GetMemberCountsPerBadgeSignature {
     ...
     * @deprecated
     */
    (): Promise<NonNullablePaths<GetMemberCountsPerBadgeResponse, `badgeMemberCounts` | `badgeMemberCounts.${number}.badgeId` | `badgeMemberCounts.${number}.memberCount`, 2>>;
}
...
interface UpdateBadgesDisplayOrderSignature {
     ...
     * @deprecated
     */
    (badgeIds: string[]): Promise<NonNullablePaths<UpdateBadgesDisplayOrderResponse, `badges` | `badges.${number}._id`, 2>>;
}
 ...
 * @deprecated
 */
declare const onBadgeAssigned: BuildEventDefinition<typeof onBadgeAssigned$1> & typeof onBadgeAssigned$1;
/**
 * Triggered when a member's badge is removed.
 * @deprecated
 */
declare const onBadgeUnassigned: BuildEventDefinition<typeof onBadgeUnassigned$1> & typeof onBadgeUnassigned$1;

export { AssignBadgeResponse, Badge, BadgeAssignedEnvelope, BadgeUnassignedEnvelope, GetMemberCountsPerBadgeResponse, ListBadgesOptions, ListBadgesResponse, ListMembersBadgeIdsResponse, ListMembersByBadgeOptions, ListMembersResponse, UpdateBadge, UpdateBadgesDisplayOrderResponse, assignBadge, createBadge, deleteBadge, getBadge, getMemberCountsPerBadge, listBadges, listBadgesPerMember, listMembersByBadge, onBadgeAssigned, onBadgeUnassigned, unassignBadge, updateBadge, updateBadgesDisplayOrder };
