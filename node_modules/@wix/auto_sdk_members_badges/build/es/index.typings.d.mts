 ...
 * @deprecated
 */
declare function onBadgeAssigned(handler: (event: BadgeAssignedEnvelope) => void | Promise<void>): void;
 ...
 * @deprecated
 */
declare function onBadgeUnassigned(handler: (event: BadgeUnassignedEnvelope) => void | Promise<void>): void;
/**
 * Creates a badge.
 *
 ...
 * @deprecated
 * @replacedBy wix.badges.v4.Badges.CreateBadge
 * @targetRemovalDate 2026-04-18
 */
declare function createBadge(badge: NonNullablePaths<Badge, `backgroundColor` | `textColor` | `title`, 0>): Promise<NonNullablePaths<Badge, `_id`, 0>>;
/**
 * Updates a badge.
 *
 ...
 * @deprecated
 * @replacedBy wix.badges.v4.Badges.UpdateBadge
 * @targetRemovalDate 2026-04-18
 */
declare function updateBadge(_id: string, badge: UpdateBadge): Promise<NonNullablePaths<Badge, `_id`, 0>>;
 ...
 * @deprecated
 * @replacedBy wix.badges.v4.Badges.QueryBadges
 * @targetRemovalDate 2026-04-18
 */
declare function listBadges(options?: ListBadgesOptions): Promise<NonNullablePaths<ListBadgesResponse, `badges` | `badges.${number}._id`, 2>>;
 ...
 * @deprecated
 * @replacedBy wix.badges.v4.Badges.GetBadge
 * @targetRemovalDate 2026-04-18
 */
declare function getBadge(_id: string): Promise<NonNullablePaths<Badge, `_id`, 0>>;
/**
 * Deletes a badge.
 * @param _id - Badge ID.
 * @public
 ...
 * @deprecated
 * @replacedBy wix.badges.v4.Badges.DeleteBadge
 * @targetRemovalDate 2026-04-18
 */
declare function deleteBadge(_id: string): Promise<void>;
/**
 ...
 * @deprecated
 * @replacedBy wix.badges.badgeassignments.v4.BadgeAssignments.CreateBadgeAssignment
 * @targetRemovalDate 2026-04-18
 */
declare function assignBadge(_id: string, memberIds: string[]): Promise<NonNullablePaths<AssignBadgeResponse, `memberIds`, 0>>;
/**
 ...
 * @deprecated
 * @replacedBy wix.badges.badgeassignments.v4.BadgeAssignments.DeleteBadgeAssignment
 * @targetRemovalDate 2026-04-18
 */
declare function unassignBadge(_id: string, memberIds: string[]): Promise<void>;
/**
 ...
 * @deprecated
 * @replacedBy wix.badges.badgeassignments.v4.BadgeAssignments.QueryBadgeAssignments
 * @targetRemovalDate 2026-04-18
 */
declare function listMembersByBadge(_id: string, options?: ListMembersByBadgeOptions): Promise<NonNullablePaths<ListMembersResponse, `memberIds`, 0>>;
 ...
 * @targetRemovalDate 2026-04-18
 */
declare function listBadgesPerMember(memberIds: string[]): Promise<NonNullablePaths<ListMembersBadgeIdsResponse, `memberBadgeIds` | `memberBadgeIds.${number}.memberId`, 2>>;
/**
 ...
 * @targetRemovalDate 2026-04-18
 */
declare function getMemberCountsPerBadge(): Promise<NonNullablePaths<GetMemberCountsPerBadgeResponse, `badgeMemberCounts` | `badgeMemberCounts.${number}.badgeId` | `badgeMemberCounts.${number}.memberCount`, 2>>;
/**
