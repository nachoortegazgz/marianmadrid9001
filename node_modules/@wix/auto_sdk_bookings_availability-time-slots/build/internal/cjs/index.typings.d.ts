...
/** @docsIgnore */
type ListAvailabilityTimeSlotEndOptionsApplicationErrors = {
    code?: 'END_OPTIONS_NOT_SUPPORTED';
    description?: string;
    data?: Record<string, any>;
} | {
    code?: 'MAX_END_DATE_EXCEEDS_MAXIMUM';
    description?: string;
    data?: Record<string, any>;
} | {
    code?: 'SERVICE_NOT_FOUND';
 ...
 */
declare function listAvailabilityTimeSlots(options?: ListAvailabilityTimeSlotsOptions): Promise<NonNullablePaths<ListAvailabilityTimeSlotsResponse, `timeSlots` | `timeSlots.${number}.location.locationType`, 3> & {
 ...
 */
declare function listAvailabilityTimeSlotEndOptions(serviceId: string, options?: NonNullablePaths<ListAvailabilityTimeSlotEndOptions, `localStartDate` | `location`, 0>): Promise<NonNullablePaths<ListAvailabilityTimeSlotEndOptionsResponse, `endOptions` | `endOptions.${number}.location.locationType`, 3> & {
 ...
 */
declare function getAvailabilityTimeSlot(serviceId: string, localStartDate: string, localEndDate: string, timeZone: string, location: Location, options?: GetAvailabilityTimeSlotOptions): Promise<NonNullablePaths<GetAvailabilityTimeSlotResponse, `timeSlot.location.locationType` | `timeSlot.availableResources` | `timeSlot.nestedTimeSlots` | `timeSlot.nestedTimeSlots.${number}.serviceId` | `timeSlot.nestedTimeSlots.${number}.localStartDate` | `timeSlot.nestedTimeSlots.${number}.localEndDate`, 3> & {
