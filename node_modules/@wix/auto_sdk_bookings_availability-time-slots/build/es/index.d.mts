...
export { ApplicationError, AvailableResources, BookingPolicyViolations, BulkActionMetadata, BulkListAvailabilityTimeSlotsRequest, BulkListAvailabilityTimeSlotsResponse, BulkServiceTimeSlotsResult, CursorPaging, CursorPagingMetadata, Cursors, CustomerChoices, DiagnoseAvailabilityRequest, DiagnoseAvailabilityResponse, DiagnosisReason, EventInfo, GetAvailabilityTimeSlotRequest, GetAvailabilityTimeSlotRequestCustomerChoices, GetEventTimeSlotRequest, GetEventTimeSlotResponse, GetMultiServiceAvailabilityTimeSlotRequest, GetMultiServiceAvailabilityTimeSlotResponse, ItemMetadata, ListAvailabilityTimeSlotEndOptionsRequest, ListAvailabilityTimeSlotsRequest, ListEventTimeSlotsRequest, ListEventTimeSlotsResponse, ListMultiServiceAvailabilityTimeSlotsRequest, ListMultiServiceAvailabilityTimeSlotsResponse, LocationType, LocationTypeWithLiterals, NestedTimeSlot, NonBookableReasons, ReasonCode, ReasonCodeWithLiterals, RequestedGender, RequestedGenderValue, RequestedGenderValueRequestedGender, RequestedGenderValueRequestedGenderWithLiterals, RequestedGenderWithLiterals, ResolvedContext, Resource, ResourceType, ScheduleInfo, Service, ServiceTimeSlots, SuggestedAction, SuggestedActionWithLiterals, TimeSlot, V2CustomerChoices, V2RequestedGenderValue, WaitingList } from './index.typings.mjs';
...
interface ListAvailabilityTimeSlotsSignature {
     ...
     */
    (options?: ListAvailabilityTimeSlotsOptions): Promise<NonNullablePaths<ListAvailabilityTimeSlotsResponse, `timeSlots` | `timeSlots.${number}.location.locationType`, 3> & {
...
interface ListAvailabilityTimeSlotEndOptionsSignature {
     ...
     */
    (serviceId: string, options?: NonNullablePaths<ListAvailabilityTimeSlotEndOptions, `localStartDate` | `location`, 0>): Promise<NonNullablePaths<ListAvailabilityTimeSlotEndOptionsResponse, `endOptions` | `endOptions.${number}.location.locationType`, 3> & {
