...
interface UpdateServiceSignature {
     ...
     */
    (_id: string, service: NonNullablePaths<UpdateService, `revision`, 0>): Promise<NonNullablePaths<Service, `type` | `media.items` | `category._id` | `form._id` | `payment.fixed.price.value` | `payment.fixed.price.currency` | `payment.subscription.frequency` | `payment.subscription.firstChargeDate` | `payment.rateType` | `payment.pricingPlanIds` | `payment.addOnOption` | `payment.discountInfo.discountName` | `locations` | `locations.${number}.business._id` | `locations.${number}.business.name` | `locations.${number}.custom._id` | `locations.${number}._id` | `locations.${number}.type` | `bookingPolicy._id` | `bookingPolicy.customPolicyDescription.enabled` | `bookingPolicy.customPolicyDescription.description` | `bookingPolicy.limitEarlyBookingPolicy.enabled` | `bookingPolicy.limitEarlyBookingPolicy.earliestBookingInMinutes` | `bookingPolicy.limitLateBookingPolicy.enabled` | `bookingPolicy.limitLateBookingPolicy.latestBookingInMinutes` | `bookingPolicy.bookAfterStartPolicy.enabled` | `bookingPolicy.cancellationPolicy.enabled` | `bookingPolicy.cancellationPolicy.limitLatestCancellation` | `bookingPolicy.cancellationPolicy.latestCancellationInMinutes` | `bookingPolicy.reschedulePolicy.enabled` | `bookingPolicy.reschedulePolicy.limitLatestReschedule` | `bookingPolicy.reschedulePolicy.latestRescheduleInMinutes` | `bookingPolicy.waitlistPolicy.enabled` | `bookingPolicy.waitlistPolicy.capacity` | `bookingPolicy.waitlistPolicy.reservationTimeInMinutes` | `bookingPolicy.participantsPolicy.maxParticipantsPerBooking` | `bookingPolicy.resourcesPolicy.enabled` | `bookingPolicy.resourcesPolicy.autoAssignAllowed` | `bookingPolicy.cancellationFeePolicy.enabled` | `bookingPolicy.cancellationFeePolicy.cancellationWindows` | `bookingPolicy.cancellationFeePolicy.cancellationWindows.${number}.percentage` | `bookingPolicy.saveCreditCardPolicy.enabled` | `schedule.availabilityConstraints.durations` | `schedule.availabilityConstraints.durations.${number}.minutes` | `schedule.availabilityConstraints.sessionDurations` | `schedule.availabilityConstraints.timeBetweenSessions` | `schedule.availabilityConstraints.durationRange.hourOptions.minDurationInMinutes` | `schedule.availabilityConstraints.durationRange.hourOptions.maxDurationInMinutes` | `schedule.availabilityConstraints.durationRange.dayOptions.minDurationInDays` | `schedule.availabilityConstraints.durationRange.dayOptions.maxDurationInDays` | `schedule.availabilityConstraints.durationRange.unitType` | `staffMemberIds` | `staffMemberDetails.staffMembers` | `staffMemberDetails.staffMembers.${number}.staffMemberId` | `serviceResources` | `supportedSlugs` | `supportedSlugs.${number}.name` | `seoData.tags` | `seoData.tags.${number}.type` | `seoData.tags.${number}.children` | `seoData.tags.${number}.custom` | `seoData.tags.${number}.disabled` | `seoData.settings.preventAutoRedirect` | `seoData.settings.keywords` | `seoData.settings.keywords.${number}.term` | `seoData.settings.keywords.${number}.isMain` | `addOnGroups` | `addOnDetails` | `taxableAddress.taxableAddressType`, 4> & {
...
interface BulkUpdateServicesByFilterSignature {
     ...
     */
    (filter: Record<string, any>, options: NonNullablePaths<BulkUpdateServicesByFilterOptions, `service`, 0>): Promise<NonNullablePaths<BulkUpdateServicesByFilterResponse, `jobId`, 0>>;
}
...
interface BulkDeleteServicesByFilterSignature {
     ...
     */
    (filter: Record<string, any>, options?: BulkDeleteServicesByFilterOptions): Promise<NonNullablePaths<BulkDeleteServicesByFilterResponse, `jobId`, 0>>;
}
...
interface CountServicesSignature {
     ...
     * [API Query Language](https://dev.wix.com/docs/rest/articles/getting-started/api-query-language#filters)
     */
    (options?: CountServicesOptions): Promise<NonNullablePaths<CountServicesResponse, `count`, 0>>;
}
...
interface QueryCategoriesSignature {
     ...
     */
    (options?: QueryCategoriesOptions): Promise<NonNullablePaths<QueryCategoriesResponse, `categories` | `categories.${number}._id`, 2>>;
}
...
interface ValidateSlugSignature {
     ...
     */
    (serviceId: string, options?: ValidateSlugOptions): Promise<NonNullablePaths<ValidateSlugResponse, `valid` | `errors`, 0>>;
}
...
interface CreateAddOnGroupSignature {
     ...
     */
    (addOnGroup: NonNullablePaths<AddOnGroup, `name`, 0>, options: NonNullablePaths<CreateAddOnGroupOptions, `serviceId`, 0>): Promise<NonNullablePaths<CreateAddOnGroupResponse, `addOnGroup.addOnIds`, 1> & {
...
interface DeleteAddOnGroupSignature {
     ...
     */
    (addOnGroupId: string, options: NonNullablePaths<DeleteAddOnGroupOptions, `serviceId`, 0>): Promise<void & {
...
interface UpdateAddOnGroupSignature {
     ...
     */
    (addOnGroup: NonNullablePaths<AddOnGroup, `_id`, 0>, options: NonNullablePaths<UpdateAddOnGroupOptions, `serviceId`, 0>): Promise<NonNullablePaths<UpdateAddOnGroupResponse, `addOnGroup.addOnIds`, 1> & {
...
interface ListAddOnGroupsByServiceIdSignature {
     ...
     */
    (serviceId: string, options?: ListAddOnGroupsByServiceIdOptions): Promise<NonNullablePaths<ListAddOnGroupsByServiceIdResponse, `addOnGroupsDetails`, 0>>;
}
...
interface SetAddOnsForGroupSignature {
     ...
     */
    (serviceId: string, options: NonNullablePaths<SetAddOnsForGroupOptions, `addOnIds` | `groupId`, 0>): Promise<NonNullablePaths<SetAddOnsForGroupResponse, `addOnGroup.addOnIds`, 1> & {
...
declare function customQueryServices(httpClient: HttpClient): {
    (query: ServiceQuery, options?: QueryServicesOptions): ReturnType<typeof typedQueryServices>;
