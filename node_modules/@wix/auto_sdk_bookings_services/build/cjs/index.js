...
var V2RequestedFields = /* @__PURE__ */ ((V2RequestedFields2) => {
  ...
  V2RequestedFields2["STAFF_WORKING_HOURS_LOCATIONS"] = "STAFF_WORKING_HOURS_LOCATIONS";
...
async function getService2(serviceId, options) {
  const { httpClient, sideEffects } = arguments[2];
...
function getService3(httpClient) {
  return (serviceId, options) => getService2(
    serviceId,
    options,
    // @ts-ignore
    { httpClient }
...
var onServiceCreated = /* @__PURE__ */ (0, import_sdk_types.EventDefinition)(
...
var onServiceDeleted = /* @__PURE__ */ (0, import_sdk_types.EventDefinition)(
...
var onServiceUpdated = /* @__PURE__ */ (0, import_sdk_types.EventDefinition)(
    ...
    (0, import_transform_paths3.transformPaths)(event, [
      {
        ...
        paths: [
          ...
          { path: "modifiedFields.schedule.lastSessionEnd" },
          { path: "modifiedFields.supportedSlugs.createdDate" },
          { path: "modifiedFields.mainSlug.createdDate" }
        ]
      },
      {
        transformFn: import_image3.transformRESTImageToSDKImage,
        paths: [
          ...
          { path: "entity.staffMembers.mainMedia.image" },
          { path: "entity.staffMemberDetails.staffMembers.mainMedia.image" },
          { path: "modifiedFields.media.items.image" },
          { path: "modifiedFields.media.mainMedia.image" },
          { path: "modifiedFields.media.coverMedia.image" },
          { path: "modifiedFields.staffMembers.mainMedia.image" },
          {
            path: "modifiedFields.staffMemberDetails.staffMembers.mainMedia.image"
          }
        ]
      },
      {
        ...
        paths: [
          ...
          { path: "entity.locations.business.address" },
          { path: "entity.locations.custom.address" },
          { path: "modifiedFields.locations.calculatedAddress" },
          { path: "modifiedFields.locations.business.address" },
          { path: "modifiedFields.locations.custom.address" }
        ]
      },
      {
        transformFn: import_page_url_v23.transformRESTPageURLV2ToSDKPageURLV2,
        paths: [
          ...
          { path: "entity.urls.bookingPage" },
          { path: "entity.urls.calendarPage" },
          { path: "modifiedFields.urls.servicePage" },
          { path: "modifiedFields.urls.bookingPage" },
          { path: "modifiedFields.urls.calendarPage" }
        ]
      }
    ])
  )
...
var onServiceCreated2 = /* @__PURE__ */ (0, import_event_definition_modules.createEventModule)(
  onServiceCreated
);
var onServiceDeleted2 = /* @__PURE__ */ (0, import_event_definition_modules.createEventModule)(
  onServiceDeleted
);
var onServiceUpdated2 = /* @__PURE__ */ (0, import_event_definition_modules.createEventModule)(
  onServiceUpdated
);
