...
interface CreateInviteSignature {
     ...
     */
    (subjectsAssignments: SubjectInviteAssignments[], options?: CreateInviteOptions): Promise<NonNullablePaths<CreateInviteResponse, `successfulInvites` | `successfulInvites.${number}._id` | `successfulInvites.${number}.accountId` | `successfulInvites.${number}.email` | `successfulInvites.${number}.role` | `successfulInvites.${number}.inviterId` | `successfulInvites.${number}.status` | `successfulInvites.${number}.acceptLink` | `successfulInvites.${number}.inviterAccountId` | `failedInvites` | `failedInvites.${number}.subjectEmail` | `failedInvites.${number}.errorMessage`, 4>>;
}

declare const createInvite: MaybeContext<BuildRESTFunction<typeof createInvite$1> & typeof createInvite$1>;

export { CreateInviteOptions, CreateInviteResponse, SubjectInviteAssignments, createInvite };
