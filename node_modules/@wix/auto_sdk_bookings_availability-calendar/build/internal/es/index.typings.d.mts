...
interface GetSlotAvailabilityRequest {
    ...
    /** @internal */
    requireIntakeFormValidation?: boolean | null;
}
...
/** @enumType */
type LocationLocationTypeWithLiterals = LocationLocationType | 'BUSINESS' | 'CUSTOM' | 'CUSTOMER';
 ...
 */
declare function queryAvailability(query: NonNullablePaths<QueryV2, `filter`, 0>, options?: QueryAvailabilityOptions): Promise<NonNullablePaths<QueryAvailabilityResponse, `availabilityEntries` | `availabilityEntries.${number}.slot.serviceId` | `availabilityEntries.${number}.slot.scheduleId` | `availabilityEntries.${number}.slot.location.locationType` | `availabilityEntries.${number}.bookable` | `availabilityEntries.${number}.isFromV2`, 4>>;
 ...
 * @targetRemovalDate 2026-03-31
 */
declare function calculateMultiSlotAvailability(options?: CalculateMultiSlotAvailabilityOptions): Promise<NonNullablePaths<CalculateMultiSlotAvailabilityResponse, `slots` | `slots.${number}.slot.serviceId` | `slots.${number}.slot.scheduleId` | `slots.${number}.slot.location.locationType` | `slots.${number}.bookable` | `slots.${number}.isFromV2`, 4>>;
