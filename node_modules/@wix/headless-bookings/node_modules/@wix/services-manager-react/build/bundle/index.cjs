...
__export(src_exports, {
  ServicesManagerProvider: () => ServicesManagerProvider,
  WixServices: () => WixServices,
...
c.prototype.subscribe = function(i3) {
  return E(() => {
...
a.prototype.S = function(i3) {
  ...
  c.prototype.S.call(this, i3);
};
a.prototype.U = function(i3) {
  if (void 0 !== this.t) {
    c.prototype.U.call(this, i3);
    if (void 0 === this.t) {
      this.f &= -33;
      for (let i4 = this.s; void 0 !== i4; i4 = i4.n)
        i4.S.U(i4);
...
var [l2] = import_react.version.split(".").map(Number);
...
var j = "undefined" != typeof window ? import_react.useLayoutEffect : import_react.useEffect;
function P(t2 = 0) {
  w2();
  const n2 = (0, import_react.useRef)();
  if (null == n2.current)
  ...
  const e2 = n2.current;
  (0, import_shim.useSyncExternalStore)(e2.subscribe, e2.getSnapshot, e2.getSnapshot);
  e2.S();
  if (0 === t2)
    j(x);
  return e2;
}
Object.defineProperties(c.prototype, { $$typeof: { configurable: true, value: d2 }, type: { configurable: true, value: function({ data: t2 }) {
  const n2 = P(1);
  try {
    return t2.value;
  } finally {
...
if (!globalThis.WixReactContext) {
  globalThis.WixReactContext = (0, import_react2.createContext)(void 0);
}
...
// src/index.tsx
var import_services_manager = require("@wix/services-manager");
function ServicesManagerProvider({
  servicesManager,
  children
}) {
  const hasProvidedComponents = servicesManager.hasService(
  ...
  return (
    ...
    /* @__PURE__ */ import_react3.default.createElement(
      ...
      hasProvidedComponents && /* @__PURE__ */ import_react3.default.createElement(ProvidedComponents, { position: "top" }),
      children,
      hasProvidedComponents && /* @__PURE__ */ import_react3.default.createElement(ProvidedComponents, { position: "bottom" })
    )
  );
}
function useGetService() {
  const maybeContext = (0, import_react3.useContext)(WixContext);
  if (!maybeContext) {
    throw new Error(
...
function WixServices(props) {
  const maybePartialServiceManager = (0, import_react3.useContext)(WixContext);
  const [servicesManager] = (0, import_react3.useState)(
    () => maybePartialServiceManager ? maybePartialServiceManager.extend(props.servicesMap) : (0, import_services_manager.createServicesManager)(props.servicesMap)
  );
  ...
  return /* @__PURE__ */ import_react3.default.createElement(ServicesManagerProvider, { servicesManager }, props.children);
}
function ProvidedComponents({ position }) {
  const provideComponentService = useService(ProvideComponentServiceDefinition);
  const Comps = position === "top" ? provideComponentService.getAllTopComponents() : provideComponentService.getAllBottomComponents();
  return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, Comps.map((Comp, index) => /* @__PURE__ */ import_react3.default.createElement(Comp, { key: index })));
}
