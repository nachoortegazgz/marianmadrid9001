...
exports.TimeSlotListService = services_definitions_1.implementService.withConfig()(time_slot_list_def_js_1.TimeSlotListServiceDefinition, ({ getService, config }) => {
    ...
    const getFilters = () => {
        ...
        const isCustomOrCustomerLocation = selectedLocation?.type === auto_sdk_bookings_availability_time_slots_1.LocationType.CUSTOM ||
            selectedLocation?.type === auto_sdk_bookings_availability_time_slots_1.LocationType.CUSTOMER;
