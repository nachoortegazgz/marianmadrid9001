...
interface ChatSettings {
     ...
     */
    personality?: PersonalityWithLiterals;
}
...
/** @enumType */
type PersonalityWithLiterals = Personality | 'PROFESSIONAL' | 'FRIENDLY' | 'PLAYFUL' | 'DIRECT';
 ...
 */
declare function createChatSettings(chatSettings: NonNullablePaths<ChatSettings, `_id`, 0>): Promise<NonNullablePaths<ChatSettings, `_id` | `personality`, 0>>;
/**
 ...
 */
declare function updateChatSettings(_id: string, chatSettings: UpdateChatSettings): Promise<NonNullablePaths<ChatSettings, `_id` | `personality`, 0>>;
 ...
 */
declare function getChatSettings(chatSettingsId: string): Promise<NonNullablePaths<ChatSettings, `_id` | `personality`, 0>>;
/**
 ...
 * @requiredField query
 */
declare function typedQueryChatSettings(query: ChatSettingsQuery): Promise<NonNullablePaths<QueryChatSettingsResponse, `chatSettings` | `chatSettings.${number}._id` | `chatSettings.${number}.personality`, 2>>;
interface ChatSettingsQuerySpec extends QuerySpec {
    paging: 'cursor';
    wql: [
        {
            fields: ['greetingMessage', 'summaryMessage'];
            operators: '*';
            sort: 'BOTH';
        }
    ];
}
type CommonQueryWithEntityContext = Query<ChatSettings, ChatSettingsQuerySpec>;
type ChatSettingsQuery = {
    /**
    Cursor paging options.
