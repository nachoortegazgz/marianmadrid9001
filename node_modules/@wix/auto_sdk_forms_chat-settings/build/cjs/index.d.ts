...
interface CreateChatSettingsSignature {
     ...
     */
    (chatSettings: NonNullablePaths<ChatSettings, `_id`, 0>): Promise<NonNullablePaths<ChatSettings, `_id` | `personality`, 0>>;
}
...
interface UpdateChatSettingsSignature {
     ...
     */
    (_id: string, chatSettings: UpdateChatSettings): Promise<NonNullablePaths<ChatSettings, `_id` | `personality`, 0>>;
}
...
interface GetChatSettingsSignature {
     ...
     */
    (chatSettingsId: string): Promise<NonNullablePaths<ChatSettings, `_id` | `personality`, 0>>;
}
...
declare function customQueryChatSettings(httpClient: HttpClient): {
    (): ChatSettingsQueryBuilder;
    (query: ChatSettingsQuery): ReturnType<typeof typedQueryChatSettings>;
};
...
declare const queryChatSettings: MaybeContext<BuildRESTFunction<typeof customQueryChatSettings> & typeof customQueryChatSettings>;
/** */
