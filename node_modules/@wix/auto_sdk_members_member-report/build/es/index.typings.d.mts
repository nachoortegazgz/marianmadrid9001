 ...
 */
declare function reportMember(memberReport: NonNullablePaths<MemberReport, `reason` | `reportedMemberId`, 0>): Promise<NonNullablePaths<ReportMemberResponse, `memberReport.reportedMemberId` | `memberReport.reason.category`, 2> & {
...
interface MemberReportsQueryBuilder {
     ...
     */
    eq: (propertyName: '_id' | 'reportedMemberId' | 'reportingMemberId' | '_createdDate', value: any) => MemberReportsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ne: (propertyName: '_id' | 'reportedMemberId' | 'reportingMemberId' | '_createdDate', value: any) => MemberReportsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ...
    in: (propertyName: '_id' | 'reportedMemberId' | 'reportingMemberId' | '_createdDate', value: any) => MemberReportsQueryBuilder;
 ...
 * @requiredField query
 */
declare function typedQueryMemberReports(query: MemberReportQuery): Promise<NonNullablePaths<QueryMemberReportsResponse, `memberReports` | `memberReports.${number}.reportedMemberId` | `memberReports.${number}.reason.category`, 3>>;
interface MemberReportQuerySpec extends QuerySpec {
    paging: 'cursor';
    wql: [
        {
            fields: [
...
type CommonQueryWithEntityContext = Query<MemberReport, MemberReportQuerySpec>;
type MemberReportQuery = {
    /**
    Filter object in the following format:
    `"filter" : {
    "fieldName1": "value1",
...
declare const utils: {
    query: _wix_sdk_types.QueryHelpers<MemberReport, MemberReportQuerySpec, MemberReportQuery>;
};
/**
 ...
 */
declare function listReportedMembers(options?: ListReportedMembersOptions): Promise<NonNullablePaths<ListReportedMembersResponse, `reportedMembers` | `reportedMembers.${number}.reportedMemberId` | `reportedMembers.${number}.reportCount` | `reportedMembers.${number}.reviewed`, 2>>;
 ...
 * @targetRemovalDate 2025-01-31
 */
declare function queryReportedMembers(options?: QueryReportedMembersOptions): Promise<NonNullablePaths<QueryReportedMembersResponse, `reportedMembers` | `reportedMembers.${number}.reportedMemberId` | `reportedMembers.${number}.reportCount` | `reportedMembers.${number}.reviewed`, 2>>;
