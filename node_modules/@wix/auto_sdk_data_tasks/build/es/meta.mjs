...
// src/data-autocms-v2-background-task-tasks.types.ts
...
// src/data-autocms-v2-background-task-tasks.meta.ts
...
function listTasks2() {
  const payload = {};
  const getRequestOptions = listTasks(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function cancelTask2() {
  const payload = { taskId: ":taskId" };
  const getRequestOptions = cancelTask(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
export {
  ...
  cancelTask2 as cancelTask,
  createTask2 as createTask,
  getTask2 as getTask,
  listTasks2 as listTasks
};
