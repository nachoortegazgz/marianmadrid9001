...
interface Card {
    ...
    /**
     * Lexicographical position used for sorting cards within a stage.
     * @internal
     * @maxLength 40
     * @readonly
     */
...
interface ContactInfo {
    ...
    /**
     * Contact's full name. This field is used for search and filter only and isn't returned.
     * @internal
     * @maxLength 100
     * @readonly
     */
    ...
    /**
     * Contact's display name. This field is used for sorting only and isn't returned.
     * @internal
     * @maxLength 100
     * @readonly
     */
 ...
 */
declare function createCard(options?: NonNullablePaths<CreateCardOptions, `card.name` | `card.pipelineId` | `card.stageId`, 1>): Promise<NonNullablePaths<Card, `priority` | `value.value` | `value.currency` | `outcome` | `additionalContacts` | `linkedEntities` | `linkedEntities.${number}.entityId` | `linkedEntities.${number}.referencedEntity` | `tags.privateTags.tagIds`, 2> & {
 ...
 */
declare function getCard(cardId: string): Promise<NonNullablePaths<Card, `priority` | `value.value` | `value.currency` | `outcome` | `additionalContacts` | `linkedEntities` | `linkedEntities.${number}.entityId` | `linkedEntities.${number}.referencedEntity` | `tags.privateTags.tagIds`, 2>>;
/**
 ...
 */
declare function updateCard(_id: string, options?: UpdateCardOptions): Promise<NonNullablePaths<Card, `priority` | `value.value` | `value.currency` | `outcome` | `additionalContacts` | `linkedEntities` | `linkedEntities.${number}.entityId` | `linkedEntities.${number}.referencedEntity` | `tags.privateTags.tagIds`, 2> & {
 ...
 * @requiredField query
 */
declare function typedQueryCards(query: CardQuery): Promise<NonNullablePaths<QueryCardsResponse, `cards` | `cards.${number}.priority` | `cards.${number}.value.value` | `cards.${number}.value.currency` | `cards.${number}.outcome`, 3>>;
...
declare const utils: {
    query: _wix_sdk_types.QueryHelpers<Card, CardQuerySpec, CardQuery>;
    search: _wix_sdk_types.SearchHelpers<Card, CardSearchSpec, CardSearch>;
};
 ...
 */
declare function searchCardsByStage(pipelineId: string, options?: NonNullablePaths<SearchCardsByStageOptions, `stageIds`, 0>): Promise<NonNullablePaths<SearchCardsByStageResponse, `results`, 0>>;
 ...
 */
declare function bulkUpdateCardTagsByFilter(filter: Record<string, any>, options?: BulkUpdateCardTagsByFilterOptions): Promise<NonNullablePaths<BulkUpdateCardTagsByFilterResponse, `jobId`, 0> & {
...
export { type PrivateTags as $, type CardUpdatedEnvelope as A, type BulkCreateCardsOptions as B, type CreateCardOptions as C, type CardsQueryBuilder as D, type CardQuery as E, typedQueryCards as F, SortOrder as G, SortType as H, SortDirection as I, MissingValues as J, ScalarType as K, Interval as L, type MoveCardOptions as M, NestedAggregationType as N, Outcome as O, Priority as P, AggregationType as Q, Mode as R, type SearchCardsOptions as S, NameFormat as T, type UpdateCardOptions as U, type CardSource as V, WebhookIdentityType as W, type Money as X, type ContactInfo as Y, type LinkedEntity as Z, type ExtendedFields as _, type Card as a, type ItemMetadata as a$, type TagList as a0, type CardMoved as a1, type CardAssigned as a2, type CardOverdue as a3, type CardStale as a4, type CreateCardRequest as a5, type CreateCardResponse as a6, type ContactsNotFound as a7, type GetCardRequest as a8, type GetCardResponse as a9, type NestedAggregationItemKindOneOf as aA, type NestedAggregation as aB, type SearchDetails as aC, type AggregationData as aD, type ValueAggregationResult as aE, type RangeAggregationResult as aF, type NestedAggregationResults as aG, type NestedAggregationResultsResultOneOf as aH, type ValueResults as aI, type RangeResults as aJ, type AggregationResultsScalarResult as aK, type NestedValueAggregationResult as aL, type ValueResult as aM, type RangeResult as aN, type ScalarResult as aO, type NestedResultValue as aP, type NestedResultValueResultOneOf as aQ, type Results as aR, type DateHistogramResult as aS, type GroupByValueResults as aT, type DateHistogramResults as aU, type NestedResults as aV, type AggregationResults as aW, type AggregationResultsResultOneOf as aX, type SearchCardsByStageRequest as aY, type BulkSearchCardsResult as aZ, type BulkCreateCardsRequest as a_, type UpdateCardRequest as aa, type UpdateCardResponse as ab, type MoveCardRequest as ac, type DeleteCardRequest as ad, type DeleteCardResponse as ae, type QueryCardsRequest as af, type CursorQuery as ag, type CursorQueryPagingMethodOneOf as ah, type Sorting as ai, type CursorPaging as aj, type QueryCardsResponse as ak, type CursorPagingMetadata as al, type Cursors as am, type SearchCardsRequest as an, type CursorSearch as ao, type CursorSearchPagingMethodOneOf as ap, type Aggregation as aq, type AggregationKindOneOf as ar, type RangeBucket as as, type IncludeMissingValuesOptions as at, type ValueAggregation as au, type ValueAggregationOptionsOneOf as av, type RangeAggregation as aw, type ScalarAggregation as ax, type DateHistogramAggregation as ay, type NestedAggregationItem as az, type CreateCardApplicationErrors as b, type ApplicationError as b0, type BulkCardResult as b1, type BulkActionMetadata as b2, type BulkUpdateCardsRequest as b3, type BulkUpdateCardsResponseBulkCardResult as b4, type BulkDeleteCardsRequest as b5, type BulkDeleteCardsResponseBulkCardResult as b6, type BulkUpdateCardTagsRequest as b7, type BulkUpdateCardTagsResult as b8, type BulkUpdateCardTagsByFilterRequest as b9, type NestedAggregationTypeWithLiterals as bA, type IntervalWithLiterals as bB, type AggregationTypeWithLiterals as bC, type ModeWithLiterals as bD, type NameFormatWithLiterals as bE, type WebhookIdentityTypeWithLiterals as bF, type CommonQueryWithEntityContext as bG, type CommonSearchWithEntityContext as bH, onCardAssigned as bI, onCardCreated as bJ, onCardDeleted as bK, onCardMoved as bL, onCardOverdue as bM, onCardStale as bN, onCardUpdated as bO, createCard as bP, getCard as bQ, updateCard as bR, moveCard as bS, deleteCard as bT, queryCards as bU, searchCardsByStage as bV, bulkCreateCards as bW, bulkUpdateCards as bX, bulkDeleteCards as bY, bulkUpdateCardTags as bZ, bulkUpdateCardTagsByFilter as b_, type DomainEvent as ba, type DomainEventBodyOneOf as bb, type EntityCreatedEvent as bc, type RestoreInfo as bd, type EntityUpdatedEvent as be, type EntityDeletedEvent as bf, type ActionEvent as bg, type Empty as bh, type MessageEnvelope as bi, type IdentificationData as bj, type IdentificationDataIdOneOf as bk, type AccountInfo as bl, type BaseEventMetadata as bm, type EventMetadata as bn, type AccountInfoMetadata as bo, type CardsQueryResult as bp, type CardQuerySpec as bq, type CardSearchSpec as br, utils as bs, type PriorityWithLiterals as bt, type OutcomeWithLiterals as bu, type SortOrderWithLiterals as bv, type SortTypeWithLiterals as bw, type SortDirectionWithLiterals as bx, type MissingValuesWithLiterals as by, type ScalarTypeWithLiterals as bz, type UpdateCardApplicationErrors as c, type MoveCardResponse as d, type MoveCardApplicationErrors as e, type CardSearch as f, type SearchCardsResponse as g, type SearchCardsByStageOptions as h, type SearchCardsByStageResponse as i, type BulkCreateCardsResponse as j, type MaskedCard as k, type BulkUpdateCardsOptions as l, type BulkUpdateCardsResponse as m, type BulkDeleteCardsResponse as n, type BulkUpdateCardTagsOptions as o, type BulkUpdateCardTagsResponse as p, type BulkUpdateCardTagsApplicationErrors as q, type BulkUpdateCardTagsByFilterOptions as r, type BulkUpdateCardTagsByFilterResponse as s, type BulkUpdateCardTagsByFilterApplicationErrors as t, type CardAssignedEnvelope as u, type CardCreatedEnvelope as v, type CardDeletedEnvelope as w, type CardMovedEnvelope as x, type CardOverdueEnvelope as y, type CardStaleEnvelope as z };
