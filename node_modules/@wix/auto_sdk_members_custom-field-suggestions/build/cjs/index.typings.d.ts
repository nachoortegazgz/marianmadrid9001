 ...
 */
declare function listCustomFieldSuggestions(options?: ListCustomFieldSuggestionsOptions): Promise<NonNullablePaths<ListCustomFieldSuggestionsResponse, `suggestions` | `suggestions.${number}.defaultPrivacy` | `suggestions.${number}.fieldType` | `suggestions.${number}.socialType` | `suggestions.${number}.fieldOrigin`, 2>>;
 ...
 */
declare function queryCustomFieldSuggestions(): SuggestionsQueryBuilder;
...
interface SuggestionsQueryBuilder {
     ...
     */
    eq: (propertyName: 'name' | 'fieldType', value: any) => SuggestionsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ne: (propertyName: 'name' | 'fieldType', value: any) => SuggestionsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ...
    in: (propertyName: 'name' | 'fieldType', value: any) => SuggestionsQueryBuilder;
    exists: (propertyName: 'name' | 'fieldType', value: boolean) => SuggestionsQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments. */
    ascending: (...propertyNames: Array<'name' | 'fieldType'>) => SuggestionsQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments. */
    descending: (...propertyNames: Array<'name' | 'fieldType'>) => SuggestionsQueryBuilder;
 ...
 * @requiredField query
 */
declare function typedQueryCustomFieldSuggestions(query: CustomFieldSuggestionQuery): Promise<NonNullablePaths<QueryCustomFieldSuggestionsResponse, `suggestions` | `suggestions.${number}.defaultPrivacy` | `suggestions.${number}.fieldType` | `suggestions.${number}.socialType` | `suggestions.${number}.fieldOrigin`, 2>>;
interface CustomFieldSuggestionQuerySpec extends QuerySpec {
    paging: 'offset';
    wql: [
        {
...
type CommonQueryWithEntityContext = Query$1<CustomFieldSuggestion, CustomFieldSuggestionQuerySpec>;
type CustomFieldSuggestionQuery = {
    /**
    Filter object.
...
declare const utils: {
    query: _wix_sdk_types.QueryHelpers<CustomFieldSuggestion, CustomFieldSuggestionQuerySpec, CustomFieldSuggestionQuery>;
};

export { type AddressLocation, type CommonQueryWithEntityContext, type CustomFieldSuggestion, type CustomFieldSuggestionQuery, type CustomFieldSuggestionQuerySpec, type ListCustomFieldSuggestionsOptions, type ListCustomFieldSuggestionsRequest, type ListCustomFieldSuggestionsResponse, Origin, type OriginWithLiterals, type Paging, type PagingMetadata, Privacy, type PrivacyWithLiterals, type Query, type QueryCustomFieldSuggestionsRequest, type QueryCustomFieldSuggestionsResponse, SocialTypeType, type SocialTypeTypeWithLiterals, SortOrder, type SortOrderWithLiterals, type Sorting, type SuggestionsQueryBuilder, type SuggestionsQueryResult, Type, type TypeWithLiterals, listCustomFieldSuggestions, queryCustomFieldSuggestions, typedQueryCustomFieldSuggestions, utils };
