...
function typedQueryCustomFieldSuggestions2(httpClient) {
  return (query) => typedQueryCustomFieldSuggestions(
    query,
    // @ts-ignore
    { httpClient }
  );
...
var queryCustomFieldSuggestions4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(customQueryCustomFieldSuggestions);
