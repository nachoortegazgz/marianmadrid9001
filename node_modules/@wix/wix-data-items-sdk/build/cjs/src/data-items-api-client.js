...
class WixDataItemsHttpClient {
    ...
    asyncPatchDataItemsByFilter(request) {
        return this.execHttpCall(exports.asyncPatchDataItemsByFilterRequestOptions, request);
    }
    ...
    asyncRemoveDataItemsByFilter(request) {
        return this.execHttpCall(exports.asyncRemoveDataItemsByFilterRequestOptions, request);
    }
    getAsyncJobStatus(request) {
        return this.execHttpCall(exports.getAsyncJobStatusRequestOptions, request);
    }
    ...
    createDataItemDraft(request) {
        return this.execHttpCall(exports.createDataItemDraftRequestOptions, request);
    }
    publishDataItemDraft(request) {
        return this.execHttpCall(exports.publishDataItemDraftRequestOptions, request);
    }
    unpublishDataItem(request) {
        return this.execHttpCall(exports.unpublishDataItemRequestOptions, request);
    }
...
exports.asyncPatchDataItemsByFilterRequestOptions = {
    method: 'POST',
...
exports.asyncRemoveDataItemsByFilterRequestOptions = {
    method: 'POST',
    methodName: 'AsyncRemoveDataItemsByFilter',
    httpPath: '/v2/bulk/items/async-remove-by-filter',
};
exports.getAsyncJobStatusRequestOptions = {
    method: 'GET',
...
exports.createDataItemDraftRequestOptions = {
    method: 'POST',
    methodName: 'CreateDataItemDraft',
    httpPath: '/v2/items/create-draft',
};
exports.publishDataItemDraftRequestOptions = {
    method: 'POST',
    methodName: 'PublishDataItemDraft',
    httpPath: '/v2/items/publish-draft',
};
exports.unpublishDataItemRequestOptions = {
    method: 'POST',
    methodName: 'UnpublishDataItem',
    httpPath: '/v2/items/unpublish',
};
const reqOptions = ({ method, methodName, httpPath }, payload) => {
    ...
    return ({ host }) => ({
        ...
        params: useSearchParams ? (0, rest_modules_1.toURLSearchParams)(payload, true) : undefined,
    });
};
