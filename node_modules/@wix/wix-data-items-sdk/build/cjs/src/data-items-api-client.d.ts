...
export declare class WixDataItemsHttpClient implements HttpApiClient {
    ...
    asyncPatchDataItemsByFilter(request: AsyncPatchDataItemsByFilterRequest): Promise<HttpResponse<AsyncPatchDataItemsByFilterResponse>>;
    ...
    asyncRemoveDataItemsByFilter(request: AsyncRemoveDataItemsByFilterRequest): Promise<HttpResponse<AsyncRemoveDataItemsByFilterResponse>>;
    getAsyncJobStatus(request: GetAsyncJobStatusRequest): Promise<HttpResponse<GetAsyncJobStatusResponse>>;
    ...
    createDataItemDraft(request: CreateDataItemDraftRequest): Promise<HttpResponse<CreateDataItemDraftResponse>>;
    publishDataItemDraft(request: PublishDataItemDraftRequest): Promise<HttpResponse<PublishDataItemDraftResponse>>;
    unpublishDataItem(request: UnpublishDataItemRequest): Promise<HttpResponse<UnpublishDataItemResponse>>;
...
export declare const asyncPatchDataItemsByFilterRequestOptions: RequestOptionsParams<'POST'>;
...
export declare const asyncRemoveDataItemsByFilterRequestOptions: RequestOptionsParams<'POST'>;
export declare const getAsyncJobStatusRequestOptions: RequestOptionsParams<'GET'>;
...
export declare const createDataItemDraftRequestOptions: RequestOptionsParams<'POST'>;
export declare const publishDataItemDraftRequestOptions: RequestOptionsParams<'POST'>;
export declare const unpublishDataItemRequestOptions: RequestOptionsParams<'POST'>;
...
export { AggregateDataItemsRequest, AggregateDataItemsResponse, AsyncPatchDataItemsByFilterRequest, AsyncPatchDataItemsByFilterResponse, AsyncRemoveDataItemsByFilterRequest, AsyncRemoveDataItemsByFilterResponse, BulkInsertDataItemReferencesRequest, BulkInsertDataItemReferencesResponse, BulkInsertDataItemsRequest, BulkInsertDataItemsResponse, BulkRemoveDataItemReferencesRequest, BulkRemoveDataItemReferencesResponse, BulkRemoveDataItemsRequest, BulkRemoveDataItemsResponse, BulkSaveDataItemsRequest, BulkSaveDataItemsResponse, BulkUpdateDataItemsRequest, BulkUpdateDataItemsResponse, CountDataItemsRequest, CountDataItemsResponse, GetAsyncJobStatusRequest, GetAsyncJobStatusResponse, GetDataItemRequest, GetDataItemResponse, InsertDataItemRequest, InsertDataItemResponse, IsReferencedDataItemRequest, IsReferencedDataItemResponse, QueryDataItemsRequest, QueryDataItemsResponse, QueryDistinctValuesRequest, QueryDistinctValuesResponse, QueryReferencedDataItemsRequest, QueryReferencedDataItemsResponse, PatchDataItemRequest, PatchDataItemResponse, BulkPatchDataItemsRequest, BulkPatchDataItemsResponse, RemoveDataItemRequest, RemoveDataItemResponse, ReplaceDataItemReferencesRequest, ReplaceDataItemReferencesResponse, SaveDataItemRequest, SaveDataItemResponse, TruncateDataItemsRequest, TruncateDataItemsResponse, UpdateDataItemRequest, UpdateDataItemResponse, SearchDataItemsRequest, SearchDataItemsResponse, CreateDataItemDraftRequest, CreateDataItemDraftResponse, PublishDataItemDraftRequest, PublishDataItemDraftResponse, UnpublishDataItemRequest, UnpublishDataItemResponse, };
