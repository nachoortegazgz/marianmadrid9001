...
export declare function asyncPatchByFilter(): __PublicMethodMetaInfo<'POST', {}, api.AsyncPatchDataItemsByFilterRequest, api.AsyncPatchDataItemsByFilterRequest, api.AsyncPatchDataItemsByFilterResponse, api.AsyncPatchDataItemsByFilterResponse>;
export declare function asyncRemoveByFilter(): __PublicMethodMetaInfo<'POST', {}, api.AsyncRemoveDataItemsByFilterRequest, api.AsyncRemoveDataItemsByFilterRequest, api.AsyncRemoveDataItemsByFilterResponse, api.AsyncRemoveDataItemsByFilterResponse>;
export declare function getAsyncJobStatus(): __PublicMethodMetaInfo<'GET', {}, api.GetAsyncJobStatusRequest, api.GetAsyncJobStatusRequest, api.GetAsyncJobStatusResponse, api.GetAsyncJobStatusResponse>;
...
export declare function createDataItemDraft(): __PublicMethodMetaInfo<'POST', {}, api.CreateDataItemDraftRequest, api.CreateDataItemDraftRequest, api.CreateDataItemDraftResponse, api.CreateDataItemDraftResponse>;
export declare function publishDataItemDraft(): __PublicMethodMetaInfo<'POST', {}, api.PublishDataItemDraftRequest, api.PublishDataItemDraftRequest, api.PublishDataItemDraftResponse, api.PublishDataItemDraftResponse>;
export declare function unpublishDataItem(): __PublicMethodMetaInfo<'POST', {}, api.UnpublishDataItemRequest, api.UnpublishDataItemRequest, api.UnpublishDataItemResponse, api.UnpublishDataItemResponse>;
