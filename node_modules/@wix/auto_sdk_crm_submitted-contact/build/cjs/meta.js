...
__export(meta_exports, {
  ...
  appendOrCreateContact: () => appendOrCreateContact
});
module.exports = __toCommonJS(meta_exports);

// src/contacts-v4-submit-contact-submitted-contact.http.ts
var import_float = require("@wix/sdk-runtime/transformations/float");
var import_timestamp = require("@wix/sdk-runtime/transformations/timestamp");
var import_transform_paths = require("@wix/sdk-runtime/transformations/transform-paths");
var import_rest_modules = require("@wix/sdk-runtime/rest-modules");
function resolveComWixpressContactsAllocatorApiV4ContactSubmitServiceV4Url(opts) {
...
var PACKAGE_NAME = "@wix/auto_sdk_crm_submitted-contact";
function submitContact(payload) {
  function __submitContact({ host }) {
    ...
    const metadata = {
      ...
      method: "POST",
      methodFqn: "com.wixpress.contacts.allocator.api.v4.ContactSubmitServiceV4.SubmitContact",
...
// src/contacts-v4-submit-contact-submitted-contact.types.ts
...
// src/contacts-v4-submit-contact-submitted-contact.meta.ts
function appendOrCreateContact() {
  const payload = {};
  const getRequestOptions = submitContact(payload);
