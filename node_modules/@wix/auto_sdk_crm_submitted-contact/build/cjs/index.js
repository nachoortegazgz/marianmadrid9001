...
__export(index_exports, {
  ...
  appendOrCreateContact: () => appendOrCreateContact3
});
module.exports = __toCommonJS(index_exports);

// src/contacts-v4-submit-contact-submitted-contact.universal.ts
...
async function appendOrCreateContact(options) {
  ...
  const reqOpts = submitContact(payload);
...
// src/contacts-v4-submit-contact-submitted-contact.public.ts
function appendOrCreateContact2(httpClient) {
  return (options) => appendOrCreateContact(
    options,
    // @ts-ignore
    { httpClient }
  );
...
// src/contacts-v4-submit-contact-submitted-contact.context.ts
var import_rest_modules2 = require("@wix/sdk-runtime/rest-modules");
var appendOrCreateContact3 = /* @__PURE__ */ (0, import_rest_modules2.createRESTModule)(appendOrCreateContact2);
