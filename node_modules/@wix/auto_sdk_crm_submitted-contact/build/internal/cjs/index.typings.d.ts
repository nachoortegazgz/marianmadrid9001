...
/** @docsIgnore */
type AppendOrCreateContactApplicationErrors = {
 ...
 */
declare function appendOrCreateContact(options?: AppendOrCreateContactOptions): Promise<NonNullablePaths<SubmitContactResponse, `contactId` | `identityType` | `newContact`, 0> & {
...
export { type AccountInfo, type ActivityIcon, type Address, type AddressLocation, type AddressStreetOneOf, AddressTag, type AddressTagWithLiterals, type AppendOrCreateContactApplicationErrors, type AppendOrCreateContactOptions, type AssigneesWrapper, type ContactActivity, ContactActivityType, type ContactActivityTypeWithLiterals, type ContactAddress, type ContactAddressesWrapper, type ContactEmail, type ContactEmailsWrapper, type ContactInfo, type ContactName, type ContactPhone, type ContactPhonesWrapper, type ContactPicture, ContactSourceType, type ContactSourceTypeWithLiterals, type ContactToSubmit, EmailTag, type EmailTagWithLiterals, type ExtendedFieldsWrapper, type IdentificationData, type IdentificationDataIdOneOf, IdentityType, type IdentityTypeWithLiterals, ImageProvider, type ImageProviderWithLiterals, type LabelsWrapper, type LocationsWrapper, type MessageEnvelope, PhoneTag, type PhoneTagWithLiterals, type StreetAddress, type Subdivision, SubdivisionType, type SubdivisionTypeWithLiterals, type SubmitContact, type SubmitContactOptions, type SubmitContactRequest, type SubmitContactResponse, SubmitOperation, type SubmitOperationWithLiterals, type SubmitVisitorIdRequest, type SubmitVisitorIdResponse, WebhookIdentityType, type WebhookIdentityTypeWithLiterals, appendOrCreateContact };
