...
import { Category, CreateCategoryApplicationErrors, UpdateCategory, CountCategoriesOptions, CountCategoriesResponse, MoveCategoryOptions, MoveCategoryResponse, CategoryCreatedEnvelope, CategoryDeletedEnvelope, CategoryUpdatedEnvelope, CategoriesQueryBuilder, CategoryQuery, typedQueryCategories } from './index.typings.mjs';
export { AccountInfo, AccountInfoMetadata, ActionEvent, BaseEventMetadata, CategoriesQueryResult, CategoryQuerySpec, CommonQueryWithEntityContext, CountCategoriesRequest, CreateCategoryRequest, CreateCategoryResponse, CursorPaging, CursorPagingMetadata, CursorQuery, CursorQueryPagingMethodOneOf, Cursors, DeleteCategoryRequest, DeleteCategoryResponse, DomainEvent, DomainEventBodyOneOf, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, ExtendedFields, GetCategoryRequest, GetCategoryResponse, IdentificationData, IdentificationDataIdOneOf, ImportCategoriesRequest, ImportCategoriesResponse, MessageEnvelope, MoveCategoryRequest, Position, PositionWithLiterals, PublishCategoriesUpdatedRequest, PublishCategoriesUpdatedResponse, QueryCategoriesRequest, QueryCategoriesResponse, RestoreInfo, SortOrder, SortOrderWithLiterals, Sorting, UpdateCategoryRequest, UpdateCategoryResponse, WebhookIdentityType, WebhookIdentityTypeWithLiterals, utils } from './index.typings.mjs';
...
interface CreateCategorySignature {
     ...
     */
    (category: NonNullablePaths<Category, `name`, 0>): Promise<Category & {
...
interface UpdateCategorySignature {
     ...
     */
    (_id: string, category: NonNullablePaths<UpdateCategory, `revision`, 0>): Promise<Category>;
}
...
interface CountCategoriesSignature {
     ...
     */
    (options?: CountCategoriesOptions): Promise<NonNullablePaths<CountCategoriesResponse, `count`, 0>>;
}
...
declare function customQueryCategories(httpClient: HttpClient): {
    ...
    (query: CategoryQuery): ReturnType<typeof typedQueryCategories>;
};
