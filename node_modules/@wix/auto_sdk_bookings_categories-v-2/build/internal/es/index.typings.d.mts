...
/** @enumType */
type PositionWithLiterals = Position | 'LAST' | 'FIRST' | 'AFTER_CATEGORY';
 ...
 */
declare function createCategory(category: NonNullablePaths<Category, `name`, 0>): Promise<Category & {
 ...
 */
declare function updateCategory(_id: string, category: NonNullablePaths<UpdateCategory, `revision`, 0>): Promise<Category>;
 ...
 * @requiredField query
 */
declare function typedQueryCategories(query: CategoryQuery): Promise<NonNullablePaths<QueryCategoriesResponse, `categories`, 0>>;
interface CategoryQuerySpec extends QuerySpec {
    paging: 'cursor';
    wql: [
        {
            fields: ['_id', 'name', 'sortOrder'];
            operators: '*';
            sort: 'BOTH';
        }
    ];
 ...
 */
declare function countCategories(options?: CountCategoriesOptions): Promise<NonNullablePaths<CountCategoriesResponse, `count`, 0>>;
