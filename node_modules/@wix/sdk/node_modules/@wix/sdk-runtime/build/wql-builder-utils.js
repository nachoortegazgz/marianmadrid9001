...
function createFieldFilter(field, existingOps = {}) {
    ...
    const getFilter = () => {
        ...
        return {
            [renameFieldPathBySegment(field, systemFieldRenameMap)]: existingOps,
        };
    };
    return {
 ...
 */
export function createSortFactory() {
    return ((field) => ({
        asc: () => ({
            sort: {
                fieldName: renameFieldPathBySegment(field, systemFieldRenameMap),
                order: 'ASC',
            },
        }),
        desc: () => ({
