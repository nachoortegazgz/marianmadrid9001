...
exports.createSearchUtils = createSearchUtils;
const wql_builder_utils_js_1 = require("./wql-builder-utils.js");
const field_rename_js_1 = require("./field-rename.js");
...
function createSearchParamsBuilder() {
    ...
    const builder = {
        ...
        fields(fields) {
            state = {
                ...state,
                fields: fields.map((field) => (0, field_rename_js_1.renameFieldPathBySegment)(field, field_rename_js_1.systemFieldRenameMap)),
            };
            return builder;
        },
        fuzzy(enabled = true) {
...
function createAggregationBuilder(name) {
    ...
    const builder = {
        ...
        onField(field) {
            state = {
                ...state,
                fieldPath: (0, field_rename_js_1.renameFieldPathBySegment)(field, field_rename_js_1.systemFieldRenameMap),
            };
            return builder;
        },
        asValueAggregation() {
...
function createSearchUtils() {
    return {
        ...
        Filter: (0, wql_builder_utils_js_1.createFilterFactory)(),
        Sort: (0, wql_builder_utils_js_1.createSortFactory)(),
