...
/** @enumType */
type StatusWithLiterals = Status | 'UNKNOWN' | 'PENDING' | 'APPROVED' | 'BLOCKED' | 'OFFLINE';
...
/** @enumType */
type PrivacyStatusStatusWithLiterals = PrivacyStatusStatus | 'UNKNOWN' | 'PRIVATE' | 'PUBLIC';
...
/** @enumType */
type SetWithLiterals = Set | 'PUBLIC' | 'EXTENDED' | 'FULL';
/** Member profile. */
...
/** @docsIgnore */
type GetCurrentMemberApplicationErrors = {
    code?: 'NOT_FOUND';
    description?: string;
    data?: Record<string, any>;
};
 ...
 */
declare function updateCurrentMemberSlug(slug: string): Promise<NonNullablePaths<UpdateMySlugResponse, `member.status` | `member.contact.phones` | `member.contact.emails` | `member.contact.addresses` | `member.contact.addresses.${number}.streetAddress.number` | `member.contact.addresses.${number}.streetAddress.name` | `member.profile.photo._id` | `member.profile.photo.url` | `member.profile.photo.height` | `member.profile.photo.width` | `member.privacyStatus` | `member.activityStatus`, 5> & {
 ...
 */
declare function updateMemberSlug(_id: string, slug: string): Promise<NonNullablePaths<UpdateMemberSlugResponse, `member.status` | `member.contact.phones` | `member.contact.emails` | `member.contact.addresses` | `member.contact.addresses.${number}.streetAddress.number` | `member.contact.addresses.${number}.streetAddress.name` | `member.profile.photo._id` | `member.profile.photo.url` | `member.profile.photo.height` | `member.profile.photo.width` | `member.privacyStatus` | `member.activityStatus`, 5> & {
 ...
 */
declare function joinCommunity(): Promise<NonNullablePaths<JoinCommunityResponse, `member.status` | `member.contact.phones` | `member.contact.emails` | `member.contact.addresses` | `member.contact.addresses.${number}.streetAddress.number` | `member.contact.addresses.${number}.streetAddress.name` | `member.profile.photo._id` | `member.profile.photo.url` | `member.profile.photo.height` | `member.profile.photo.width` | `member.privacyStatus` | `member.activityStatus`, 5> & {
 ...
 */
declare function leaveCommunity(): Promise<NonNullablePaths<LeaveCommunityResponse, `member.status` | `member.contact.phones` | `member.contact.emails` | `member.contact.addresses` | `member.contact.addresses.${number}.streetAddress.number` | `member.contact.addresses.${number}.streetAddress.name` | `member.profile.photo._id` | `member.profile.photo.url` | `member.profile.photo.height` | `member.profile.photo.width` | `member.privacyStatus` | `member.activityStatus`, 5>>;
/**
 ...
 */
declare function getCurrentMember(options?: GetCurrentMemberOptions): Promise<NonNullablePaths<GetMyMemberResponse, `member.status` | `member.contact.phones` | `member.contact.emails` | `member.contact.addresses` | `member.contact.addresses.${number}.streetAddress.number` | `member.contact.addresses.${number}.streetAddress.name` | `member.profile.photo._id` | `member.profile.photo.url` | `member.profile.photo.height` | `member.profile.photo.width` | `member.privacyStatus` | `member.activityStatus`, 5> & {
    __applicationErrorsType?: GetCurrentMemberApplicationErrors;
}>;
 ...
 */
declare function getMember(_id: string, options?: GetMemberOptions): Promise<NonNullablePaths<Member, `status` | `contact.phones` | `contact.emails` | `contact.addresses` | `contact.addresses.${number}.streetAddress.number` | `contact.addresses.${number}.streetAddress.name` | `profile.photo._id` | `profile.photo.url` | `profile.photo.height` | `profile.photo.width` | `privacyStatus` | `activityStatus`, 4> & {
...
interface MembersQueryBuilder {
     ...
     */
    eq: (propertyName: '_id' | 'loginEmail' | 'status' | 'contactId' | 'contact.firstName' | 'contact.lastName' | 'profile.nickname' | 'profile.slug' | 'privacyStatus', value: any) => MembersQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ne: (propertyName: '_id' | 'loginEmail' | 'status' | 'contactId' | 'contact.firstName' | 'contact.lastName' | 'profile.nickname' | 'profile.slug' | 'privacyStatus', value: any) => MembersQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ...
    in: (propertyName: '_id' | 'loginEmail' | 'status' | 'contactId' | 'contact.firstName' | 'contact.lastName' | 'profile.nickname' | 'profile.slug' | 'privacyStatus', value: any) => MembersQueryBuilder;
    exists: (propertyName: '_id' | 'loginEmail' | 'status' | 'contactId' | 'contact.firstName' | 'contact.lastName' | 'profile.nickname' | 'profile.slug' | 'privacyStatus', value: boolean) => MembersQueryBuilder;
...
declare const utils: {
    query: _wix_sdk_types.QueryHelpers<Member, MemberQuerySpec, MemberQuery>;
};
/**
 * Mutes a member.
 *
 ...
 */
declare function muteMember(_id: string): Promise<NonNullablePaths<MuteMemberResponse, `member.status` | `member.contact.phones` | `member.contact.emails` | `member.contact.addresses` | `member.contact.addresses.${number}.streetAddress.number` | `member.contact.addresses.${number}.streetAddress.name` | `member.profile.photo._id` | `member.profile.photo.url` | `member.profile.photo.height` | `member.profile.photo.width` | `member.privacyStatus` | `member.activityStatus`, 5>>;
/**
 * Unmutes a member.
 *
 ...
 */
declare function unmuteMember(_id: string): Promise<NonNullablePaths<UnmuteMemberResponse, `member.status` | `member.contact.phones` | `member.contact.emails` | `member.contact.addresses` | `member.contact.addresses.${number}.streetAddress.number` | `member.contact.addresses.${number}.streetAddress.name` | `member.profile.photo._id` | `member.profile.photo.url` | `member.profile.photo.height` | `member.profile.photo.width` | `member.privacyStatus` | `member.activityStatus`, 5>>;
/**
 ...
 */
declare function approveMember(_id: string): Promise<NonNullablePaths<ApproveMemberResponse, `member.status` | `member.contact.phones` | `member.contact.emails` | `member.contact.addresses` | `member.contact.addresses.${number}.streetAddress.number` | `member.contact.addresses.${number}.streetAddress.name` | `member.profile.photo._id` | `member.profile.photo.url` | `member.profile.photo.height` | `member.profile.photo.width` | `member.privacyStatus` | `member.activityStatus`, 5>>;
/**
 * Blocks a member.
 *
 ...
 */
declare function blockMember(_id: string): Promise<NonNullablePaths<BlockMemberResponse, `member.status` | `member.contact.phones` | `member.contact.emails` | `member.contact.addresses` | `member.contact.addresses.${number}.streetAddress.number` | `member.contact.addresses.${number}.streetAddress.name` | `member.profile.photo._id` | `member.profile.photo.url` | `member.profile.photo.height` | `member.profile.photo.width` | `member.privacyStatus` | `member.activityStatus`, 5> & {
 ...
 */
declare function disconnectMember(_id: string): Promise<NonNullablePaths<DisconnectMemberResponse, `member.status` | `member.contact.phones` | `member.contact.emails` | `member.contact.addresses` | `member.contact.addresses.${number}.streetAddress.number` | `member.contact.addresses.${number}.streetAddress.name` | `member.profile.photo._id` | `member.profile.photo.url` | `member.profile.photo.height` | `member.profile.photo.width` | `member.privacyStatus` | `member.activityStatus`, 5>>;
/**
 ...
 */
declare function bulkDeleteMembersByFilter(filter: any, options?: BulkDeleteMembersByFilterOptions): Promise<NonNullablePaths<BulkDeleteMembersByFilterResponse, `jobId`, 0>>;
 ...
 */
declare function bulkApproveMembers(filter: any): Promise<NonNullablePaths<BulkApproveMembersResponse, `jobId`, 0>>;
/**
 ...
 */
declare function bulkBlockMembers(filter: any): Promise<NonNullablePaths<BulkBlockMembersResponse, `jobId`, 0>>;
/**
 ...
 */
declare function deleteMemberPhones(_id: string): Promise<NonNullablePaths<DeleteMemberPhonesResponse, `member.status` | `member.contact.phones` | `member.contact.emails` | `member.contact.addresses` | `member.contact.addresses.${number}.streetAddress.number` | `member.contact.addresses.${number}.streetAddress.name` | `member.profile.photo._id` | `member.profile.photo.url` | `member.profile.photo.height` | `member.profile.photo.width` | `member.privacyStatus` | `member.activityStatus`, 5>>;
/**
