...
interface ListMembersSignature {
     ...
     */
    (options?: ListMembersOptions): Promise<NonNullablePaths<ListMembersResponse, `members` | `members.${number}.status` | `members.${number}.profile.photo._id` | `members.${number}.profile.photo.url` | `members.${number}.profile.photo.height` | `members.${number}.profile.photo.width` | `members.${number}.privacyStatus` | `members.${number}.activityStatus`, 4>>;
}
...
interface DeleteMyMemberSignature {
     ...
     * To delete multiple members by a specified filter, call [Bulk Delete Members By Filter](https://dev.wix.com/docs/api-reference/crm/members-contacts/members/member-management/members/bulk-delete-members-by-filter).
     */
    (options?: DeleteMyMemberOptions): Promise<void & {
...
interface BulkDeleteMembersByFilterSignature {
     ...
     */
    (filter: any, options?: BulkDeleteMembersByFilterOptions): Promise<NonNullablePaths<BulkDeleteMembersByFilterResponse, `jobId`, 0>>;
}
...
interface BulkApproveMembersSignature {
     ...
     * @param - Query options. See [API Query Language](https://dev.wix.com/docs/rest/articles/getting-started/api-query-language) for more details.
     */
    (filter: any): Promise<NonNullablePaths<BulkApproveMembersResponse, `jobId`, 0>>;
}
...
interface BulkBlockMembersSignature {
     ...
     * @param - Query options. See [API Query Language](https://dev.wix.com/docs/rest/articles/getting-started/api-query-language) for more details.
     */
    (filter: any): Promise<NonNullablePaths<BulkBlockMembersResponse, `jobId`, 0>>;
}
...
interface CreateMemberSignature {
     ...
     * @returns New member.
     */
    (options?: CreateMemberOptions): Promise<NonNullablePaths<Member, `status` | `contact.phones` | `contact.emails` | `contact.addresses` | `contact.addresses.${number}.streetAddress.number` | `contact.addresses.${number}.streetAddress.name` | `profile.photo._id` | `profile.photo.url` | `profile.photo.height` | `profile.photo.width` | `privacyStatus` | `activityStatus`, 4>>;
}
...
declare function customQueryMembers(httpClient: HttpClient): {
    (query: MemberQuery, options?: QueryMembersOptions): ReturnType<typeof typedQueryMembers>;
    (options?: QueryMembersOptions): MembersQueryBuilder;
};
...
declare const queryMembers: MaybeContext<BuildRESTFunction<typeof customQueryMembers> & typeof customQueryMembers>;
/**
