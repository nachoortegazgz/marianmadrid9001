...
export { ApplicationError, AvailableResources, BookingPolicyViolations, BulkActionMetadata, BulkListAvailabilityTimeSlotsRequest, BulkListAvailabilityTimeSlotsResponse, BulkServiceTimeSlotsResult, CursorPaging, CursorPagingMetadata, Cursors, CustomerChoices, DiagnoseAvailabilityRequest, DiagnoseAvailabilityResponse, DiagnosisReason, EventInfo, GetAvailabilityTimeSlotRequest, GetAvailabilityTimeSlotRequestCustomerChoices, GetAvailabilityTimeSlotResponse, GetEventTimeSlotRequest, GetMultiServiceAvailabilityTimeSlotRequest, GetMultiServiceAvailabilityTimeSlotResponse, ItemMetadata, ListAvailabilityTimeSlotEndOptionsRequest, ListAvailabilityTimeSlotEndOptionsResponse, ListAvailabilityTimeSlotsRequest, ListAvailabilityTimeSlotsResponse, ListEventTimeSlotsRequest, ListMultiServiceAvailabilityTimeSlotsRequest, ListMultiServiceAvailabilityTimeSlotsResponse, Location, LocationType, LocationTypeWithLiterals, NestedTimeSlot, NonBookableReasons, ReasonCode, ReasonCodeWithLiterals, RequestedGender, RequestedGenderValue, RequestedGenderValueRequestedGender, RequestedGenderValueRequestedGenderWithLiterals, RequestedGenderWithLiterals, ResolvedContext, Resource, ResourceType, ScheduleInfo, Service, ServiceTimeSlots, SuggestedAction, SuggestedActionWithLiterals, TimeSlot, V2CustomerChoices, V2RequestedGenderValue, WaitingList } from './index.typings.js';
...
interface ListEventTimeSlotsSignature {
     ...
     */
    (options?: ListEventTimeSlotsOptions): Promise<NonNullablePaths<ListEventTimeSlotsResponse, `timeSlots` | `timeSlots.${number}.location.locationType`, 3>>;
}
