...
var listEventTimeSlots4 = /* @__PURE__ */ createRESTModule(listEventTimeSlots3);
var getEventTimeSlot4 = /* @__PURE__ */ createRESTModule(getEventTimeSlot3);
export {
  LocationType,
  ReasonCode,
  RequestedGender,
  RequestedGenderValueRequestedGender,
  SuggestedAction,
  getEventTimeSlot4 as getEventTimeSlot,
  listEventTimeSlots4 as listEventTimeSlots
};
