...
function listEventTimeSlots2() {
  const payload = {};
  const getRequestOptions = listEventTimeSlots(payload);
...
function getEventTimeSlot2() {
  const payload = { eventId: ":eventId" };
  const getRequestOptions = getEventTimeSlot(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "GET",
    path: "/v2/time-slots/event/{eventId}",
...
export {
  ...
  ReasonCode as ReasonCodeOriginal,
  RequestedGender as RequestedGenderOriginal,
  RequestedGenderValueRequestedGender as RequestedGenderValueRequestedGenderOriginal,
  SuggestedAction as SuggestedActionOriginal,
