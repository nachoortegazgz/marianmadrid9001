...
interface GetExternalDatabaseConnectionSignature {
     ...
     */
    (name: string): Promise<NonNullablePaths<ExternalDatabaseConnection, `name` | `connectionStatus.successful` | `connectionStatus.causeOfFailure` | `connectionStatus.hasCollections` | `capabilities.collectionModificationsSupported` | `capabilities.fieldTypes`, 1>>;
}
...
interface UpdateExternalDatabaseConnectionSignature {
     ...
     */
    (name: string, externalDatabaseConnection: UpdateExternalDatabaseConnection): Promise<NonNullablePaths<ExternalDatabaseConnection, `name` | `connectionStatus.successful` | `connectionStatus.causeOfFailure` | `connectionStatus.hasCollections` | `capabilities.collectionModificationsSupported` | `capabilities.fieldTypes`, 1>>;
}
