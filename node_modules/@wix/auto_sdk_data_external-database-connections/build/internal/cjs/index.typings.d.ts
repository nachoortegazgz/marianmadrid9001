...
interface ExternalDatabaseConnection {
     ...
     * @readonly
     */
    protocolVersion?: ProtocolVersionWithLiterals;
    /**
 ...
 */
declare function getExternalDatabaseConnection(name: string): Promise<NonNullablePaths<ExternalDatabaseConnection, `name` | `connectionStatus.successful` | `connectionStatus.causeOfFailure` | `connectionStatus.hasCollections` | `capabilities.collectionModificationsSupported` | `capabilities.fieldTypes`, 1>>;
/**
