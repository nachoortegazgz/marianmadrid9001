...
export { AccountInfo, AccountInfoMetadata, ActionEvent, BackofficeDownloadBackupRequest, Backup, BackupStateChanged, BaseEventMetadata, CancelBackupRequest, CancelBackupResponse, Collection, CreateBackupRequest, DeleteAllRequest, DeleteBackupRequest, DeleteBackupResponse, DisableInstanceRequest, DomainEvent, DomainEventBodyOneOf, Empty, EnableInstanceRequest, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, FailRestorationRequest, GetBackupMetadataRequest, GetBackupMetadataResponse, HeadersEntry, IdentificationData, IdentificationDataIdOneOf, ListBackupsRequest, ListRestorationsRequest, MessageEnvelope, MigrateNamespaceRequest, MigrateNamespaceResponse, MoveRequest, Paging, PagingMetadataV2, RawHttpResponse, RebuildRequest, RemoveDeletedRequest, Restoration, RestorationStateChanged, RestorationStatus, RestorationStatusWithLiterals, RestoreBackupRequest, RestoreDestination, RestoreInfo, RestorePartialBackupRequest, Status, StatusWithLiterals, TakeBackupRequest, Type, TypeWithLiterals, UpdateBackupMetadataRequest, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.mjs';
...
interface CreateBackupSignature {
     ...
     */
    (): Promise<NonNullablePaths<CreateBackupResponse, `backup._id` | `backup.status` | `backup.type` | `backup.collections` | `backup.collections.${number}._id`, 3>>;
}
...
interface ListBackupsSignature {
     ...
     */
    (options?: ListBackupsOptions): Promise<NonNullablePaths<ListBackupsResponse, `backups` | `backups.${number}._id` | `backups.${number}.status` | `backups.${number}.type`, 2>>;
}
...
interface RestoreBackupSignature {
     ...
     */
    (backupId: string): Promise<NonNullablePaths<RestoreBackupResponse, `restoration._id` | `restoration.backup._id` | `restoration.backup.status` | `restoration.backup.type` | `restoration.backup.collections` | `restoration.backup.collections.${number}._id` | `restoration.status` | `restoration.restorationCollections` | `restoration.restorationCollections.${number}.dataCollectionId` | `restoration.restorationCollections.${number}.restoreDestination.dataCollectionId`, 4>>;
}
...
interface ListRestorationsSignature {
     ...
     */
    (options?: ListRestorationsOptions): Promise<NonNullablePaths<ListRestorationsResponse, `restorations` | `restorations.${number}._id` | `restorations.${number}.backup._id` | `restorations.${number}.backup.status` | `restorations.${number}.backup.type` | `restorations.${number}.status`, 3>>;
}
 ...
 */
declare const onBackupStateChanged: BuildEventDefinition<typeof onBackupStateChanged$1> & typeof onBackupStateChanged$1;
/**
 ...
 */
declare const onBackupRestorationStateChanged: BuildEventDefinition<typeof onBackupRestorationStateChanged$1> & typeof onBackupRestorationStateChanged$1;
