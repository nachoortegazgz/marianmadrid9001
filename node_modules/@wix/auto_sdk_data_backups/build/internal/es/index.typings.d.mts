...
interface BackofficeDownloadBackupRequest {
    /** @format GUID */
    backupId?: string;
}
 ...
 */
declare function createBackup(): Promise<NonNullablePaths<CreateBackupResponse, `backup._id` | `backup.status` | `backup.type` | `backup.collections` | `backup.collections.${number}._id`, 3>>;
/**
 ...
 */
declare function listBackups(options?: ListBackupsOptions): Promise<NonNullablePaths<ListBackupsResponse, `backups` | `backups.${number}._id` | `backups.${number}.status` | `backups.${number}.type`, 2>>;
 ...
 */
declare function listRestorations(options?: ListRestorationsOptions): Promise<NonNullablePaths<ListRestorationsResponse, `restorations` | `restorations.${number}._id` | `restorations.${number}.backup._id` | `restorations.${number}.backup.status` | `restorations.${number}.backup.type` | `restorations.${number}.status`, 3>>;
