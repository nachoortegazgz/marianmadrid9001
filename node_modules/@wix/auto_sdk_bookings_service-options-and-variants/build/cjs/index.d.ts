...
import { ServiceOptionsAndVariants, CreateServiceOptionsAndVariantsApplicationErrors, CloneServiceOptionsAndVariantsResponse, GetServiceOptionsAndVariantsByServiceIdResponse, UpdateServiceOptionsAndVariants, UpdateServiceOptionsAndVariantsApplicationErrors, DeleteServiceOptionsAndVariantsOptions, ServiceOptionsAndVariantsCreatedEnvelope, ServiceOptionsAndVariantsDeletedEnvelope, ServiceOptionsAndVariantsUpdatedEnvelope, ServiceOptionsAndVariantsListQueryBuilder, ServiceOptionsAndVariantsQuery, typedQueryServiceOptionsAndVariants } from './index.typings.js';
export { AccountInfo, AccountInfoMetadata, ActionEvent, Address, AddressHint, BaseEventMetadata, BusinessSchedule, Categories, ChangeContext, ChangeContextPayloadOneOf, CloneServiceOptionsAndVariantsRequest, CommonQueryWithEntityContext, ConsentPolicy, CreateServiceOptionsAndVariantsRequest, CreateServiceOptionsAndVariantsResponse, CursorPaging, Cursors, CustomServiceOption, DailyConfig, DateRangeRule, DateTimeRule, DateTimeRuleRuleOneOf, DateTimeRuleType, DateTimeRuleTypeWithLiterals, Day, DayOfWeek, DayOfWeekWithLiterals, DayWithLiterals, DeleteServiceOptionsAndVariantsRequest, DeleteServiceOptionsAndVariantsResponse, DomainEvent, DomainEventBodyOneOf, Duration, DurationRange, DurationRangeConfigOneOf, DurationServiceOption, DurationUnitType, DurationUnitTypeWithLiterals, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, ExtendedFields, GeoCoordinates, GetServiceOptionsAndVariantsByServiceIdRequest, GetServiceOptionsAndVariantsRequest, GetServiceOptionsAndVariantsResponse, HourlyConfig, HoursAndDaysRule, IdentificationData, IdentificationDataIdOneOf, Locale, MessageEnvelope, Money, MonthsRule, Multilingual, Paging, PagingMetadataV2, ParticipantsRange, PlacementType, PlacementTypeWithLiterals, Properties, PropertiesChange, QueryServiceOptionsAndVariantsRequest, QueryServiceOptionsAndVariantsResponse, QueryV2, QueryV2PagingMethodOneOf, ResolutionMethod, ResolutionMethodWithLiterals, RestoreInfo, ServiceChoice, ServiceChoiceChoiceOneOf, ServiceOption, ServiceOptionOptionSpecificDataOneOf, ServiceOptionType, ServiceOptionTypeWithLiterals, ServiceOptions, ServiceOptionsAndVariantsListQueryResult, ServiceOptionsAndVariantsQuerySpec, ServiceVariant, ServiceVariants, SiteCloned, SiteCreated, SitePropertiesEvent, SitePropertiesNotification, SortOrder, SortOrderWithLiterals, Sorting, SpecialHourPeriod, SupportedLanguage, TimePeriod, Translation, UpdateServiceOptionsAndVariantsRequest, UpdateServiceOptionsAndVariantsResponse, WebhookIdentityType, WebhookIdentityTypeWithLiterals, utils } from './index.typings.js';
...
interface GetServiceOptionsAndVariantsSignature {
     ...
     */
    (serviceOptionsAndVariantsId: string): Promise<NonNullablePaths<ServiceOptionsAndVariants, `options.values` | `options.values.${number}.customData.name` | `options.values.${number}._id` | `options.values.${number}.type` | `variants.values` | `variants.values.${number}.price.value` | `variants.values.${number}.price.currency`, 4>>;
}
...
interface UpdateServiceOptionsAndVariantsSignature {
     ...
     */
    (_id: string, serviceOptionsAndVariants: NonNullablePaths<UpdateServiceOptionsAndVariants, `revision`, 0>): Promise<NonNullablePaths<ServiceOptionsAndVariants, `options.values` | `options.values.${number}.customData.name` | `options.values.${number}._id` | `options.values.${number}.type` | `variants.values` | `variants.values.${number}.price.value` | `variants.values.${number}.price.currency`, 4> & {
...
declare function customQueryServiceOptionsAndVariants(httpClient: HttpClient): {
    ...
    (query: ServiceOptionsAndVariantsQuery): ReturnType<typeof typedQueryServiceOptionsAndVariants>;
};
...
export { CloneServiceOptionsAndVariantsResponse, CreateServiceOptionsAndVariantsApplicationErrors, DeleteServiceOptionsAndVariantsOptions, GetServiceOptionsAndVariantsByServiceIdResponse, ServiceOptionsAndVariants, ServiceOptionsAndVariantsCreatedEnvelope, ServiceOptionsAndVariantsDeletedEnvelope, ServiceOptionsAndVariantsListQueryBuilder, ServiceOptionsAndVariantsQuery, ServiceOptionsAndVariantsUpdatedEnvelope, UpdateServiceOptionsAndVariants, UpdateServiceOptionsAndVariantsApplicationErrors, cloneServiceOptionsAndVariants, createServiceOptionsAndVariants, deleteServiceOptionsAndVariants, getServiceOptionsAndVariants, getServiceOptionsAndVariantsByServiceId, onServiceOptionsAndVariantsCreated, onServiceOptionsAndVariantsDeleted, onServiceOptionsAndVariantsUpdated, queryServiceOptionsAndVariants, updateServiceOptionsAndVariants };
