...
interface ListCategoriesSignature {
     ...
     * @deprecated
     */
    (options?: ListCategoriesOptions): Promise<NonNullablePaths<ListCategoryResponse, `categories` | `categories.${number}.status`, 2>>;
}
...
interface CreateCategorySignature {
     ...
     * @deprecated
     */
    (category: NonNullablePaths<Category, `name`, 0>): Promise<NonNullablePaths<Category, `status`, 0>>;
}
...
interface UpdateCategorySignature {
     ...
     * @deprecated
     */
    (_id: string, category: NonNullablePaths<UpdateCategory, `name`, 0>): Promise<NonNullablePaths<UpdateCategoryResponse, `category.status`, 1> & {
...
/** @deprecated */
declare const onCategoryNotification: BuildEventDefinition<typeof onCategoryNotification$1> & typeof onCategoryNotification$1;
