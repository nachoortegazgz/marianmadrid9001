 ...
 * @deprecated
 */
declare function listCategories(options?: ListCategoriesOptions): Promise<NonNullablePaths<ListCategoryResponse, `categories` | `categories.${number}.status`, 2>>;
 ...
 * @deprecated
 */
declare function createCategory(category: NonNullablePaths<Category, `name`, 0>): Promise<NonNullablePaths<Category, `status`, 0>>;
/**
 * Updates a category.
 *
 *
 ...
 * @deprecated
 */
declare function updateCategory(_id: string, category: NonNullablePaths<UpdateCategory, `name`, 0>): Promise<NonNullablePaths<UpdateCategoryResponse, `category.status`, 1> & {
