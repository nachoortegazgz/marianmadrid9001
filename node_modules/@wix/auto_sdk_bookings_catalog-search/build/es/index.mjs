...
// src/bookings-catalog-search-v1-catalog-search-catalog-search.http.ts
import { transformRESTFloatToSDKFloat } from "@wix/sdk-runtime/transformations/float";
import { transformRESTTimestampToSDKTimestamp } from "@wix/sdk-runtime/transformations/timestamp";
import { transformPaths } from "@wix/sdk-runtime/transformations/transform-paths";
import { resolveUrl } from "@wix/sdk-runtime/rest-modules";
function resolveWixBookingsCatalogSearchV1CatalogSearchUrl(opts) {
...
var queryServicesByFilters4 = /* @__PURE__ */ createRESTModule(queryServicesByFilters3);
export {
  AddOnPaymentOptions,
  CompletionRequirement,
  FirstChargeDateType,
  ...
  Timing,
  UnitType,
  queryServicesByFilters4 as queryServicesByFilters
};
