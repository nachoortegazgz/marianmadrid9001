 ...
 */
declare function queryServicesByFilters(options?: QueryServicesByFiltersOptions): Promise<NonNullablePaths<QueryServicesByFiltersResponse, `results` | `results.${number}.service.type` | `results.${number}.service.category._id` | `results.${number}.service.form._id` | `results.${number}.service.payment.rateType` | `results.${number}.service.payment.addOnOption` | `results.${number}.service.bookingPolicy._id` | `results.${number}.service.taxableAddress.taxableAddressType` | `results.${number}.available`, 4>>;
