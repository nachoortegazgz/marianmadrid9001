...
interface Connection {
     ...
     * @deprecated
     */
    syncToErrorReason?: SyncToErrorReasonWithLiterals;
}
declare enum Status {
...
interface ConnectionSyncConfigSyncToCalendar extends ConnectionSyncConfigSyncToCalendarSyncToOneOf {
    ...
    /**
     * Whether buffer time is exported to the external calendar as its own event alongside
     * the appointment. Opt-in: default is false.
     * @internal
     */
    includeBufferTime?: boolean | null;
}
/** @oneof */
