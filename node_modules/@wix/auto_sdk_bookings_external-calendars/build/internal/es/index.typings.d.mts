 ...
 */
declare function listProviders(): Promise<NonNullablePaths<ListProvidersResponse, `providers` | `providers.${number}.calendarType` | `providers.${number}.features.listEventFromCalendars` | `providers.${number}.features.syncToCalendar`, 3>>;
/**
 ...
 */
declare function getConnection(connectionId: string): Promise<NonNullablePaths<GetConnectionResponse, `connection.calendarType` | `connection.status` | `connection.errorReason` | `connection.syncConfig.listEventFromCalendars.calendars.calendars`, 4>>;
/**
 ...
 */
declare function listConnections(options?: ListConnectionsOptions): Promise<NonNullablePaths<ListConnectionsResponse, `connections` | `connections.${number}.calendarType` | `connections.${number}.status` | `connections.${number}.errorReason` | `failedProviderIds`, 2>>;
 ...
 */
declare function connectByOAuth(providerId: string, scheduleId: string, redirectUrl: string): Promise<ConnectByOAuthResponse & {
 ...
 */
declare function connectByCredentials(providerId: string, scheduleId: string, email: string, password: string): Promise<NonNullablePaths<ConnectByCredentialsResponse, `connection.calendarType` | `connection.status` | `connection.errorReason` | `connection.syncConfig.listEventFromCalendars.calendars.calendars`, 4> & {
 ...
 */
declare function listCalendars(connectionId: string): Promise<NonNullablePaths<ListCalendarsResponse, `calendars`, 0> & {
 ...
 */
declare function updateSyncConfig(connectionId: string, syncConfig: ConnectionSyncConfig): Promise<NonNullablePaths<UpdateSyncConfigResponse, `connection.calendarType` | `connection.status` | `connection.errorReason` | `connection.syncConfig.listEventFromCalendars.calendars.calendars`, 4> & {
 ...
 */
declare function disconnect(connectionId: string): Promise<NonNullablePaths<DisconnectResponse, `connection.calendarType` | `connection.status` | `connection.errorReason` | `connection.syncConfig.listEventFromCalendars.calendars.calendars`, 4> & {
 ...
 */
declare function listEvents(options?: ListEventsOptions): Promise<NonNullablePaths<ListEventsResponse, `events` | `events.${number}.calendarType` | `failedProviderIds`, 2>>;
