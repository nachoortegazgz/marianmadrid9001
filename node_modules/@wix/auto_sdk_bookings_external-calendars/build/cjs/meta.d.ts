...
declare enum ConnectMethod {
     ...
     */
    UNDEFINED = "UNDEFINED",
    /** You can connect the external calendar to the Wix site by calling [Connect By O Auth](https://dev.wix.com/docs/rest/business-solutions/bookings/calendar/external-calendar-v2/connect-by-o-auth). */
    OAUTH = "OAUTH",
    /** You can connect the external calendar to the Wix site by calling [Connect By Credentials](https://dev.wix.com/docs/rest/business-solutions/bookings/calendar/external-calendar-v2/connect-by-credentials). */
...
declare enum SyncToCalendar {
    /**
     * There is no information about which Wix calendar [events](https://dev.wix.com/docs/rest/business-management/calendar/events-v3/introduction)
     * you can export to the external calendar.
     */
    UNDEFINED = "UNDEFINED",
    /**
     * You can't export any Wix calendar [events](https://dev.wix.com/docs/rest/business-management/calendar/events-v3/introduction)
     * to the external calendar.
     */
    NOT_SUPPORTED = "NOT_SUPPORTED",
    /**
     * You can export Wix calendar [events](https://dev.wix.com/docs/rest/business-management/calendar/events-v3/introduction)
...
declare enum Status {
    ...
    UNDEFINED = "UNDEFINED",
    /**
     * The external calendar is connected to the Wix [schedule](https://dev.wix.com/docs/rest/business-management/calendar/schedules-v3/introduction),
    ...
    SYNCED = "SYNCED",
    /** The external calender has been disconnected from the Wix [schedule](https://dev.wix.com/docs/rest/business-management/calendar/schedules-v3/introduction). */
...
declare enum SyncToErrorReason {
    /** No sync error. */
    UNDEFINED = "UNDEFINED",
...
/** @enumType */
type SyncToErrorReasonWithLiterals = SyncToErrorReason | 'UNDEFINED' | 'CALENDAR_CREATION_FAILURE' | 'CALENDAR_DELETED';
...
/** @enumType */
type SessionStatusWithLiterals = SessionStatus | 'UNDEFINED' | 'CONFIRMED' | 'CANCELLED';
...
/** @docsIgnore */
type ConnectByCredentialsApplicationErrors = {
...
/** @docsIgnore */
type ListCalendarsApplicationErrors = {
...
/** @docsIgnore */
type DisconnectApplicationErrors = {
...
export { type AddressLocation as AddressLocationOriginal, type Address as AddressOriginal, type AddressStreetOneOf as AddressStreetOneOfOriginal, ApprovalStatus as ApprovalStatusOriginal, type ApprovalStatusWithLiterals as ApprovalStatusWithLiteralsOriginal, type AvailabilityConstraints as AvailabilityConstraintsOriginal, type Availability as AvailabilityOriginal, type AvailabilityPolicy as AvailabilityPolicyOriginal, type AvailabilityPolicyUpdated as AvailabilityPolicyUpdatedOriginal, type BusinessSchedule as BusinessScheduleOriginal, type CalendarConference as CalendarConferenceOriginal, type CalendarDateTime as CalendarDateTimeOriginal, type Calendar as CalendarOriginal, CalendarType as CalendarTypeOriginal, type CalendarTypeWithLiterals as CalendarTypeWithLiteralsOriginal, type Calendars as CalendarsOriginal, type ConferenceProvider as ConferenceProviderOriginal, ConferenceType as ConferenceTypeOriginal, type ConferenceTypeWithLiterals as ConferenceTypeWithLiteralsOriginal, type ConnectByCredentialsApplicationErrors as ConnectByCredentialsApplicationErrorsOriginal, type ConnectByCredentialsRequest as ConnectByCredentialsRequestOriginal, type ConnectByCredentialsResponse as ConnectByCredentialsResponseOriginal, type ConnectByOAuthApplicationErrors as ConnectByOAuthApplicationErrorsOriginal, type ConnectByOAuthRequest as ConnectByOAuthRequestOriginal, type ConnectByOAuthResponse as ConnectByOAuthResponseOriginal, ConnectMethod as ConnectMethodOriginal, type ConnectMethodWithLiterals as ConnectMethodWithLiteralsOriginal, type Connection as ConnectionOriginal, type ConnectionSyncConfigListEventFromCalendarsListFromOneOf as ConnectionSyncConfigListEventFromCalendarsListFromOneOfOriginal, type ConnectionSyncConfigListEventFromCalendars as ConnectionSyncConfigListEventFromCalendarsOriginal, type ConnectionSyncConfig as ConnectionSyncConfigOriginal, type ConnectionSyncConfigSyncToCalendar as ConnectionSyncConfigSyncToCalendarOriginal, type ConnectionSyncConfigSyncToCalendarSyncToOneOf as ConnectionSyncConfigSyncToCalendarSyncToOneOfOriginal, type CursorPagingMetadata as CursorPagingMetadataOriginal, type CursorPaging as CursorPagingOriginal, type Cursors as CursorsOriginal, DayOfWeek as DayOfWeekOriginal, type DayOfWeekWithLiterals as DayOfWeekWithLiteralsOriginal, Day as DayOriginal, type DayWithLiterals as DayWithLiteralsOriginal, type DedicatedCalendar as DedicatedCalendarOriginal, type DisconnectApplicationErrors as DisconnectApplicationErrorsOriginal, type DisconnectRequest as DisconnectRequestOriginal, type DisconnectResponse as DisconnectResponseOriginal, type Empty as EmptyOriginal, ErrorReason as ErrorReasonOriginal, type ErrorReasonWithLiterals as ErrorReasonWithLiteralsOriginal, type Event as EventOriginal, type ExtendedFields as ExtendedFieldsOriginal, type ExternalCalendarInfo as ExternalCalendarInfoOriginal, type ExternalCalendar as ExternalCalendarOriginal, type ExternalCalendarOverrides as ExternalCalendarOverridesOriginal, type Frequency as FrequencyOriginal, type GetConnectionRequest as GetConnectionRequestOriginal, type GetConnectionResponse as GetConnectionResponseOriginal, type HeadersEntry as HeadersEntryOriginal, type Interval as IntervalOriginal, type IntervalSplit as IntervalSplitOriginal, type LinkedSchedule as LinkedScheduleOriginal, type ListCalendarsApplicationErrors as ListCalendarsApplicationErrorsOriginal, type ListCalendarsRequest as ListCalendarsRequestOriginal, type ListCalendarsResponse as ListCalendarsResponseOriginal, type ListConnectionsRequest as ListConnectionsRequestOriginal, type ListConnectionsResponse as ListConnectionsResponseOriginal, ListEventFromCalendars as ListEventFromCalendarsOriginal, type ListEventFromCalendarsWithLiterals as ListEventFromCalendarsWithLiteralsOriginal, type ListEventsRequest as ListEventsRequestOriginal, type ListEventsResponse as ListEventsResponseOriginal, type ListProvidersRequest as ListProvidersRequestOriginal, type ListProvidersResponse as ListProvidersResponseOriginal, type LocalDateTime as LocalDateTimeOriginal, type Location as LocationOriginal, LocationStatus as LocationStatusOriginal, type LocationStatusWithLiterals as LocationStatusWithLiteralsOriginal, LocationType as LocationTypeOriginal, type LocationTypeWithLiterals as LocationTypeWithLiteralsOriginal, type LocationsAddressLocation as LocationsAddressLocationOriginal, type LocationsAddress as LocationsAddressOriginal, type LocationsLocation as LocationsLocationOriginal, LocationsLocationType as LocationsLocationTypeOriginal, type LocationsLocationTypeWithLiterals as LocationsLocationTypeWithLiteralsOriginal, type LocationsStreetAddress as LocationsStreetAddressOriginal, type MigrationData as MigrationDataOriginal, type MigrationEvent as MigrationEventOriginal, type MultipleSessionsCreated as MultipleSessionsCreatedOriginal, type ParticipantNotification as ParticipantNotificationOriginal, type Participant as ParticipantOriginal, type PathParametersEntry as PathParametersEntryOriginal, type Price as PriceOriginal, type PrimaryCalendar as PrimaryCalendarOriginal, type ProviderFeatures as ProviderFeaturesOriginal, type Provider as ProviderOriginal, type QueryParametersEntry as QueryParametersEntryOriginal, type Rate as RateOriginal, type RawHttpRequest as RawHttpRequestOriginal, type RawHttpResponse as RawHttpResponseOriginal, type RecurringInterval as RecurringIntervalOriginal, RecurringIntervalType as RecurringIntervalTypeOriginal, type RecurringIntervalTypeWithLiterals as RecurringIntervalTypeWithLiteralsOriginal, type RecurringSessionSplit as RecurringSessionSplitOriginal, type RecurringSessionsUpdated as RecurringSessionsUpdatedOriginal, type ScheduleCancelled as ScheduleCancelledOriginal, type ScheduleCreated as ScheduleCreatedOriginal, type ScheduleNotificationEventOneOf as ScheduleNotificationEventOneOfOriginal, type ScheduleNotification as ScheduleNotificationOriginal, type Schedule as ScheduleOriginal, ScheduleStatus as ScheduleStatusOriginal, type ScheduleStatusWithLiterals as ScheduleStatusWithLiteralsOriginal, type ScheduleUnassignedFromUser as ScheduleUnassignedFromUserOriginal, type ScheduleUpdated as ScheduleUpdatedOriginal, type ScheduleWithSessions as ScheduleWithSessionsOriginal, type SessionCancelled as SessionCancelledOriginal, type SessionCreated as SessionCreatedOriginal, type Session as SessionOriginal, SessionStatus as SessionStatusOriginal, type SessionStatusWithLiterals as SessionStatusWithLiteralsOriginal, SessionType as SessionTypeOriginal, type SessionTypeWithLiterals as SessionTypeWithLiteralsOriginal, type SessionUpdated as SessionUpdatedOriginal, type SessionVersion as SessionVersionOriginal, type SitePropertiesOnScheduleCreation as SitePropertiesOnScheduleCreationOriginal, type SpecialHourPeriod as SpecialHourPeriodOriginal, type SplitInterval as SplitIntervalOriginal, type StaffData as StaffDataOriginal, Status as StatusOriginal, type StatusWithLiterals as StatusWithLiteralsOriginal, type StreetAddress as StreetAddressOriginal, type Subdivision as SubdivisionOriginal, SyncToCalendar as SyncToCalendarOriginal, type SyncToCalendarWithLiterals as SyncToCalendarWithLiteralsOriginal, SyncToErrorReason as SyncToErrorReasonOriginal, type SyncToErrorReasonWithLiterals as SyncToErrorReasonWithLiteralsOriginal, type TimePeriod as TimePeriodOriginal, Transparency as TransparencyOriginal, type TransparencyWithLiterals as TransparencyWithLiteralsOriginal, type UpdateSyncConfigApplicationErrors as UpdateSyncConfigApplicationErrorsOriginal, type UpdateSyncConfigRequest as UpdateSyncConfigRequestOriginal, type UpdateSyncConfigResponse as UpdateSyncConfigResponseOriginal, type Version as VersionOriginal, type __PublicMethodMetaInfo, connectByCredentials, connectByOAuth, disconnect, getConnection, listCalendars, listConnections, listEvents, listProviders, updateSyncConfig };
