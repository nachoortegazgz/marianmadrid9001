...
__export(index_exports, {
  ...
  connectByCredentials: () => connectByCredentials4,
  connectByOAuth: () => connectByOAuth4,
  disconnect: () => disconnect4,
  getConnection: () => getConnection4,
  listCalendars: () => listCalendars4,
  listConnections: () => listConnections4,
  listEvents: () => listEvents4,
  listProviders: () => listProviders4,
  updateSyncConfig: () => updateSyncConfig4
});
...
// src/bookings-calendar-v2-external-calendar-external-calendars.public.ts
function listProviders3(httpClient) {
  return () => listProviders2(
    // @ts-ignore
    { httpClient }
  );
}
function getConnection3(httpClient) {
  return (connectionId) => getConnection2(
    connectionId,
    // @ts-ignore
    { httpClient }
  );
}
function listConnections3(httpClient) {
  return (options) => listConnections2(
    options,
    // @ts-ignore
    { httpClient }
  );
}
function connectByOAuth3(httpClient) {
  return (providerId, scheduleId, redirectUrl) => connectByOAuth2(
    providerId,
    scheduleId,
    redirectUrl,
    // @ts-ignore
...
function connectByCredentials3(httpClient) {
  return (providerId, scheduleId, email, password) => connectByCredentials2(
    providerId,
    scheduleId,
    email,
    password,
...
function listCalendars3(httpClient) {
  return (connectionId) => listCalendars2(
    connectionId,
    // @ts-ignore
    { httpClient }
  );
}
function updateSyncConfig3(httpClient) {
  return (connectionId, syncConfig) => updateSyncConfig2(
    connectionId,
    syncConfig,
    // @ts-ignore
    { httpClient }
...
function disconnect3(httpClient) {
  return (connectionId) => disconnect2(
    connectionId,
    // @ts-ignore
    { httpClient }
  );
...
// src/bookings-calendar-v2-external-calendar-external-calendars.context.ts
var import_rest_modules3 = require("@wix/sdk-runtime/rest-modules");
var listProviders4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(listProviders3);
var getConnection4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getConnection3);
var listConnections4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(listConnections3);
var connectByOAuth4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(connectByOAuth3);
var connectByCredentials4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(connectByCredentials3);
var listCalendars4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(listCalendars3);
var updateSyncConfig4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(updateSyncConfig3);
var disconnect4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(disconnect3);
