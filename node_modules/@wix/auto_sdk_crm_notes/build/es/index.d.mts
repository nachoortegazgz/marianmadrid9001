...
import { Note, UpdateNote, NoteCreatedEnvelope, NoteDeletedEnvelope, NoteUpdatedEnvelope, NoteQuery, QueryNotesOptions, typedQueryNotes, NotesQueryBuilder } from './index.typings.mjs';
...
interface CreateNoteSignature {
     ...
     */
    (note: NonNullablePaths<Note, `contactId`, 0>): Promise<NonNullablePaths<Note, `type` | `source.sourceType`, 1>>;
}
...
interface GetNoteSignature {
     ...
     */
    (noteId: string): Promise<NonNullablePaths<Note, `type` | `source.sourceType`, 1>>;
}
...
interface UpdateNoteSignature {
     ...
     */
    (_id: string, note: NonNullablePaths<UpdateNote, `revision`, 0>): Promise<NonNullablePaths<Note, `type` | `source.sourceType`, 1>>;
}
...
declare function customQueryNotes(httpClient: HttpClient): {
    (query: NoteQuery, options?: QueryNotesOptions): ReturnType<typeof typedQueryNotes>;
 ...
 */
declare const onNoteCreated: BuildEventDefinition<typeof onNoteCreated$1> & typeof onNoteCreated$1;
/**
 * Triggered when a note is deleted.
 */
declare const onNoteDeleted: BuildEventDefinition<typeof onNoteDeleted$1> & typeof onNoteDeleted$1;
/**
...
export { Note, NoteCreatedEnvelope, NoteDeletedEnvelope, NoteQuery, NoteUpdatedEnvelope, NotesQueryBuilder, QueryNotesOptions, UpdateNote, createNote, deleteNote, getNote, onNoteCreated, onNoteDeleted, onNoteUpdated, queryNotes, updateNote };
