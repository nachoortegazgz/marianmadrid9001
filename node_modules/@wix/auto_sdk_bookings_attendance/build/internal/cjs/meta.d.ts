...
interface BulkSetAttendanceRequest {
    /**
     * List of `attendance` objects to create or update.
     * *Deprecated**. Use `attendanceDetails` instead.
     * @internal
     * @maxSize 8
     * @deprecated List of `attendance` objects to create or update.
     * *Deprecated**. Use `attendanceDetails` instead.
...
declare function deleteAttendance(): __PublicMethodMetaInfo<'DELETE', {
    attendanceId: string;
}, DeleteAttendanceRequest$1, DeleteAttendanceRequest, DeleteAttendanceResponse$1, DeleteAttendanceResponse>;
declare function bulkDeleteAttendances(): __PublicMethodMetaInfo<'POST', {}, BulkDeleteAttendancesRequest$1, BulkDeleteAttendancesRequest, BulkDeleteAttendancesResponse$1, BulkDeleteAttendancesResponse>;
