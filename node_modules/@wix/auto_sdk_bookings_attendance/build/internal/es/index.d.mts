...
interface GetAttendanceSignature {
     ...
     */
    (attendanceId: string): Promise<NonNullablePaths<Attendance, `status` | `numberOfAttendees`, 0> & {
...
interface SetAttendanceSignature {
     ...
     */
    (attendance: NonNullablePaths<Attendance, `bookingId` | `status`, 0>, options?: SetAttendanceOptions): Promise<NonNullablePaths<SetAttendanceResponse, `attendance.status` | `attendance.numberOfAttendees`, 1> & {
...
interface CountAttendancesSignature {
     ...
     */
    (options?: CountAttendancesOptions): Promise<NonNullablePaths<CountAttendancesResponse, `count`, 0>>;
}
...
declare function bulkDeleteAttendances$1(httpClient: HttpClient): BulkDeleteAttendancesSignature;
...
declare function customQueryAttendance(httpClient: HttpClient): {
    ...
    (query: AttendanceQuery): ReturnType<typeof typedQueryAttendance>;
};
