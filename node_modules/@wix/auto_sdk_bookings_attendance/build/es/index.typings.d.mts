...
interface BulkDeleteAttendancesRequest {
    /**
...
interface BulkDeleteAttendancesResponse {
    /**
...
interface BulkDeleteAttendancesResult {
...
/** @docsIgnore */
type GetAttendanceApplicationErrors = {
    code?: 'ATTENDANCE_NOT_FOUND';
    description?: string;
    data?: Record<string, any>;
};
/** @docsIgnore */
type SetAttendanceApplicationErrors = {
    code?: 'SESSION_ID_NOT_PROVIDED';
    description?: string;
    data?: Record<string, any>;
};
/** @docsIgnore */
type BulkSetAttendanceApplicationErrors = {
    code?: 'ATTENDANCES_MISSING_IN_REQUEST';
    description?: string;
    data?: Record<string, any>;
};
/** @docsIgnore */
type DeleteAttendanceApplicationErrors = {
    code?: 'ATTENDANCE_NOT_FOUND';
    description?: string;
    data?: Record<string, any>;
};
...
interface AttendanceDeletedEnvelope {
 ...
 */
declare function onAttendanceDeleted(handler: (event: AttendanceDeletedEnvelope) => void | Promise<void>): void;
/**
 ...
 */
declare function getAttendance(attendanceId: string): Promise<NonNullablePaths<Attendance, `status` | `numberOfAttendees`, 0> & {
 ...
 */
declare function setAttendance(attendance: NonNullablePaths<Attendance, `bookingId` | `status`, 0>, options?: SetAttendanceOptions): Promise<NonNullablePaths<SetAttendanceResponse, `attendance.status` | `attendance.numberOfAttendees`, 1> & {
 ...
 */
declare function queryAttendance(): AttendancesQueryBuilder;
...
interface AttendancesQueryBuilder {
     ...
     */
    eq: (propertyName: '_id' | 'bookingId' | 'sessionId' | 'status' | 'numberOfAttendees' | 'eventId', value: any) => AttendancesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ne: (propertyName: '_id' | 'bookingId' | 'sessionId' | 'status' | 'numberOfAttendees' | 'eventId', value: any) => AttendancesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    ...
    in: (propertyName: '_id' | 'bookingId' | 'sessionId' | 'status' | 'numberOfAttendees' | 'eventId', value: any) => AttendancesQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments. */
    ascending: (...propertyNames: Array<'_id' | 'bookingId' | 'sessionId' | 'status' | 'numberOfAttendees' | 'eventId'>) => AttendancesQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments. */
 ...
 */
declare function typedQueryAttendance(query: AttendanceQuery): Promise<NonNullablePaths<QueryAttendanceResponse, `attendances` | `attendances.${number}.status` | `attendances.${number}.numberOfAttendees`, 2>>;
interface AttendanceQuerySpec extends QuerySpec {
    paging: 'cursor';
    wql: [
        {
...
type CommonQueryWithEntityContext = Query<Attendance, AttendanceQuerySpec>;
...
declare const utils: {
    query: _wix_sdk_types.QueryHelpers<Attendance, AttendanceQuerySpec, AttendanceQuery>;
};
/**
 ...
 */
declare function countAttendances(options?: CountAttendancesOptions): Promise<NonNullablePaths<CountAttendancesResponse, `count`, 0>>;
 ...
 */
declare function deleteAttendance(attendanceId: string): Promise<void & {
