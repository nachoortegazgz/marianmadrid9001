...
/** @enumType */
type TypeWithLiterals = Type | 'UNKNOWN' | 'ROLE' | 'BADGE' | 'PRICING_PLAN' | 'MEMBER';
...
/** @enumType */
type ExclusionTypeWithLiterals = ExclusionType | 'UNKNOWN' | 'ROLE' | 'BADGE' | 'PRICING_PLAN' | 'MEMBER';
...
/** @enumType */
type FieldTypeTypeWithLiterals = FieldTypeType | 'UNKNOWN' | 'TEXT' | 'NUMBER' | 'DATE' | 'URL' | 'SOCIAL';
...
declare enum AppliesToEnumAppliesTo {
...
/** @enumType */
type AppliesToEnumAppliesToWithLiterals = AppliesToEnumAppliesTo | 'ALL_MEMBERS' | 'SELECTED_MEMBERS';
