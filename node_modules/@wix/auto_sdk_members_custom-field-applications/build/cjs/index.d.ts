...
import { CustomFieldApplication, UpdateCustomFieldApplication, GetCustomFieldApplicationResponse, GetCustomFieldApplicationsResponse, GetMembersCustomFieldApplicationsResponse, GetRolesCustomFieldApplicationsResponse } from './index.typings.js';
export { AccountInfo, ActionEvent, ApplicationsWrapper, AppliesTo, AppliesToEnumAppliesTo, AppliesToEnumAppliesToWithLiterals, CreateCustomFieldApplicationRequest, CreateCustomFieldApplicationResponse, CustomField, DeleteCustomFieldApplicationRequest, DeleteCustomFieldApplicationResponse, DomainEvent, DomainEventBodyOneOf, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, Exclusion, ExclusionType, ExclusionTypeWithLiterals, ExclusionsWrapper, FieldApplication, FieldTypeType, FieldTypeTypeWithLiterals, GetCustomFieldApplicationRequest, GetCustomFieldApplicationsRequest, GetMembersCustomFieldApplicationsRequest, GetRolesCustomFieldApplicationsRequest, IdentificationData, IdentificationDataIdOneOf, MemberCustomFieldApplication, MessageEnvelope, Origin, OriginWithLiterals, Privacy, PrivacyWithLiterals, RestoreInfo, RoleCustomFieldApplication, Section, SectionWithLiterals, SocialTypeType, SocialTypeTypeWithLiterals, Type, TypeWithLiterals, UpdateCustomFieldApplicationRequest, UpdateCustomFieldApplicationResponse, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.js';
...
interface CreateCustomFieldApplicationSignature {
     ...
     */
    (application: NonNullablePaths<CustomFieldApplication, `applications.items.${number}.entityId` | `customFieldId` | `exclusions.items.${number}.entityId`, 3>): Promise<NonNullablePaths<CustomFieldApplication, `applications.items` | `applications.items.${number}.applicationType` | `exclusions.items` | `exclusions.items.${number}.exclusionType`, 3>>;
}
...
interface UpdateCustomFieldApplicationSignature {
     ...
     */
    (customFieldId: string, application: NonNullablePaths<UpdateCustomFieldApplication, `applications.items.${number}.entityId` | `exclusions.items.${number}.entityId` | `revision`, 3>): Promise<NonNullablePaths<CustomFieldApplication, `applications.items` | `applications.items.${number}.applicationType` | `exclusions.items` | `exclusions.items.${number}.exclusionType`, 3>>;
}
...
interface GetCustomFieldApplicationSignature {
     ...
     */
    (customFieldId: string): Promise<NonNullablePaths<GetCustomFieldApplicationResponse, `application.applications.items` | `application.applications.items.${number}.applicationType` | `application.exclusions.items` | `application.exclusions.items.${number}.exclusionType`, 4>>;
}
...
interface GetCustomFieldApplicationsSignature {
     ...
     */
    (customFieldIds: string[]): Promise<NonNullablePaths<GetCustomFieldApplicationsResponse, `applications`, 0>>;
}
...
interface GetMembersCustomFieldApplicationsSignature {
     ...
     */
    (memberIds: string[]): Promise<NonNullablePaths<GetMembersCustomFieldApplicationsResponse, `results`, 0>>;
}
...
interface GetRolesCustomFieldApplicationsSignature {
     ...
     */
    (roleIds: string[]): Promise<NonNullablePaths<GetRolesCustomFieldApplicationsResponse, `results`, 0>>;
}
