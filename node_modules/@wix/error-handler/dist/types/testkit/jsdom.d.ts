export declare const ErrorToastContentTestkit: (testkitArgs: import("@wix/wix-ui-test-utils/vanilla").TestkitArgs) => {
    requestInfoSectionExists: () => Promise<boolean>;
    getPopover: () => {
        click: () => Promise<void>;
    ...
    getInfoDescriptionText: () => Promise<string>;
