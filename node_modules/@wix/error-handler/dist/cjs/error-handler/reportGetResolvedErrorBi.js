...
exports.reportGetResolvedErrorBi = reportGetResolvedErrorBi;
var _v = require("@wix/error-handler-core/@wix/bi-logger-os-data/v2");
var _withoutDefaults = require("../util/withoutDefaults");
function reportGetResolvedErrorBi(errorHandler, params) {
  ...
  biLogger.report((0, _withoutDefaults.withoutDefaults)(_v.getResolvedErrorSrc176Evid101)({
