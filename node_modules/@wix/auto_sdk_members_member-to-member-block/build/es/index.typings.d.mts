 ...
 */
declare function blockMember(memberId: string): Promise<void & {
 ...
 */
declare function unblockMember(memberId: string): Promise<void & {
    __applicationErrorsType?: UnblockMemberApplicationErrors;
}>;
/**
 ...
 */
declare function listCurrentMemberBlocking(options?: ListCurrentMemberBlockingOptions): Promise<NonNullablePaths<ListCurrentMemberBlockingResponse, `blockedMemberIds`, 0>>;
 ...
 */
declare function listMemberBlocks(memberId: string, options?: ListMemberBlocksOptions): Promise<NonNullablePaths<ListMemberBlocksResponse, `memberBlocks` | `memberBlocks.${number}.memberId` | `memberBlocks.${number}.blockDirection`, 2>>;
interface ListMemberBlocksOptions {
    /** Pagination parameters. */
    cursorPaging?: CursorPaging;
}

export { type AccountInfo, type ActionEvent, type AdminBlockingForbiddenError, BlockDirection, type BlockDirectionWithLiterals, type BlockDoesNotExistError, type BlockMemberApplicationErrors, type BlockMemberRequest, type BlockMemberResponse, type CursorPaging, type Cursors, type DomainEvent, type DomainEventBodyOneOf, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type IdentificationData, type IdentificationDataIdOneOf, type ListCurrentMemberBlockingOptions, type ListCurrentMemberBlockingRequest, type ListCurrentMemberBlockingResponse, type ListMemberBlocksOptions, type ListMemberBlocksRequest, type ListMemberBlocksResponse, type MemberAlreadyBlockedError, type MemberBlock, type MemberBlockedByMember, type MemberToMemberBlock, type MemberUnblockedByMember, type MessageEnvelope, type PagingMetadataV2, type RestoreInfo, type SelfBlockingForbiddenError, type SelfUnblockingForbiddenError, type UnblockMemberApplicationErrors, type UnblockMemberRequest, type UnblockMemberResponse, WebhookIdentityType, type WebhookIdentityTypeWithLiterals, blockMember, listCurrentMemberBlocking, listMemberBlocks, unblockMember };
