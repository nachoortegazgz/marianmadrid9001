import { GetSiteContributorsV2Request as GetSiteContributorsV2Request$1, GetSiteContributorsV2Response as GetSiteContributorsV2Response$1, GetCurrentContributorRequest as GetCurrentContributorRequest$1, GetCurrentContributorResponse as GetCurrentContributorResponse$1, ChangeContributorRoleRequest as ChangeContributorRoleRequest$1, ChangeContributorRoleResponse as ChangeContributorRoleResponse$1, ChangeContributorLocationRequest as ChangeContributorLocationRequest$1, ChangeContributorLocationResponse as ChangeContributorLocationResponse$1, QuerySiteContributorsRequest as QuerySiteContributorsRequest$1, QuerySiteContributorsResponse as QuerySiteContributorsResponse$1, GetContributorsQuotaRequest as GetContributorsQuotaRequest$1, GetContributorsQuotaResponse as GetContributorsQuotaResponse$1, RemoveContributorRequest as RemoveContributorRequest$1, RemoveContributorResponse as RemoveContributorResponse$1 } from './index.typings.mjs';
...
interface Contributor {
     ...
     */
    accountGroup?: AccountGroupWithLiterals;
}
...
/** @enumType */
type AccountGroupWithLiterals = AccountGroup | 'ENTERPRISE' | 'CHANNELS';
...
interface GetSiteContributorsV2Request {
    ...
    fields?: string[];
    /**
     * Optional: Host platform. Enrichment always uses v1 and all v2 predefined roles; when provided, host-specific v2 entries override matching policy ids.
     * Valid values: "channels", "enterprise", "studio", "dev-center", "bm-vibe", "bm-headless", "bm-studio", "bm-classic", "bm-wixel", "bm-studio2"
     * @maxLength 50
     */
    host?: string | null;
}
...
/** @enumType */
type TypeWithLiterals = Type | 'UNKNOWN' | 'LIMITED' | 'UNLIMITED';
...
interface GetCurrentContributorRequest {
}
interface GetCurrentContributorResponse {
    /**
     * The contributor details for the current caller, including metadata, role assignments, and capabilities.
     * Some fields may be omitted based on the caller's permissions.
     */
...
interface RemoveContributorResponse {
}
