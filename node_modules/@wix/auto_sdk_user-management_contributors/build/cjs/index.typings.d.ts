...
interface ContributorCreatedEnvelope {
    entity: Contributor;
 ...
 * @slug created
 */
declare function onContributorCreated(handler: (event: ContributorCreatedEnvelope) => void | Promise<void>): void;
 ...
 */
declare function removeContributor(accountId: string): Promise<void>;

export { AccountGroup, type AccountGroupWithLiterals, type AccountInfo, type AccountInfoMetadata, type ActionEvent, type ApiAccountInfo, type AppInvite, type AssignedPolicy, type Assignment, type BaseEventMetadata, type BulkGetUserRolesOnSiteRequest, type BulkGetUserRolesOnSiteResponse, type BulkValidateEmailInviteEligibilityRequest, type BulkValidateEmailInviteEligibilityResponse, type ChangeContributorLocationOptions, type ChangeContributorLocationRequest, type ChangeContributorLocationResponse, type ChangeContributorRoleRequest, type ChangeContributorRoleResponse, type ChangeRoleOptions, type CompanionResource, type Condition, ConditionAttributeType, type ConditionAttributeTypeWithLiterals, type Conditions, type Contributor, type ContributorCreatedEnvelope, type ContributorLimit, type ContributorV2, type ContributorsQuota, type ContributorsQuotaOptionsOneOf, type DomainEvent, type DomainEventBodyOneOf, type EmailInviteEligibility, type EnrichedSiteInvite, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type EventMetadata, FieldSet, type FieldSetWithLiterals, type GetAppContributorsRequest, type GetAppContributorsResponse, type GetContributorsQuotaRequest, type GetContributorsQuotaResponse, type GetCurrentContributorRequest, type GetCurrentContributorResponse, type GetCurrentUserRolesRequest, type GetCurrentUserRolesResponse, type GetSiteContributorsRequest, type GetSiteContributorsResponse, type GetSiteContributorsV2Options, type GetSiteContributorsV2Request, type GetSiteContributorsV2Response, type HandleSiteTransferRequest, type HandleSiteTransferResponse, type IdentificationData, type IdentificationDataIdOneOf, InviteStatus, type InviteStatusWithLiterals, type LimitedOptions, type LocalizedPolicyInfo, type LocalizedRole, type LocationsRestriction, type MessageEnvelope, type Name, type PendingOwner, type PersonMetaData, type Policy, type PredefinedRole, type PredefinedRoles, type QuerySiteContributorsFilter, type QuerySiteContributorsOptions, type QuerySiteContributorsRequest, type QuerySiteContributorsResponse, type RemoveContributorRequest, type RemoveContributorResponse, type Resource, ResourceType, type ResourceTypeWithLiterals, type RestoreInfo, type Restriction, type RestrictionRestrictionsOneOf, type Role, type SiteInvite, type SiteLocationAssignment, type SiteRestriction, type SiteRoleAssignment, type Subject, type SubjectContext, SubjectContextType, type SubjectContextTypeWithLiterals, SubjectType, type SubjectTypeWithLiterals, type Team, Type, type TypeWithLiterals, type User, type UserLocalizedRoles, type UserSubject, WebhookIdentityType, type WebhookIdentityTypeWithLiterals, changeContributorLocation, changeRole, onContributorCreated, querySiteContributors, removeContributor };
