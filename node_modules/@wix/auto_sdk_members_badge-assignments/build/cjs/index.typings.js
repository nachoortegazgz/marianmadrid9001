...
__export(index_typings_exports, {
  ...
  bulkCreateBadgeAssignments: () => bulkCreateBadgeAssignments2,
  bulkDeleteBadgeAssignments: () => bulkDeleteBadgeAssignments2,
  bulkUpdateBadgeAssignmentTags: () => bulkUpdateBadgeAssignmentTags2,
  bulkUpdateBadgeAssignmentTagsByFilter: () => bulkUpdateBadgeAssignmentTagsByFilter2,
  createBadgeAssignment: () => createBadgeAssignment2,
  deleteBadgeAssignment: () => deleteBadgeAssignment2,
  queryBadgeAssignments: () => queryBadgeAssignments2,
  typedQueryBadgeAssignments: () => typedQueryBadgeAssignments,
  utils: () => utils
});
...
async function createBadgeAssignment2(badgeAssignment) {
  ...
  try {
    ...
    return (0, import_rename_all_nested_keys.renameKeysFromRESTResponseToSDKResponse)(result.data)?.badgeAssignment;
  } catch (err) {
    const transformedError = (0, import_transform_error.transformError)(
      err,
      {
        spreadPathsToArguments: {},
        explicitPathsToArguments: { badgeAssignment: "$[0]" },
...
async function deleteBadgeAssignment2(badgeAssignmentId) {
  ...
  try {
    ...
    const transformedError = (0, import_transform_error.transformError)(
      ...
      {
        spreadPathsToArguments: {},
        explicitPathsToArguments: { badgeAssignmentId: "$[0]" },
        singleArgumentUnchanged: false
      },
      ["badgeAssignmentId"]
    );
...
async function bulkDeleteBadgeAssignments2(badgeAssignmentIds) {
  ...
  try {
    ...
    const transformedError = (0, import_transform_error.transformError)(
      ...
      {
        spreadPathsToArguments: {},
        explicitPathsToArguments: { badgeAssignmentIds: "$[0]" },
        singleArgumentUnchanged: false
      },
      ["badgeAssignmentIds"]
    );
...
async function bulkUpdateBadgeAssignmentTagsByFilter2(filter, options) {
  ...
  const reqOpts = bulkUpdateBadgeAssignmentTagsByFilter(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
