...
import { Trigger as CoreCheckoutTrigger, Root as CoreCheckoutRoot, } from './core/Checkout.js';
...
(function (TestIds) {
    ...
    TestIds["actionCheckout"] = "action-checkout";
    /** Test ID for add to cart action buttons */
    TestIds["actionAddToCart"] = "action-add-to-cart";
    /** Test ID for buy now action buttons */
    TestIds["actionBuyNow"] = "action-buy-now";
})(TestIds || (TestIds = {}));
/**
 ...
 * ```
 */
export const Root = ({ checkoutServiceConfig, children }) => {
    return (_jsx(CoreCheckoutRoot, { checkoutServiceConfig: checkoutServiceConfig, children: _jsx(AsChildSlot, { "data-component-tag": DataComponentTags.commerceRoot, children: children }) }));
};
 ...
 * ```
 */
const ActionCheckout = React.forwardRef(({ asChild, children, className, label = 'Checkout', loadingState = '...', ...otherProps }, ref) => {
    return (_jsx(CoreCurrentCartCheckout, { children: (renderProps) => {
            const defaultContent = children
                ? children
                : renderProps.isLoading
                    ? loadingState
                    : label;
            return (_jsx(AsChildSlot, { ref: ref, asChild: asChild, className: className, onClick: renderProps.proceedToCheckout, disabled: !renderProps.canCheckout || renderProps.isLoading, "data-testid": TestIds.actionCheckout, "data-in-progress": renderProps.isLoading, customElement: children, customElementProps: {
                    proceedToCheckout: renderProps.proceedToCheckout,
                    canCheckout: renderProps.canCheckout,
                    isLoading: renderProps.isLoading,
                }, content: defaultContent, ...otherProps, children: _jsx("button", { children: defaultContent }) }));
        } }));
});
/**
 ...
 * ```
 */
const ActionBuyNow = React.forwardRef(({ disabled, asChild, children, className, label = 'Buy Now', loadingState = '...', lineItems, ...props }, ref) => {
    return (_jsx(CoreCheckoutTrigger, { children: (renderProps) => {
            const onClick = () => {
            ...
            return (_jsx(Comp, { ref: ref, className: className, onClick: onClick, disabled: renderProps.isLoading || disabled, "data-testid": TestIds.actionBuyNow, "data-in-progress": renderProps.isLoading, ...props, children: children
                    ? children
                    : renderProps.isLoading
                        ? loadingState
                        : label }));
 ...
 * ```
 */
const ActionAddToCart = React.forwardRef(({ disabled, asChild, children, className, label = 'Add to Cart', loadingState = '...', lineItems, onSuccess, ...props }, ref) => {
    return (_jsx(CoreCurrentCartCheckout, { children: (renderProps) => {
            const onClick = async () => {
                await renderProps.addToCart(lineItems);
                await onSuccess?.();
            };
            if (asChild && children && typeof children === 'function') {
                return children({
            ...
            const Comp = asChild ? Slot : 'button';
            return (_jsx(Comp, { ref: ref, className: className, onClick: onClick, disabled: renderProps.isLoading || disabled, "data-testid": TestIds.actionAddToCart, "data-in-progress": renderProps.isLoading, ...props, children: children
                    ? children
                    : renderProps.isLoading
                        ? loadingState
                        : label }));
 ...
 * ```
 */
export const CheckoutTrigger = React.forwardRef((props) => {
