...
__export(meta_exports, {
  ...
  ContactAutofillOriginal: () => ContactAutofill,
  ContactFieldOriginal: () => ContactField,
  ContactIdentityTypeOriginal: () => ContactIdentityType,
  CropOriginal: () => Crop,
  ...
  LayoutDataImagePositionOriginal: () => LayoutDataImagePosition,
  ...
  MeetingTypeOriginal: () => MeetingType,
  ModeOriginal: () => Mode,
  ...
  ResultsDisplayOriginal: () => ResultsDisplay,
  ...
  StaffStrategySelectionOriginal: () => StaffStrategySelection,
  ...
  SubmissionAccessOriginal: () => SubmissionAccess,
  ...
  SubscriptionChannelOriginal: () => SubscriptionChannel,
  ...
  downloadSubmission: () => downloadSubmission2,
...
function downloadSubmission2() {
  const payload = { submissionId: ":submissionId" };
  const getRequestOptions = downloadSubmission(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "GET",
    path: "/v4/submissions/{submissionId}/download",
    pathParams: { submissionId: "submissionId" },
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
0 && (module.exports = {
  ...
  ContactAutofillOriginal,
  ContactFieldOriginal,
  ContactIdentityTypeOriginal,
  CropOriginal,
  DayOfWeekOriginal,
  ...
  LayoutDataImagePositionOriginal,
  LayoutOriginal,
  LayoutTypeOriginal,
  LineCapOriginal,
  LineStyleOriginal,
