...
__export(index_exports, {
  ...
  bulkDeleteSubmission: () => bulkDeleteSubmission4,
  bulkMarkSubmissionsAsSeen: () => bulkMarkSubmissionsAsSeen4,
  bulkRemoveSubmissionFromTrashBin: () => bulkRemoveSubmissionFromTrashBin4,
  bulkUpdateFormSubmissionTags: () => bulkUpdateFormSubmissionTags4,
  bulkUpdateFormSubmissionTagsByFilter: () => bulkUpdateFormSubmissionTagsByFilter4,
  confirmSubmission: () => confirmSubmission4,
  countDeletedSubmissions: () => countDeletedSubmissions4,
  countSubmissions: () => countSubmissions4,
  ...
  getSubmission: () => getSubmission4,
  getSubmissionDownloadUrl: () => getSubmissionDownloadUrl4,
  listDeletedSubmissions: () => listDeletedSubmissions4,
  onSubmissionContactMapped: () => onSubmissionContactMapped2,
  onSubmissionContactMappingSkipped: () => onSubmissionContactMappingSkipped2,
  onSubmissionCreated: () => onSubmissionCreated2,
  onSubmissionDeleted: () => onSubmissionDeleted2,
  onSubmissionRemovedSubmissionFromTrash: () => onSubmissionRemovedSubmissionFromTrash2,
  onSubmissionStatusUpdated: () => onSubmissionStatusUpdated2,
  onSubmissionUpdated: () => onSubmissionUpdated2,
  querySubmission: () => querySubmission4,
  querySubmissionsByNamespace: () => querySubmissionsByNamespace4,
  removeSubmissionFromTrashBin: () => removeSubmissionFromTrashBin4,
  restoreSubmissionFromTrashBin: () => restoreSubmissionFromTrashBin4,
  searchSubmissionsByNamespace: () => searchSubmissionsByNamespace4,
  updateExtendedFields: () => updateExtendedFields4,
  updateSubmission: () => updateSubmission4,
  upsertContactFromSubmission: () => upsertContactFromSubmission4,
  utils: () => utils,
  validateFormSubmission: () => validateFormSubmission4
});
module.exports = __toCommonJS(index_exports);

// src/forms-v4-submission-submissions.public.ts
...
function resolveWixFormsV4FormSubmissionServiceUrl(opts) {
  const domainToMappings = {
    ...
    "www.wixapis.com": [
      ...
      {
        srcPath: "/forms/v4/submissions",
        destPath: "/v4/submissions"
      }
    ],
    "apps._base_domain_": [
      {
...
function resolveWixFormsV4FormSubmissionContactUpsertServiceUrl(opts) {
  const domainToMappings = {
    ...
    "*.dev.wix-code.com": [
      {
        srcPath: "/forms/contactupsert/v4/submissions-contacts",
        destPath: "/v4/submissions-contacts"
      }
    ],
    _: [
      {
...
var ContactIdentityType = /* @__PURE__ */ ((ContactIdentityType2) => {
  ContactIdentityType2["CONTACT"] = "CONTACT";
  ContactIdentityType2["MEMBER"] = "MEMBER";
  ContactIdentityType2["NOT_AUTHENTICATED_MEMBER"] = "NOT_AUTHENTICATED_MEMBER";
  return ContactIdentityType2;
})(ContactIdentityType || {});
...
var WaitType = /* @__PURE__ */ ((WaitType2) => {
  WaitType2["NO_WAIT"] = "NO_WAIT";
  WaitType2["WAIT"] = "WAIT";
  WaitType2["NO_REBOOKING"] = "NO_REBOOKING";
  return WaitType2;
})(WaitType || {});
...
var StaffStrategySelection = /* @__PURE__ */ ((StaffStrategySelection2) => {
  ...
  return StaffStrategySelection2;
...
var InputType = /* @__PURE__ */ ((InputType2) => {
  ...
  InputType2["OBJECT_ARRAY"] = "OBJECT_ARRAY";
  return InputType2;
})(InputType || {});
...
var SubscriptionChannel = /* @__PURE__ */ ((SubscriptionChannel2) => {
...
var OverrideEntityType = /* @__PURE__ */ ((OverrideEntityType2) => {
  ...
  OverrideEntityType2["FORM"] = "FORM";
  OverrideEntityType2["NESTED_FORM_FIELD"] = "NESTED_FORM_FIELD";
...
// src/forms-v4-submission-submissions.public.ts
function upsertContactFromSubmission3(httpClient) {
  return (submissionId, options) => upsertContactFromSubmission2(
    submissionId,
    options,
    // @ts-ignore
    { httpClient }
...
function createSubmission3(httpClient) {
  return (submission, options) => createSubmission2(
    submission,
    options,
    // @ts-ignore
    { httpClient }
...
function getSubmission3(httpClient) {
  return (submissionId) => getSubmission2(
    submissionId,
    // @ts-ignore
    { httpClient }
  );
}
function updateSubmission3(httpClient) {
  return (_id, submission) => updateSubmission2(
    _id,
    submission,
    // @ts-ignore
    { httpClient }
...
function confirmSubmission3(httpClient) {
  return (submissionId) => confirmSubmission2(
    submissionId,
    // @ts-ignore
    { httpClient }
  );
}
function deleteSubmission3(httpClient) {
  return (submissionId, options) => deleteSubmission2(
    submissionId,
    options,
    // @ts-ignore
    { httpClient }
...
function bulkDeleteSubmission3(httpClient) {
  return (formId, options) => bulkDeleteSubmission2(
    formId,
    options,
    // @ts-ignore
    { httpClient }
...
function restoreSubmissionFromTrashBin3(httpClient) {
  return (submissionId) => restoreSubmissionFromTrashBin2(
    submissionId,
    // @ts-ignore
    { httpClient }
  );
}
function removeSubmissionFromTrashBin3(httpClient) {
  return (submissionId) => removeSubmissionFromTrashBin2(
    submissionId,
    // @ts-ignore
    { httpClient }
  );
}
function bulkRemoveSubmissionFromTrashBin3(httpClient) {
  return (formId, options) => bulkRemoveSubmissionFromTrashBin2(
    formId,
    options,
    // @ts-ignore
    { httpClient }
...
function listDeletedSubmissions3(httpClient) {
  return (formId, options) => listDeletedSubmissions2(
    formId,
    options,
    // @ts-ignore
    { httpClient }
...
function getDeletedSubmission3(httpClient) {
  return (submissionId) => getDeletedSubmission2(
    submissionId,
    // @ts-ignore
    { httpClient }
  );
}
function querySubmission3(httpClient) {
  return (query, options) => querySubmission2(
    query,
    options,
    // @ts-ignore
    { httpClient }
...
function searchSubmissionsByNamespace3(httpClient) {
  return (search) => searchSubmissionsByNamespace2(
    search,
    // @ts-ignore
    { httpClient }
  );
}
function querySubmissionsByNamespace3(httpClient) {
  return (options) => querySubmissionsByNamespace2(
    options,
    // @ts-ignore
    { httpClient }
  );
...
function countSubmissions3(httpClient) {
  return (formIds, namespace, options) => countSubmissions2(
    formIds,
    namespace,
    options,
    // @ts-ignore
...
function countDeletedSubmissions3(httpClient) {
  return (formIds, namespace, options) => countDeletedSubmissions2(
    formIds,
    namespace,
    options,
    // @ts-ignore
...
function getMediaUploadUrl3(httpClient) {
  return (formId, filename, mimeType) => getMediaUploadUrl2(
    formId,
    filename,
    mimeType,
    // @ts-ignore
...
function bulkMarkSubmissionsAsSeen3(httpClient) {
  return (ids, formId) => bulkMarkSubmissionsAsSeen2(
    ids,
    formId,
    // @ts-ignore
    { httpClient }
...
function getSubmissionDownloadUrl3(httpClient) {
  return (submissionId) => getSubmissionDownloadUrl2(
    submissionId,
    // @ts-ignore
    { httpClient }
  );
...
function bulkUpdateFormSubmissionTags3(httpClient) {
  return (submissionIds, options) => bulkUpdateFormSubmissionTags2(
    submissionIds,
    options,
    // @ts-ignore
    { httpClient }
...
function bulkUpdateFormSubmissionTagsByFilter3(httpClient) {
  return (filter, options) => bulkUpdateFormSubmissionTagsByFilter2(
    filter,
    options,
    // @ts-ignore
    { httpClient }
...
function validateFormSubmission3(httpClient) {
  return (submission, options) => validateFormSubmission2(
    submission,
    options,
    // @ts-ignore
    { httpClient }
...
var onSubmissionCreated = /* @__PURE__ */ (0, import_sdk_types.EventDefinition)(
...
var onSubmissionDeleted = /* @__PURE__ */ (0, import_sdk_types.EventDefinition)(
...
var onSubmissionRemovedSubmissionFromTrash = /* @__PURE__ */ (0, import_sdk_types.EventDefinition)(
...
var onSubmissionStatusUpdated = /* @__PURE__ */ (0, import_sdk_types.EventDefinition)(
...
var onSubmissionContactMapped = /* @__PURE__ */ (0, import_sdk_types.EventDefinition)(
...
var onSubmissionContactMappingSkipped = /* @__PURE__ */ (0, import_sdk_types.EventDefinition)(
...
var onSubmissionUpdated = /* @__PURE__ */ (0, import_sdk_types.EventDefinition)(
...
var upsertContactFromSubmission4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(upsertContactFromSubmission3);
var createSubmission4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(createSubmission3);
var getSubmission4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getSubmission3);
var updateSubmission4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(updateSubmission3);
var confirmSubmission4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(confirmSubmission3);
var deleteSubmission4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(deleteSubmission3);
var bulkDeleteSubmission4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(bulkDeleteSubmission3);
var restoreSubmissionFromTrashBin4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(restoreSubmissionFromTrashBin3);
var removeSubmissionFromTrashBin4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(removeSubmissionFromTrashBin3);
var bulkRemoveSubmissionFromTrashBin4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(bulkRemoveSubmissionFromTrashBin3);
var listDeletedSubmissions4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(listDeletedSubmissions3);
var getDeletedSubmission4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getDeletedSubmission3);
var querySubmission4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(querySubmission3);
var searchSubmissionsByNamespace4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(searchSubmissionsByNamespace3);
var countSubmissionsByFilter4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(countSubmissionsByFilter3);
var countSubmissions4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(countSubmissions3);
var countDeletedSubmissions4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(countDeletedSubmissions3);
...
var querySubmissionsByNamespace4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(customQuerySubmissionsByNamespace);
var onSubmissionCreated2 = /* @__PURE__ */ (0, import_event_definition_modules.createEventModule)(
  onSubmissionCreated
);
var onSubmissionDeleted2 = /* @__PURE__ */ (0, import_event_definition_modules.createEventModule)(
  onSubmissionDeleted
);
var onSubmissionRemovedSubmissionFromTrash2 = /* @__PURE__ */ (0, import_event_definition_modules.createEventModule)(onSubmissionRemovedSubmissionFromTrash);
var onSubmissionStatusUpdated2 = /* @__PURE__ */ (0, import_event_definition_modules.createEventModule)(
  onSubmissionStatusUpdated
);
var onSubmissionContactMapped2 = /* @__PURE__ */ (0, import_event_definition_modules.createEventModule)(
  onSubmissionContactMapped
);
var onSubmissionContactMappingSkipped2 = /* @__PURE__ */ (0, import_event_definition_modules.createEventModule)(onSubmissionContactMappingSkipped);
var onSubmissionUpdated2 = /* @__PURE__ */ (0, import_event_definition_modules.createEventModule)(
  onSubmissionUpdated
);
