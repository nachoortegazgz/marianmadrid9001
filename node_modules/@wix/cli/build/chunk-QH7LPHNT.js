...
function getRemoteLogContext() {
  const remoteContext = env.REMOTE_MACHINE_LOG_CONTEXT;
  if (!remoteContext) {
    return {};
  }
  try {
...
var createEnv = () => {
  ...
  return {
    ...
    ciName: overrides.ciName ?? import_ci_info.default.name ?? env.CI_NAME ?? null,
    cliEnvName: overrides.cliEnvName ?? env.WIX_RUNTIME_ENVIRONMENT ?? null,
    cliTrackingId: overrides.cliTrackingId ?? env.TRACKING_ID ?? null,
    remoteLogContext: getRemoteLogContext(),
    devCenterDraftOverrides: env.WIX_CLI_DEV_CENTER_DRAFT_OVERRIDES === "true"
  };
};
...
*/
//# sourceMappingURL=chunk-QH7LPHNT.js.map