...
declare function createScheduledDataWorkflow(): __PublicMethodMetaInfo<'POST', {}, CreateScheduledDataWorkflowRequest$1, CreateScheduledDataWorkflowRequest, CreateScheduledDataWorkflowResponse$1, CreateScheduledDataWorkflowResponse>;
declare function rescheduleScheduledDataWorkflow(): __PublicMethodMetaInfo<'POST', {
    scheduledDataWorkflowId: string;
}, RescheduleScheduledDataWorkflowRequest$1, RescheduleScheduledDataWorkflowRequest, RescheduleScheduledDataWorkflowResponse$1, RescheduleScheduledDataWorkflowResponse>;
declare function triggerScheduledDataWorkflowNow(): __PublicMethodMetaInfo<'POST', {
    scheduledDataWorkflowId: string;
}, TriggerScheduledDataWorkflowNowRequest$1, TriggerScheduledDataWorkflowNowRequest, TriggerScheduledDataWorkflowNowResponse$1, TriggerScheduledDataWorkflowNowResponse>;
declare function updateScheduledDataWorkflow(): __PublicMethodMetaInfo<'PATCH', {}, UpdateScheduledDataWorkflowRequest$1, UpdateScheduledDataWorkflowRequest, UpdateScheduledDataWorkflowResponse$1, UpdateScheduledDataWorkflowResponse>;
declare function deleteScheduledDataWorkflow(): __PublicMethodMetaInfo<'DELETE', {
    scheduledDataWorkflowId: string;
}, DeleteScheduledDataWorkflowRequest$1, DeleteScheduledDataWorkflowRequest, DeleteScheduledDataWorkflowResponse$1, DeleteScheduledDataWorkflowResponse>;
declare function getScheduledDataWorkflow(): __PublicMethodMetaInfo<'GET', {
    scheduledDataWorkflowId: string;
