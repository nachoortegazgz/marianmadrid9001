...
class WixDataQueryImpl extends _QueryBase.QueryBase {
  constructor(origin) {
    ...
    (0, _defineProperty2.default)(this, "randomSortOptions", void 0);
    (0, _defineProperty2.default)(this, "fieldGroups", void 0);
    ...
    this.fieldGroups = (origin == null ? void 0 : origin.fieldGroups) ?? [];
  }
  copy(params) {
