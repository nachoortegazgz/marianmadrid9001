...
exports.messages = exports.codes = exports.WixDataValidationError = exports.BulkError = void 0;
exports.validationError = validationError;
exports.wdeValidationError = wdeValidationError;
exports.wixDataError = wixDataError;
exports.wixDataValidationError = wixDataValidationError;
...
const messages = exports.messages = {
  ...
  queryValidations: {
    ...
    isNumber: (operatorName, specifier, operand) => `WDE0032: Invalid ${operatorName} parameter [${(0, _utils.typeForDisplay)(operand)}]. ${operatorName} parameter must be a ${specifier} number.`,
  ...
  filterValidations: {
    typeIsString: (operatorName, value) => `WDE0044: Invalid ${operatorName} parameter value [${(0, _utils.typeForDisplay)(value)}]. ${operatorName} parameter must be a String.`,
    typeIsStringNumberOrDate: (operatorName, value) => `WDE0045: Invalid ${operatorName} parameter value [${(0, _utils.typeForDisplay)(value)}]. Valid ${operatorName} parameter types are String, Number or Date.`,
    typeIsStringNumberBoolOrDate: (operatorName, value) => `WDE0045: Invalid ${operatorName} parameter value [${(0, _utils.typeForDisplay)(value)}]. Valid ${operatorName} parameter types are String, Number, Boolean or Date.`,
    sameType: (operatorName, first, second) => `WDE0046: Invalid ${operatorName} parameter values [${(0, _utils.typeForDisplay)(first)}] and [${(0, _utils.typeForDisplay)(second)}]. Both parameters must be of the same type.`,
    ...
    validFieldName: (operatorName, field) => `WDE0048: Invalid ${operatorName} field value [${(0, _utils.typeForDisplay)(field)}]. ${operatorName} field must be a String.`,
    isInstanceOfSameClass: (operatorName, constructorName, obj) => `WDE0049: Invalid ${operatorName} parameter [${(0, _utils.typeForDisplay)(obj)}]. ${operatorName} expects ${constructorName} only.`,
  ...
  filterTreeValidations: {
    ...
    comparisonOperatorType: (operatorName, value) => `WDE0058: ${operatorName} should be a Date, Number, String, or Boolean. Got ${stringify(value)} instead`,
    stringOperatorType: (operatorName, value) => `WDE0059: ${operatorName} should be a String. Got ${stringify(value)} instead`,
    setOperatorItems: (operatorName, value) => `WDE0060: ${operatorName} Array should only contain values of types Date, Number, String, and Boolean. Got ${stringify(value)} instead`,
    // Kept as a compatibility alias for validators that still reference the
    // former protocol-specific $in validation.
    inOperatorItems: value => `WDE0060: $in Array should only contain values of types Date, Number, String, and Boolean. Got ${stringify(value)} instead`,
  ...
  sortValidations: {
    typeIsStringOrArrayOfStrings: (operatorName, effectiveArgs) => `WDE0051: Invalid ${operatorName} parameters [${effectiveArgs.map(_utils.typeForDisplay)}]. Valid ${operatorName} values are String, Array of String or varargs String.`
  },
  orderByValidations: {
...
class WixDataValidationError extends Error {
  constructor(message, code, details, violations = []) {
    ...
    (0, _defineProperty2.default)(this, "details", void 0);
    (0, _defineProperty2.default)(this, "violations", void 0);
    this.code = code;
