...
export interface WixDataQuery {
     ...
     *  - By default, each returned item can include up to 50 referenced items.
     *    To change this limit, pass a numeric value as the final argument to
     ...
     *    [`queryReferenced()`](https://dev.wix.com/docs/sdk/business-solutions/data/items/query-referenced).
     *
     ...
     * @public
     * @documentationMaturity preview
     * @param groups - Field group names to include.
     * @requiredField groups
     * @returns Refined query.
     */
    includeFieldGroups(...groups: string[]): WixDataQuery;
    /**
     * Apply random sorting to the query (optionally deterministic with a seed).
     *
     * When enabled, RANDOM sort mode takes effect and regular sorts (ascending/descending)
     * cannot be used at the same time.
     *
     * @public
     * @documentationMaturity preview
     * @param seed - Seed value to produce a repeatable random order.
     * @returns Refined query with random sort applied.
     */
    randomSort({ seed }: {
        seed?: number;
    }): WixDataQuery;
