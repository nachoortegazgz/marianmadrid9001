import type { FieldViolation } from '../types/error';
export declare const messages: {
    ...
    filterValidations: {
        ...
        typeIsStringNumberBoolOrDate: (operatorName: string, value: any) => string;
...
export declare function wixDataError(message: string, code?: string, details?: any, cause?: any): Error;
...
export declare class BulkError extends Error {
    ...
    constructor(message: string, code: string, item: any, name: string, originalIndex: number, violations?: FieldViolation[]);
}
export declare class WixDataValidationError extends Error {
    name: string;
    code?: string;
    details?: any;
    violations: FieldViolation[];
    constructor(message: string, code?: string, details?: any, violations?: FieldViolation[]);
}
export declare function wixDataValidationError(message: string, code?: string, details?: any, violations?: FieldViolation[]): WixDataValidationError;
