...
interface CountExtendedBookingsSignature {
     ...
     */
    (options?: CountExtendedBookingsOptions): Promise<NonNullablePaths<CountExtendedBookingsResponse, `count`, 0>>;
}

declare function customQueryExtendedBookings(httpClient: HttpClient): {
    (query: ExtendedBookingQuery, options?: QueryExtendedBookingsOptions): ReturnType<typeof typedQueryExtendedBookings>;
    (options?: QueryExtendedBookingsOptions): ExtendedBookingsQueryBuilder;
};
...
declare const queryExtendedBookings: MaybeContext<BuildRESTFunction<typeof customQueryExtendedBookings> & typeof customQueryExtendedBookings>;

export { CountExtendedBookingsOptions, CountExtendedBookingsResponse, ExtendedBookingQuery, ExtendedBookingsQueryBuilder, QueryExtendedBookingResponse, QueryExtendedBookingsOptions, QueryOptions, QueryV2, countExtendedBookings, query, queryExtendedBookings };
