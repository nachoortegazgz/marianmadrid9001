...
interface CreateRedirectSessionSignature {
     ...
     */
    (options?: CreateRedirectSessionOptions): Promise<NonNullablePaths<CreateRedirectSessionResponse, `redirectSession._id` | `redirectSession.fullUrl` | `redirectSession.urlDetails.endpoint` | `redirectSession.shortUrl`, 2>>;
}
