...
interface CreateRedirectSessionRequest extends CreateRedirectSessionRequestIntentOneOf {
    ...
    ecomOrderPaymentRequest?: RedirectSessionEcomOrderPaymentRequestParams;
    /**
...
declare enum Prompt {
    ...
    none = "none",
    /**
     * Ask the member to consent.
     * @documentationMaturity preview
     * @internal
     */
    consent = "consent",
    /**
     * Allow the member to select an account from multiple options.
     * @documentationMaturity preview
     * @internal
     */
...
interface RedirectSessionEcomOrderPaymentRequestParams {
    /**
     * <b>Required</b>. ID of the order payment request to process.
     * @format GUID
     */
...
interface SignInURLRequest {
    ...
    clientId?: string;
    /**
     * Optional IAM IdP connection to authenticate with. When set, the returned sign-in URL should initiate an OIDC login via IAM's /sso/login for this connection instead of the default Wix login page.
     * @format GUID
     */
 ...
 */
declare function createRedirectSession(options?: CreateRedirectSessionOptions): Promise<NonNullablePaths<CreateRedirectSessionResponse, `redirectSession._id` | `redirectSession.fullUrl` | `redirectSession.urlDetails.endpoint` | `redirectSession.shortUrl`, 2>>;
