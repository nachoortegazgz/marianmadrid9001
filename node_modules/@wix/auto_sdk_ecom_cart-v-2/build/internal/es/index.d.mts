...
/** @internal */
declare function getUpsellOptions$1(httpClient: HttpClient): GetUpsellOptionsSignature;
interface GetUpsellOptionsSignature {
    /**
     * Returns the upsell options available for the cart's line items.
     * @param - Cart ID.
     */
    (cartId: string): Promise<NonNullablePaths<GetUpsellOptionsResponse, `itemsUpsells` | `itemsUpsells.${number}.lineItemId`, 2>>;
}
...
declare function estimateCart$1(httpClient: HttpClient): EstimateCartSignature;
interface EstimateCartSignature {
    /**
...
interface GetCheckoutUrlSignature {
     ...
     */
    (cartId: string, options?: GetCheckoutUrlOptions): Promise<NonNullablePaths<GetCheckoutURLResponse, `checkoutUrl`, 0> & {
        __applicationErrorsType?: GetCheckoutUrlApplicationErrors;
    }>;
}
declare function placeOrder$1(httpClient: HttpClient): PlaceOrderSignature;
interface PlaceOrderSignature {
    /**
     ...
     * @param - Cart ID.
     */
    (cartId: string, options?: PlaceOrderOptions): Promise<NonNullablePaths<PlaceOrderResponse, `orderId` | `completed`, 0> & {
...
interface RemoveLineItemsSignature {
     ...
     * @param - Cart ID.
     * @param - Line item IDs to remove from the cart.
     */
...
declare function addCoupon$1(httpClient: HttpClient): AddCouponSignature;
interface AddCouponSignature {
    /**
...
declare function setDeliveryMethod$1(httpClient: HttpClient): SetDeliveryMethodSignature;
interface SetDeliveryMethodSignature {
    /**
...
declare function removeDeliveryMethod$1(httpClient: HttpClient): RemoveDeliveryMethodSignature;
interface RemoveDeliveryMethodSignature {
    /**
...
/** @internal */
declare const getUpsellOptions: MaybeContext<BuildRESTFunction<typeof getUpsellOptions$1> & typeof getUpsellOptions$1>;
...
declare const estimateCart: MaybeContext<BuildRESTFunction<typeof estimateCart$1> & typeof estimateCart$1>;
...
declare const placeOrder: MaybeContext<BuildRESTFunction<typeof placeOrder$1> & typeof placeOrder$1>;
...
declare const addCoupon: MaybeContext<BuildRESTFunction<typeof addCoupon$1> & typeof addCoupon$1>;
declare const removeCoupon: MaybeContext<BuildRESTFunction<typeof removeCoupon$1> & typeof removeCoupon$1>;
declare const setDeliveryMethod: MaybeContext<BuildRESTFunction<typeof setDeliveryMethod$1> & typeof setDeliveryMethod$1>;
declare const removeDeliveryMethod: MaybeContext<BuildRESTFunction<typeof removeDeliveryMethod$1> & typeof removeDeliveryMethod$1>;
