...
function getUpsellOptions2() {
  const payload = { cartId: ":cartId" };
  const getRequestOptions = getUpsellOptions(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "GET",
    path: "/v2/carts/{cartId}/upsell-options",
    pathParams: { cartId: "cartId" },
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function setDeliveryMethod2() {
  const payload = { cartId: ":cartId" };
  const getRequestOptions = setDeliveryMethod(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function removeDeliveryMethod2() {
  const payload = { cartId: ":cartId" };
  const getRequestOptions = removeDeliveryMethod(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/carts/{cartId}/remove-delivery-method",
    pathParams: { cartId: "cartId" },
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
export {
  ...
  QuotaType as QuotaTypeOriginal,
  RateType as RateTypeOriginal,
  RedemptionType as RedemptionTypeOriginal,
  ...
  V1PlatformFeeChargeType as V1PlatformFeeChargeTypeOriginal,
  ValidationsConfig as ValidationsConfigOriginal,
  VatType as VatTypeOriginal,
  ViolationCode as ViolationCodeOriginal,
  ViolationScope as ViolationScopeOriginal,
  ViolationSeverity as ViolationSeverityOriginal,
  ...
  getUpsellOptions2 as getUpsellOptions,
  ...
  removeDeliveryMethod2 as removeDeliveryMethod,
