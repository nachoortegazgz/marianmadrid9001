 ...
 * @permissionId WIX_FORMS.READ_INTERACTIVE_FORM_SESSION
 * @webhook
 * @eventType wix.forms.ai.v1.interactive_form_session_created
 * @slug created
 * @documentationMaturity preview
 */
declare function onInteractiveFormSessionCreated(handler: (event: InteractiveFormSessionCreatedEnvelope) => void | Promise<void>): void;
/**
 ...
 */
declare function createInteractiveFormSession(formId: string, options?: CreateInteractiveFormSessionOptions): Promise<NonNullablePaths<InteractiveFormSession, `_id` | `formId`, 0>>;
