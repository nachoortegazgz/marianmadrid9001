...
interface InteractiveFormSession {
    ...
    formId?: string;
    /**
     * Form to create interactive session for.
     * Should be provided only by internal services and only when the form is not yet created.
     * @internal
     */
    form?: Form;
}
...
/** @enumType */
type DefaultCountryConfigTypeWithLiterals = DefaultCountryConfigType | 'UNKNOWN_DEFAULT_COUNTRY' | 'BY_IP' | 'COUNTRY';
...
/** @enumType */
type ChunkTypeWithLiterals = ChunkType | 'TEXT' | 'TEXT_DATA' | 'MULTI_SELECT_INPUT' | 'NUMBER_INPUT' | 'SEPARATOR' | 'SINGLE_SELECT_INPUT' | 'ERROR' | 'SUBMISSION' | 'IMPORTANT_TEXT' | 'DEBUG' | 'END_OF_RESPONSE' | 'FILE_UPLOAD' | 'SIGNATURE';
...
/** @enumType */
type StyleWithLiterals = Style | 'NORMAL' | 'BOLD';
/** Structured data extracted from user input and mapped to form fields. */
...
/** @enumType */
type TypeWithLiterals = Type | 'PARAGRAPH';
/** Selector for selecting a single option from a predefined list. */
...
/** @enumType */
type RoleWithLiterals = Role | 'USER' | 'ASSISTANT' | 'FUNCTION_CALL' | 'FUNCTION_CALL_OUTPUT' | 'DEVELOPER';
...
/** Request to generate a natural language summary of a form. */
interface GenerateFormSummaryRequest {
    /**
...
/** Response containing the generated form summary. */
interface GenerateFormSummaryResponse {
    /**
...
/** @docsIgnore */
type GenerateFormSummaryApplicationErrors = {
    code?: 'INVALID_FORM';
    description?: string;
    data?: Record<string, any>;
};
