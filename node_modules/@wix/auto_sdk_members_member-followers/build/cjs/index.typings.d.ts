 ...
 */
declare function onFollowMemberFollowed(handler: (event: FollowMemberFollowedEnvelope) => void | Promise<void>): void;
 ...
 */
declare function onFollowMemberUnfollowed(handler: (event: FollowMemberUnfollowedEnvelope) => void | Promise<void>): void;
/**
 ...
 */
declare function followMember(memberId: string): Promise<void>;
/**
 ...
 */
declare function unfollowMember(memberId: string): Promise<void>;
/**
 ...
 */
declare function listCurrentMemberFollowing(options?: ListCurrentMemberFollowingOptions): Promise<ListCurrentMemberFollowingResult>;
 ...
 */
declare function listMemberFollowing(memberId: string, options?: ListMemberFollowingOptions): Promise<ListMemberFollowingResult>;
 ...
 */
declare function listCurrentMemberFollowers(options?: ListCurrentMemberFollowersOptions): Promise<ListCurrentMemberFollowersResult>;
 ...
 */
declare function listMemberFollowers(memberId: string, options?: ListMemberFollowersOptions): Promise<ListMemberFollowersResult>;
 ...
 */
declare function queryCurrentMemberConnections(connectedMemberIds: string[]): Promise<NonNullablePaths<QueryMyMemberConnectionsResponse, `connectedMembers` | `connectedMembers.${number}.connectedMemberId` | `connectedMembers.${number}.followedByMember` | `connectedMembers.${number}.followingMember`, 2>>;
/**
 ...
 */
declare function queryMemberConnections(memberId: string, connectedMemberIds: string[]): Promise<NonNullablePaths<QueryMemberConnectionsResponse, `connectedMembers` | `connectedMembers.${number}.connectedMemberId` | `connectedMembers.${number}.followedByMember` | `connectedMembers.${number}.followingMember`, 2>>;

export { type AccountInfo, type AccountInfoMetadata, type ActionEvent, type App, type BaseEventMetadata, type ConnectedMembers, type CursorPaging, type Cursors, type CustomTag, type DomainEvent, type DomainEventBodyOneOf, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type EventMetadata, type File, type FollowMemberFollowedEnvelope, type FollowMemberRequest, type FollowMemberResponse, type FollowMemberUnfollowedEnvelope, type Follower, type IdentificationData, type IdentificationDataIdOneOf, type InvalidateCache, type InvalidateCacheGetByOneOf, type ListCurrentMemberFollowersOptions, type ListCurrentMemberFollowersResult, type ListCurrentMemberFollowingOptions, type ListCurrentMemberFollowingResult, type ListMemberFollowersOptions, type ListMemberFollowersRequest, type ListMemberFollowersResponse, type ListMemberFollowersResult, type ListMemberFollowingOptions, type ListMemberFollowingRequest, type ListMemberFollowingResponse, type ListMemberFollowingResult, type ListMyMemberFollowersRequest, type ListMyMemberFollowersResponse, type ListMyMemberFollowingRequest, type ListMyMemberFollowingResponse, type MemberFollowed, type MemberUnfollowed, type MessageEnvelope, type Page, type Pages, type PagingMetadataV2, type QueryMemberConnectionsRequest, type QueryMemberConnectionsResponse, type QueryMyMemberConnectionsRequest, type QueryMyMemberConnectionsResponse, type RestoreInfo, type URI, type URIs, type UnfollowMemberRequest, type UnfollowMemberResponse, WebhookIdentityType, type WebhookIdentityTypeWithLiterals, followMember, listCurrentMemberFollowers, listCurrentMemberFollowing, listMemberFollowers, listMemberFollowing, onFollowMemberFollowed, onFollowMemberUnfollowed, queryCurrentMemberConnections, queryMemberConnections, unfollowMember };
