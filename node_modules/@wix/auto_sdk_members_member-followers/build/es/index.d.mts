...
import { ListCurrentMemberFollowingOptions, ListCurrentMemberFollowingResult, ListMemberFollowingOptions, ListMemberFollowingResult, ListCurrentMemberFollowersOptions, ListCurrentMemberFollowersResult, ListMemberFollowersOptions, ListMemberFollowersResult, QueryMyMemberConnectionsResponse, QueryMemberConnectionsResponse, FollowMemberFollowedEnvelope, FollowMemberUnfollowedEnvelope } from './index.typings.mjs';
export { AccountInfo, AccountInfoMetadata, ActionEvent, App, BaseEventMetadata, ConnectedMembers, CursorPaging, Cursors, CustomTag, DomainEvent, DomainEventBodyOneOf, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, File, FollowMemberRequest, FollowMemberResponse, Follower, IdentificationData, IdentificationDataIdOneOf, InvalidateCache, InvalidateCacheGetByOneOf, ListMemberFollowersRequest, ListMemberFollowersResponse, ListMemberFollowingRequest, ListMemberFollowingResponse, ListMyMemberFollowersRequest, ListMyMemberFollowersResponse, ListMyMemberFollowingRequest, ListMyMemberFollowingResponse, MemberFollowed, MemberUnfollowed, MessageEnvelope, Page, Pages, PagingMetadataV2, QueryMemberConnectionsRequest, QueryMyMemberConnectionsRequest, RestoreInfo, URI, URIs, UnfollowMemberRequest, UnfollowMemberResponse, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.mjs';
...
interface ListCurrentMemberFollowingSignature {
     ...
     */
    (options?: ListCurrentMemberFollowingOptions): Promise<ListCurrentMemberFollowingResult>;
}
...
interface ListMemberFollowingSignature {
     ...
     */
    (memberId: string, options?: ListMemberFollowingOptions): Promise<ListMemberFollowingResult>;
}
...
interface ListCurrentMemberFollowersSignature {
     ...
     */
    (options?: ListCurrentMemberFollowersOptions): Promise<ListCurrentMemberFollowersResult>;
}
...
interface ListMemberFollowersSignature {
     ...
     */
    (memberId: string, options?: ListMemberFollowersOptions): Promise<ListMemberFollowersResult>;
}
...
interface QueryCurrentMemberConnectionsSignature {
     ...
     */
    (connectedMemberIds: string[]): Promise<NonNullablePaths<QueryMyMemberConnectionsResponse, `connectedMembers` | `connectedMembers.${number}.connectedMemberId` | `connectedMembers.${number}.followedByMember` | `connectedMembers.${number}.followingMember`, 2>>;
}
...
interface QueryMemberConnectionsSignature {
     ...
     */
    (memberId: string, connectedMemberIds: string[]): Promise<NonNullablePaths<QueryMemberConnectionsResponse, `connectedMembers` | `connectedMembers.${number}.connectedMemberId` | `connectedMembers.${number}.followedByMember` | `connectedMembers.${number}.followingMember`, 2>>;
}
declare const onFollowMemberFollowed$1: EventDefinition<FollowMemberFollowedEnvelope, "wix.members.v3.follow_member_followed">;
declare const onFollowMemberUnfollowed$1: EventDefinition<FollowMemberUnfollowedEnvelope, "wix.members.v3.follow_member_unfollowed">;
