...
export { Access, AccessLevel, AccessLevelWithLiterals, AccessWithLiterals, ActionEvent, AddSpecialPermissionsRequest, Condition, ConditionOperator, ConditionOperatorOperatorsOneOf, ConditionType, ConditionTypeOfOneOf, ConditionValue, ConditionValueValueOneOf, DependOnOperator, DomainEvent, DomainEventBodyOneOf, DraftItemsPluginPermissions, Effect, EffectWithLiterals, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EnvironmentCondition, EnvironmentConditionConditionOneOf, EqualOperator, ExperimentCondition, ExperimentOperator, GetMyPermissionsRequest, GetMyPermissionsResponseDraftItemsPluginPermissions, GetPermissionsRequest, JoinedCondition, JoinedConditionOperator, JoinedConditionOperatorWithLiterals, LikeOperator, MigrateCustomRolesRequest, MigrateCustomRolesResponse, PolicyAssigned, PolicyAssignment, PolicyAssignmentUpdated, PolicyAssignmentsUpdated, PolicyAssignmentsUpdatedEventOneOf, PolicyAuthorizationDataUpdated, PolicyCondition, PolicyOwner, PolicyOwnerType, PolicyOwnerTypeWithLiterals, PolicyStatement, PolicyType, PolicyTypeWithLiterals, PolicyUnassigned, RemoveSpecialPermissionsRequest, RemoveSpecialPermissionsResponse, Resource, ResourcePath, RestoreInfo, SimpleCondition, SimpleConditionOperator, SimpleConditionOperatorWithLiterals, SimpleConditionValue, SimpleConditionValueValueOneOf, SpecialPermissionsDraftItemsPluginPermissions, SpecialPermissionsSubjectOneOf, Subject, SubjectContext, SubjectContextType, SubjectContextTypeWithLiterals, SubjectType, SubjectTypeWithLiterals, UpdatePermissionsRequest, UpdateSpecialPermissionsRequest } from './index.typings.js';
...
interface UpdatePermissionsSignature {
     ...
     */
    (dataPermissions: NonNullablePaths<DataPermissions, `_id` | `itemInsert` | `itemRead` | `itemRemove` | `itemUpdate`, 0>): Promise<NonNullablePaths<UpdatePermissionsResponse, `dataPermissions._id` | `dataPermissions.itemRead` | `dataPermissions.itemInsert` | `dataPermissions.itemUpdate` | `dataPermissions.itemRemove` | `dataPermissions.specialPermissions` | `dataPermissions.specialPermissions.${number}.userId` | `dataPermissions.specialPermissions.${number}.policyId` | `dataPermissions.specialPermissions.${number}._id` | `dataPermissions.specialPermissions.${number}.itemRead` | `dataPermissions.specialPermissions.${number}.itemInsert` | `dataPermissions.specialPermissions.${number}.itemUpdate` | `dataPermissions.specialPermissions.${number}.itemRemove`, 3> & {
...
interface UpdateSpecialPermissionsSignature {
     ...
     * @param - ID of the special permissions set.
     */
...
interface GetMyPermissionsSignature {
     ...
     */
    (dataCollectionId: string): Promise<NonNullablePaths<GetMyPermissionsResponse, `itemRead` | `itemInsert` | `itemUpdate` | `itemRemove`, 0> & {
